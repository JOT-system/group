...
''' </summary>
''' <remarks></remarks>
Public Class GS0012SUPPLCODEget
    Inherits GS0000
    ...
    Protected METHOD_NAME As String = "GS0012SUPPLCODEget"
    ''' <summary>
    ''' 庸車会社の一覧を取得する
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub GS0012SUPPLCODEget()
        '<< エラー説明 >>
        ...
        Try
            ...
            Else
                ...
                Dim PARA2 As SqlParameter = SQLcmd.Parameters.Add("@P2", System.Data.SqlDbType.Date)
                Dim PARA3 As SqlParameter = SQLcmd.Parameters.Add("@P3", System.Data.SqlDbType.Date)
                Dim PARA4 As SqlParameter = SQLcmd.Parameters.Add("@P3", System.Data.SqlDbType.NVarChar, 20)
                PARA1.Value = USERID
                PARA2.Value = STYMD
                PARA3.Value = ENDYMD
                PARA4.Value = ORGCODE
