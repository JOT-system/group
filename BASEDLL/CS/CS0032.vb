...
Public Structure CS0032TABLERecover
    ...
    Public Sub CS0032TABLERecover()
        ...
        Try
            ...
            Using fst As New FileStream(FILEDIR, mode:=FileMode.Open, access:=FileAccess.Read, share:=FileShare.Read, bufferSize:=32768, options:=FileOptions.SequentialScan),
                  bs As New BufferedStream(fst),
                  fs As New StreamReader(bs, System.Text.Encoding.UTF8)
                ...
                Do
                    ...
                    WW_Row.ItemArray = WW_LineData.Split(ControlChars.Tab)
