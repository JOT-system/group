...
Public Structure CS0044L1INSERT
    ...
    Public Sub CS0044L1ColmnsAdd(ByRef I_TBL As DataTable)
        ...
        '2020/04/13 ADD
        I_TBL.Columns.Add("PAYROSAIYUKYNIUSSU", GetType(Decimal))    '労災欠勤日数（有給）
        I_TBL.Columns.Add("PAYTOKUKYUMUKYUNISSU", GetType(Decimal))  '特別休暇日数（無給）
        I_TBL.Columns.Add("PAYKOKANGOYUKYUNISSU", GetType(Decimal))  '子看護休暇日数（有給）
        I_TBL.Columns.Add("PAYKOKANGOMUKYUNISSU", GetType(Decimal))  '子看護休暇日数（無給）
        ...
        '2020/04/13 ADD
        I_TBL.Columns.Add("PAYOUENKAISU", GetType(Decimal))        '応援手当回数
        I_TBL.Columns.Add("PAYHANCHOKAISU", GetType(Decimal))      '班長会議手当回数
        I_TBL.Columns.Add("PAYYOKSAIKENSADAISU", GetType(Decimal)) '容器再検査台数
        I_TBL.Columns.Add("PAYKIMITUKENSADAISU", GetType(Decimal)) '気密検査台数
    ...
    Public Sub CS0044L1CreTempTbl(ByVal I_TBL_Name As String)
        ...
        SQLStr = "CREATE TABLE " & I_TBL_Name _
                ...
                & "  PAYROSAIYUKYNIUSSU numeric(10, 3)," _
                & "  PAYTOKUKYUMUKYUNISSU numeric(10, 3)," _
                & "  PAYKOKANGOYUKYUNISSU numeric(10, 3)," _
                & "  PAYKOKANGOMUKYUNISSU numeric(10, 3)," _
                ...
                & "  PAYOUENKAISU numeric(10, 3)," _
                & "  PAYHANCHOKAISU numeric(10, 3)," _
                & "  PAYYOKSAIKENSADAISU numeric(10, 3)," _
                & "  PAYKIMITUKENSADAISU numeric(10, 3)," _
