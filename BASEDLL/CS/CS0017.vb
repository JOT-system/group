            ...
            Using SQLcon = sm.getConnection
                ...
                Using SQLcmd As New SqlCommand(SQLStr, SQLcon)
                    ...
                    If SQLdr.HasRows = False Then
                        '存在しなかった場合、バージョンを除き再検索
                        If Not String.IsNullOrEmpty(VER) Then
                            SQLdr.Close()
                            PARA1.Value = MAPID.Replace("_" & VER, "")
    ...
    Public Sub getNextURL()
        ...
        Try
            ...
            Using SQLcon = sm.getConnection
               ...
               & "   ON  B.MAPID    = A.MAPID + CASE WHEN charindex(@P7, A.MAPID) > 0 THEN '' ELSE @P7 END " _
               & "   and B.STYMD   <= @P4 " _
               & "   and B.ENDYMD  >= @P3 " _
               & "   and B.DELFLG  <> @P5 " _
               & " Where " _
               ...
               & "   and A.DELFLG   <> @P5 "
                ...
                Using SQLcmd As New SqlCommand(SQLStr, SQLcon)
                    ...
                    If SQLdr.Read Then
                        ...
                        URL = SQLdr("URL")
                        NAMES = SQLdr("NAMES")
                        If Not String.IsNullOrEmpty(VER) AndAlso SQLdr("MAPID").ToString.IndexOf(VER) < 0 Then
                            MAP_RETURN = SQLdr("MAPID") & "_" & VER
                        Else
