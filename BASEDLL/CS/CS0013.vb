    ...
    Private Sub MakeTableObject(ByRef profTbl As DataTable, ByRef outArea As Object)
        ...
        For Each dataRow In Me.SRCDATA.Rows
            ...
            If Me.HIDEOPERATIONOPT = False Then
                ...
                Select Case outTHCell.Text
                    Case C_LIST_OPERATION_CODE.WARNING,
                         C_LIST_OPERATION_CODE.SELECTED & C_LIST_OPERATION_CODE.WARNING
                        outTHCell.CssClass = outTHCell.CssClass & " OPERATION_WARNING"
                    Case C_LIST_OPERATION_CODE.ERRORED,
                        C_LIST_OPERATION_CODE.SELECTED & C_LIST_OPERATION_CODE.ERRORED
                        outTHCell.CssClass = outTHCell.CssClass & " OPERATION_ERROR"
                    Case C_LIST_OPERATION_CODE.UPDATING,
                        C_LIST_OPERATION_CODE.SELECTED & C_LIST_OPERATION_CODE.UPDATING
                        outTHCell.CssClass = outTHCell.CssClass & " OPERATION_UPDATING"
                    Case C_LIST_OPERATION_CODE.SELECTED
                        outTHCell.CssClass = outTHCell.CssClass & " OPERATION_SELECTED"
                    Case Else
                End Select
