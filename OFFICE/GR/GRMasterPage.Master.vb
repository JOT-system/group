    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Else
                ...
                title.SetTitle(MF_MAPID.Value, MF_VERSION.Value, MF_MAPvariant.Value, COMPANYCODE, WW_RTN, CS0050SESSION.USERID)
...
#Region "<< Public Methods >>"
    ...
    Public Sub SetMAPValue()
        ...
        ElseIf Not IsNothing(Page.PreviousPage) AndAlso Not IsNothing(Page.PreviousPage.Master) Then
            ...
            With Page.PreviousPage.Master
                ...
                MF_VERSION.Value = DirectCast(.FindControl("MF_VERSION"), HiddenField).Value
    ...
    ''' <remarks></remarks>
    Public Sub TransitionPrevPage(Optional ByRef COMPCODE As String = "", Optional ByVal VER As String = "")

        '〇画面戻先URL取得
        CS0017ForwardURL.VER = VER
    ...
    ''' </summary>
    ''' <param name="COMPCODE">会社コード</param>
    ''' <param name="VER">バージョン（サフィックス）</param>
    ''' <remarks></remarks>
    Public Sub TransitionPage(Optional ByRef COMPCODE As String = "", Optional ByVal VER As String = "")
...
#Region "<< Property Accessor >>"
    ...
    Property VERSION As String
        Get
            Return MF_VERSION.Value
        End Get
        Set(value As String)
            MF_VERSION.Value = value
        End Set
    End Property
#End Region
End Class