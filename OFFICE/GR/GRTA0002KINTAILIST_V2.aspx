<%@ Page Title="TA0002_V2" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0002KINTAILIST_V2.aspx.vb" Inherits="OFFICE.GRTA0002KINTAILIST_V2" %>
...
<%@ register src="~/GR/inc/GRTA0002WRKINC_V2.ascx" tagname="work" tagprefix="LSINC" %>
<asp:Content ID="GRTA0002H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0002_V2.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0002_V2.js")%>"></script>
</asp:Content>
        ...
        <div  class="Detail" id="detailbox" runat="server">
            ...
            <span class="ENEX">
                ...
                <a style="position:fixed;top:12.9em;left:49em; width:32em;">
                    <asp:Label ID="WF_YOKSAIKENSADAISU_L" runat="server" Text="容器再検査" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:TextBox ID="WF_YOKSAIKENSADAISU" runat="server" Height="1.2em" Width="6em" CssClass="WF_TEXTBOX_CSS" readonly="true" style="text-align: right; "></asp:TextBox>
                    </b>
                </a>
                <!-- ■　気密検査　■ -->
                <a style="position:fixed;top:14.0em;left:49em; width:32em;">
                    <asp:Label ID="WF_KIMITUKENSADAISU_L" runat="server" Text="気密検査" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:TextBox ID="WF_KIMITUKENSADAISU" runat="server" Height="1.2em" Width="6em" CssClass="WF_TEXTBOX_CSS" readonly="true" style="text-align: right; "></asp:TextBox>
                    </b>
                </a>
                ...
                <!-- ■　荷卸回数　■ -->
                <a style="position:fixed;top:16.7em;left:49em; width:32em;">
                ...
                <!-- ■　走行距離　■ -->
                <a style="position:fixed;top:15.6em;left:67em; width:32em;">
                ...
                <a style="position:fixed;top:15.6em;left:73em; width:32em;">
                ...
                <a style="position:fixed;top:16.7em;left:61em; width:32em;">
                ...
                <a style="position:fixed;top:16.7em;left:71em; width:32em;">
                    <b>
            ...
            <span class="KNK">
                ...
                <!-- ■　車h中伯　■ -->
                <a style="position:fixed;top:12.9em;left:49em; width:32em;">
                    <asp:Label ID="WF_SHACHUHAKKBN_KNK_L" runat="server" Text="車中泊" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:CheckBox ID="WF_SHACHUHAKKBN_KNK" runat="server" Height="1.2em" Width="6em"  Readonly="true"></asp:CheckBox>
                    </b>
                </a>
                <!-- ■　点呼回数　■ -->
                <a style="position:fixed;top:14.0em;left:49em; width:32em;">
                    <asp:Label ID="WF_TENKOKAISU_KNK_L" runat="server" Text="点呼回数" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:TextBox ID="WF_TENKOKAISU_KNK" runat="server" Height="1.2em" Width="6em" CssClass="WF_TEXTBOX_CSS" Readonly="true"  style="text-align: right; "></asp:TextBox>
                    </b>
                </a>
                <!-- ■　応援手当　■ -->
                <a style="position:fixed;top:15.1em;left:49em; width:32em;">
                    <asp:Label ID="WF_OUENKAISU_KNK_L" runat="server" Text="応援手当" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:TextBox ID="WF_OUENKAISU_KNK" runat="server" Height="1.2em" Width="6em" CssClass="WF_TEXTBOX_CSS" Readonly="true"  style="text-align: right; "></asp:TextBox>
                    </b>
                </a>
                <!-- ■　班長会議　■ -->
                <a style="position:fixed;top:16.2em;left:49em; width:32em;">
                    <asp:Label ID="WF_HANCHOKAISU_KNK_L" runat="server" Text="班長会議" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:TextBox ID="WF_HANCHOKAISU_KNK" runat="server" Height="1.2em" Width="6em" CssClass="WF_TEXTBOX_CSS" Readonly="true"  style="text-align: right; "></asp:TextBox>
                    </b>
                </a>
