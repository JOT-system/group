<%@ Page Title="T00007_V2" Language="vb" AutoEventWireup="false" CodeBehind="GRT00007KINTAI_KNK_V2.aspx.vb" Inherits="OFFICE.GRT00007KINTAI_KNK_V2" %>
...
<asp:Content ID="T00007H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00007_KNK_V2.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00007_KNK_V2.js")%>'></script>
        ...
        <asp:MultiView ID="WF_DetailMView" runat="server">
            ...
            <asp:View ID="WF_DView1" runat="server" >
                ...
                <a style="position:fixed;top:14em;left:33em; width:32em;">
                    <asp:Label ID="WF_OUENKAISU_LABEL" runat="server" Text="応援手当" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                    <asp:TextBox ID="WF_OUENKAISU" runat="server" Height="1.2em" Width="4em" CssClass="WF_TEXTBOX_CSS" enabled="true" onchange="ItemChange('WF_OUENKAISU')" style="text-align: right; "></asp:TextBox>
                    </b>
                </a>
                <!-- ■　班長会議手当回数　■ -->
                ...
                <!-- ■　荷卸回数　■ -->
                <a style="position:fixed;top:16.7em;left:43em; width:32em;">
                ...
                <!-- ■　走行距離　■ -->
                <a style="position:fixed;top:16.7em;left:52.5em; width:32em;">
                ...
                <a style="position:fixed;top:16.7em;left:62.6em; width:32em;">
            ...
            <!--◆◆◆◆◆◆ Tab No2　（月調整） ◆◆◆◆◆◆◆-->
                <asp:View ID="WF_DView2" runat="server" >
                    ...
                    <a style="position:fixed;top:18.8em;left:3em; width:32em;" >
                        <asp:Label ID="WF_NENSHINISSUTTL_LABEL" runat="server" Text="年 末 年 始" Height="1.2em" Width="5.3em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                        <b>
                    ...
                    <a style="position:fixed;top:18.8em;left:25em; width:32em;" >
                    ...
                    <!-- ■■■　手当関連２　■■■ -->
                    <a style="position:fixed;top:19.9em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:19.9em;left:14em; width:32em;" >
