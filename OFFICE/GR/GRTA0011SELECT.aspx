<%@ Page Title="TA0011" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0011SELECT.aspx.vb" Inherits="OFFICE.GRTA0011SELECT" %>
...
<asp:Content ID="TA0011SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0011S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0011S.js")%>"></script>
</asp:Content>
<asp:Content ID="TA0011S" ContentPlaceHolderID="contents1" runat="server">
       <!-- 全体レイアウト　headerbox -->
