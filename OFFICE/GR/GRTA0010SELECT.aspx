<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GRTA0010SELECT.aspx.vb" Inherits="OFFICE.GRTA0010SELECT" %>
...
<asp:Content ID="TA0010SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0010S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0010S.js")%>"></script>
</asp:Content>
<asp:Content ID="TA0010S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
    <div  class="searchbox" id="searchbox" style="overflow:hidden">
        ...
        <div id="searchkeybox">
            ...
            <p class="LINE_3"> 
                <!-- 　出力部署　 -->
                <a style="position:fixed;top:12.1em;left:4em;font-weight:bold;text-decoration:underline;">出力部署</a>
                <a style="position:fixed;top:12.1em;left:18em;" ondblclick="Field_DBclick('WF_ORG' ,  <%=LIST_BOX_CLASSIFICATION.LC_ORG%>)" onchange="TextBox_change('WF_ORG');">
                    <asp:TextBox ID="WF_ORG" runat="server" Height="1.4em" Width="10em" ></asp:TextBox>
                </a>
                <a style="position:fixed;top:12.1em;left:27em;">
                    <asp:Label ID="WF_ORG_TEXT" runat="server" Text="" Width="17em" Height="1.2em" CssClass="WF_TEXT"></asp:Label>
                </a>
            </p>
        </div>
        <a hidden="hidden">
