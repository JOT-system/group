...
Public Class GRT00013SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00013WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00013 Then       '実行画面からの遷移
            '画面項目設定処理
            ...
            '休憩・配送選択
            If work.WF_SEL_WORKKBN.Text = "BB" Then
                WF_SW1.Checked = True
                WF_SW2.Checked = False
            Else
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRT00013WRKINC.MAPIDS
        rightview.MAPID = GRT00013WRKINC.MAPID
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        If WF_SW1.Checked Then
            work.WF_SEL_WORKKBN.Text = "BB"                     '休憩
        End If
        If WF_SW2.Checked Then
            work.WF_SEL_WORKKBN.Text = "G1"                     '配送
        End If
                        ...
                        Select Case WF_FIELD.Value
                            Case "WF_STAFFCODE"         '従業員(コード)
                                If Trim(WF_HORG.Text) = "" Then
                                    prmData = work.CreateStaffCodeParam(GL0005StaffList.LC_STAFF_TYPE.DRIVER,
                                                                    WF_CAMPCODE.Text, WF_TAISHOYM.Text, WF_HORG.Text, WF_STAFFKBN.Text)
                                Else
                                    prmData = work.CreateStaffCodeParam(GL0005StaffList.LC_STAFF_TYPE.ATTENDANCE_FOR_DRIVER_IN_AORG,
                                                                    WF_CAMPCODE.Text, WF_TAISHOYM.Text, WF_HORG.Text, WF_STAFFKBN.Text)
                                End If
                            Case "WF_HORG"              '配属部署
