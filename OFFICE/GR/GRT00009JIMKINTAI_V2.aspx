<%@ Page Title="T00009_V2" Language="vb" AutoEventWireup="false" CodeBehind="GRT00009JIMKINTAI_V2.aspx.vb" Inherits="OFFICE.GRT00009JIMKINTAI_V2" %>
...
<%@ Register Src="~/GR/inc/GRT00009WRKINC_V2.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="T00009H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00009_V2.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00009_V2.js")%>'></script>
            ...
            <table id="tblAdjustArea">
                ...
                <tbody id="tblAdjucstArea_tbody">
                    ...
                    <tr id="LINE_02">
                        ...
                        <td id="TOKUKYUMUKYUNISSU_L">
                            <!-- 特休無給 -->
                            <asp:Label ID="WF_TOKUKYUMUKYUNISSUTTL_L" runat="server" Text="特 休 無 給" CssClass="WF_TEXT_LEFT"></asp:Label>
                        </td>
                        <td id="TOKUKYUMUKYUNISSU">
                            <asp:TextBox ID="WF_TOKUKYUMUKYUNISSUTTL" runat="server" Height="1.1em" Width="6em" CssClass="WF_TEXTBOX_RIGHT"></asp:TextBox>
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
                    ...
                    <tr id="LINE_04">
                        ...
                        <td id="ROSAIYUKYNIUSSU_L">
                            <!-- 労災 -->
                            <asp:Label ID="WF_ROSAIYUKYNIUSSUTTL_L" runat="server" Text="労 　 　 災" CssClass="WF_TEXT_LEFT"></asp:Label>
                        </td>
                        <td id="ROSAIYUKYNIUSSU">
                            <asp:TextBox ID="WF_ROSAIYUKYNIUSSUTTL" runat="server" Height="1.1em" Width="6em" CssClass="WF_TEXTBOX_RIGHT"></asp:TextBox>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr id="LINE_04_1">
                        <td id="KOKANGOYUKYUNISSU_L">
                            <!-- 他欠 -->
                            <asp:Label ID="WF_KOKANGOYUKYUNISSUTTL_L" runat="server" Text="子 看 有 給" CssClass="WF_TEXT_LEFT"></asp:Label>
                        </td>
                        <td id="KOKANGOYUKYUNISSU">
                            <asp:TextBox ID="WF_KOKANGOYUKYUNISSUTTL" runat="server" Height="1.1em" Width="6em" CssClass="WF_TEXTBOX_RIGHT"></asp:TextBox>
                        </td>

                        <td id="KOKANGOMUKYUNISSU_L">
                            <!-- ｽﾄｯｸ休暇 -->
                            <asp:Label ID="WF_KOKANGOMUKYUNISSUTTL_L" runat="server" Text="子 看 無 給" CssClass="WF_TEXT_LEFT"></asp:Label>
                        </td>
                        <td id="KOKANGOMUKYUNISSU">
                            <asp:TextBox ID="WF_KOKANGOMUKYUNISSUTTL" runat="server" Height="1.1em" Width="6em" CssClass="WF_TEXTBOX_RIGHT"></asp:TextBox>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
