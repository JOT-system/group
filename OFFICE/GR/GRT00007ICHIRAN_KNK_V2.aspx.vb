...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007ICHIRAN_KNK_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC_V2.MAPIDIKNK
        Master.VERSION = "V2"
    ...
    Protected Sub WF_ButtonEND_Click()
        ...
        ''■■■ 画面戻先URL取得 ■■■
        'CS0017RETURNURLget.MAPID = GRT00007WRKINC_V2.MAPIDIKNK
    ...
    '            CS0049UPROFview.MAPID = GRT00007WRKINC_V2.MAPIDIKNK
    ...
    Private Sub GRID_INITset()
        ...
        Try
            ...
            Dim SQLStr As String =
               ...
               & "       isnull(A.OUENKAISU,0) as OUENKAISU , " _
               & "       isnull(A.OUENKAISUCHO,0) as OUENKAISUCHO , " _
               & "       isnull(A.HANCHOKAISU,0) as HANCHOKAISU , " _
               & "       isnull(A.HANCHOKAISUCHO,0) as HANCHOKAISUCHO , " _
            ...
            For i As Integer = 0 To T0007tbl.Rows.Count - 1
                ...
                T0007row("SHACHUHAKNISSUTTL") = Val(T0007row("SHACHUHAKNISSU")) + Val(T0007row("SHACHUHAKNISSUCHO"))
                T0007row("OUENKAISUTTL") = Val(T0007row("OUENKAISU")) + Val(T0007row("OUENKAISUCHO"))
                T0007row("HANCHOKAISUTTL") = Val(T0007row("HANCHOKAISU")) + Val(T0007row("HANCHOKAISUCHO"))
                ...
                T0007row("KAITENCNTTTL1_1") = Val(T0007row("KAITENCNT1_1")) + Val(T0007row("KAITENCNTCHO1_1"))
                T0007row("KAITENCNTTTL1_2") = Val(T0007row("KAITENCNT1_2")) + Val(T0007row("KAITENCNTCHO1_2"))
                T0007row("KAITENCNTTTL1_3") = Val(T0007row("KAITENCNT1_3")) + Val(T0007row("KAITENCNTCHO1_3"))
                T0007row("KAITENCNTTTL1_4") = Val(T0007row("KAITENCNT1_4")) + Val(T0007row("KAITENCNTCHO1_4"))
                T0007row("KAITENCNTTTL2_1") = Val(T0007row("KAITENCNT2_1")) + Val(T0007row("KAITENCNTCHO2_1"))
                T0007row("KAITENCNTTTL2_2") = Val(T0007row("KAITENCNT2_2")) + Val(T0007row("KAITENCNTCHO2_2"))
                T0007row("KAITENCNTTTL2_3") = Val(T0007row("KAITENCNT2_3")) + Val(T0007row("KAITENCNTCHO2_3"))
                T0007row("KAITENCNTTTL2_4") = Val(T0007row("KAITENCNT2_4")) + Val(T0007row("KAITENCNTCHO2_4"))
                T0007row("LATITUDE") = ""
                T0007row("LONGITUDE") = ""
                T0007row("DATAKBN") = "K"
                T0007row("SHIPORG") = ""
                ...
                T0007row("T10SAVECNT") = 0
                T0007row("T10SHARYOKBN1") = ""
                T0007row("T10OILPAYKBN1") = ""
                T0007row("T10SHUKABASHO1") = ""
                T0007row("T10TODOKECODE1") = ""
                T0007row("T10MODELDISTANCE1") = "0"
                T0007row("T10MODIFYKBN1") = ""
                T0007row("T10SHARYOKBN2") = ""
                T0007row("T10OILPAYKBN2") = ""
                T0007row("T10SHUKABASHO2") = ""
                T0007row("T10TODOKECODE2") = ""
                T0007row("T10MODELDISTANCE2") = "0"
                T0007row("T10MODIFYKBN2") = ""
                T0007row("T10SHARYOKBN3") = ""
                T0007row("T10OILPAYKBN3") = ""
                T0007row("T10SHUKABASHO3") = ""
                T0007row("T10TODOKECODE3") = ""
                T0007row("T10MODELDISTANCE3") = "0"
                T0007row("T10MODIFYKBN3") = ""
                T0007row("T10SHARYOKBN4") = ""
                T0007row("T10OILPAYKBN4") = ""
                T0007row("T10SHUKABASHO4") = ""
                T0007row("T10TODOKECODE4") = ""
                T0007row("T10MODELDISTANCE4") = "0"
                T0007row("T10MODIFYKBN4") = ""
                T0007row("T10SHARYOKBN5") = ""
                T0007row("T10OILPAYKBN5") = ""
                T0007row("T10SHUKABASHO5") = ""
                T0007row("T10TODOKECODE5") = ""
                T0007row("T10MODELDISTANCE5") = "0"
                T0007row("T10MODIFYKBN5") = ""
                T0007row("T10SHARYOKBN6") = ""
                T0007row("T10OILPAYKBN6") = ""
                T0007row("T10SHUKABASHO6") = ""
                T0007row("T10TODOKECODE6") = ""
                T0007row("T10MODELDISTANCE6") = "0"
                T0007row("T10MODIFYKBN6") = ""
                ...
                T0007row("KAITENCNT") = Int(T0007row("KAITENCNT"))
                T0007row("KAITENCNTCHO") = Int(T0007row("KAITENCNTCHO"))
                T0007row("KAITENCNTTTL") = Int(T0007row("KAITENCNTTTL"))
        ...
        Try
            ...
            For Each WW_HEADrow As DataRow In wT0007tbl.Rows
                ...
                For i As Integer = 0 To WW_WKDTLtbl.Rows.Count - 1
                    ...
                    WW_WKDTLrow("KAIDISTANCE") = 0
                    WW_WKDTLrow("KAIDISTANCECHO") = 0
                    WW_WKDTLrow("KAIDISTANCETTL") = 0
    ...
    Private Sub T0007_InsertEdit(ByRef iTbl As DataTable, ByVal iDATENOW As Date, ByRef oTBL As DataTable, ByRef oRtn As String)
        ...
        For i As Integer = 0 To iTbl.Rows.Count - 1
            ...
            WW_row("OUENKAISU") = iRow("OUENKAISU")                                                 '応援手当回数
            WW_row("OUENKAISUCHO") = iRow("OUENKAISUCHO")                                           '応援手当回数調整
            WW_row("HANCHOKAISU") = iRow("HANCHOKAISU")                                             '班長会議手当回数
            WW_row("HANCHOKAISUCHO") = iRow("HANCHOKAISUCHO")                                       '班長会議手当回数調整
    ...
    Public Sub T0007Insert(ByVal iRow As DataRow, ByRef I_SQLcon As SqlConnection)
        ...
        Dim P_OUENKAISU As SqlParameter = SQLcmd.Parameters.Add("@OUENKAISU", System.Data.SqlDbType.Int)
        Dim P_OUENKAISUCHO As SqlParameter = SQLcmd.Parameters.Add("@OUENKAISUCHO", System.Data.SqlDbType.Int)
        Dim P_HANCHOKAISU As SqlParameter = SQLcmd.Parameters.Add("@HANCHOKAISU", System.Data.SqlDbType.Int)
        Dim P_HANCHOKAISUCHO As SqlParameter = SQLcmd.Parameters.Add("@HANCHOKAISUCHO", System.Data.SqlDbType.Int)
        ...
        P_OUENKAISU.Value = iRow("OUENKAISU")
        P_OUENKAISUCHO.Value = iRow("OUENKAISUCHO")
        P_HANCHOKAISU.Value = iRow("HANCHOKAISU")
        P_HANCHOKAISUCHO.Value = iRow("HANCHOKAISUCHO")
                    ...
                    If T0007row("WORKDATE") = WW_HEADrow("WORKDATE") And
                       ...
                       T0007row("SELECT") = "1" Then
                        ...
                        If T0007row("HDKBN") = "H" Then
                            ...
                            WW_T0007row("OUENKAISUCHO") = Val(WW_HEADrow("OUENKAISUTTL")) - T0007row("OUENKAISU")
                            WW_T0007row("OUENKAISUTTL") = Val(T0007row("OUENKAISU")) + Val(T0007row("OUENKAISUCHO"))
                            WW_T0007row("HANCHOKAISUCHO") = Val(WW_HEADrow("HANCHOKAISUTTL")) - T0007row("HANCHOKAISU")
                            WW_T0007row("HANCHOKAISUTTL") = Val(T0007row("HANCHOKAISU")) + Val(T0007row("HANCHOKAISUCHO"))
    ...
    '        Dim DTLcnt = (From d As DataRow In ioTBL.Rows
    '                      Where d("WORKDATE") = WW_HEADrow("WORKDATE") AndAlso
    '                               d("STAFFCODE") = WW_HEADrow("STAFFCODE") AndAlso
    '                               d("RECODEKBN") = WW_HEADrow("RECODEKBN") AndAlso
    '                               d("HDKBN") = "D" AndAlso
    '                               d("SELECT") = "1"
    '                      Select d).Count
    '        'WW_Filter = ""
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC_V2.MAPIDIKNK
        ...
        If T0007INProw("RECODEKBN") = "0" Then
            ...
            If T0007INProw("BINDTIME") = Nothing Then
                If T0007INProw("HOLIDAYKBN") = 0 Then
        ...
        If T0007INProw("RECODEKBN") = "2" Then
            ...
            If T0007INProw("SHACHUHAKNISSUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(車中泊日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                ...
                Else
                    'エラーレポート編集
                    WW_CheckMES1 = "・更新できないレコード(車中泊日数エラー)です。"
                    WW_CheckMES2 = CS0036FCHECK.CHECKREPORT
                    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
                End If
            End If

            ' *** 応援手当回数合計(OUENKAISUTTL)
            If T0007INProw("OUENKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(応援手当回数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "OUENKAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("OUENKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("OUENKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
                    WW_CheckMES1 = "・更新できないレコード(応援手当回数エラー)です。"
                    WW_CheckMES2 = CS0036FCHECK.CHECKREPORT
                    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
                End If
            End If

            ' *** 班長会議手当回数合計(HANCHOKAISUTTL)
            If T0007INProw("HANCHOKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(班長会議手当回数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "HANCHOKAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("HANCHOKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("HANCHOKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
                    WW_CheckMES1 = "・更新できないレコード(班長会議手当回数エラー)です。"
                    WW_CheckMES2 = CS0036FCHECK.CHECKREPORT
                    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
                End If
            End If
        ...
        For i As Integer = 0 To CS0021PROFXLS.FIELD.Count - 1
            If CS0021PROFXLS.EFFECT(i) = "Y" AndAlso CS0021PROFXLS.POSIX(i) > 0 AndAlso CS0021PROFXLS.POSIY(i) > 0 Then
                ...
                If (CS0021PROFXLS.FIELD(i) = "KYOTEIWEEKNISSUTTL") OrElse
                   ...
                   (CS0021PROFXLS.FIELD(i) = "TENKOKAISUTTL") OrElse
                   (CS0021PROFXLS.FIELD(i) = "SHACHUHAKNISSUTTL") OrElse
                   (CS0021PROFXLS.FIELD(i) = "OUENKAISUTTL") OrElse
                   (CS0021PROFXLS.FIELD(i) = "HANCHOKAISUTTL") OrElse
    ...
    Protected Sub T0007INPmake(ByRef iTBL As DataTable, ByRef iTTLFLG As String)
        ...
        For i As Integer = 0 To iTBL.Rows.Count - 1
            ...
            ' *** 応援手当回数(OUENKAISU)
            If WW_COLUMNS.IndexOf("OUENKAISU") < 0 Then
                T0007INProw("OUENKAISU") = ""
            Else
                T0007INProw("OUENKAISU") = iTBL.Rows(i)("OUENKAISU")
            End If

            ' *** 班長会議手当回数(HANCHOKAISU)
            If WW_COLUMNS.IndexOf("HANCHOKAISU") < 0 Then
                T0007INProw("HANCHOKAISU") = ""
            Else
                T0007INProw("HANCHOKAISU") = iTBL.Rows(i)("HANCHOKAISU")
            End If
            ...
            ' *** 応援手当回数合計(OUENKAISUTTL)
            If WW_COLUMNS.IndexOf("OUENKAISUTTL") < 0 Then
                T0007INProw("OUENKAISUTTL") = ""
            Else
                T0007INProw("OUENKAISUTTL") = iTBL.Rows(i)("OUENKAISUTTL")
            End If

            ' *** 班長会議手当回数合計(HANCHOKAISUTTL)
            If WW_COLUMNS.IndexOf("HANCHOKAISUTTL") < 0 Then
                T0007INProw("HANCHOKAISUTTL") = ""
            Else
                T0007INProw("HANCHOKAISUTTL") = iTBL.Rows(i)("HANCHOKAISUTTL")
            End If
    ...
    Protected Sub MAPrefelence(ByRef O_MSG As String, ByRef O_RTN As String)
        ...
        '■■■ 選択画面の入力初期値設定 ■■■
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007KNK_V2 Then
