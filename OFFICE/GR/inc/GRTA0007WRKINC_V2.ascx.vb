...
Public Class GRTA0007WRKINC_V2
    Inherits UserControl

    Public Const MAPIDS As String = "TA0007S"                        'MAPID(選択)
    Public Const MAPID As String = "TA0007_V2"                       'MAPID(実行)
    ...
    Public Sub GetRoundType(ByVal COMPCODE As String, ByRef O_SPLIT_MINUITE As Integer, ByRef O_ROUND_TYPE As GRT00009TIMEFORMAT.EM_ROUND_TYPE)
        Select Case COMPCODE
            Case CONST_CAMP_ENEX, CONST_CAMP_KNK 'ENX, KNK
                O_SPLIT_MINUITE = 10
                O_ROUND_TYPE = GRT00009TIMEFORMAT_V2.EM_ROUND_TYPE.CEILING
            Case CONST_CAMP_NJS 'NJS
                O_SPLIT_MINUITE = 5
                O_ROUND_TYPE = GRT00009TIMEFORMAT_V2.EM_ROUND_TYPE.CEILING
            Case CONST_CAMP_JKT 'JKT
                O_SPLIT_MINUITE = 10
                O_ROUND_TYPE = GRT00009TIMEFORMAT_V2.EM_ROUND_TYPE.ROUND_AWAY
            Case Else
                O_SPLIT_MINUITE = 1
                O_ROUND_TYPE = GRT00009TIMEFORMAT_V2.EM_ROUND_TYPE.ROUND
        End Select
    End Sub
End Class