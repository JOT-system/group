...
Public Class GRT00007WRKINC_V2
    Inherits UserControl

    Public Const MAPIDS As String = "T00007S"               'MAPID(条件)
    'Public Const MAPIDS As String = "T00007S_V2"            'MAPID(条件)
    Public Const MAPIDI As String = "T00007I_V2"            'MAPID(一覧)
    Public Const MAPIDINJS As String = "T00007INJS_V2"      'MAPID(一覧)
    Public Const MAPIDIKNK As String = "T00007IKNK_V2"      'MAPID(一覧)
    Public Const MAPIDIJKT As String = "T00007IJKT_V2"      'MAPID(一覧)
    Public Const MAPID As String = "T00007_V2"              'MAPID(実行)
    Public Const MAPIDNJS As String = "T00007NJS_V2"        'MAPID(実行)
    Public Const MAPIDKNK As String = "T00007KNK_V2"        'MAPID(実行)
    Public Const MAPIDJKT As String = "T00007JKT_V2"        'MAPID(実行)
