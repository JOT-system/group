...
Public Class GRT00008WRKINC
    ...
    Public Function CreateORGParam(ByVal COMPCODE As String, ByVal ORGCODE As String) As Hashtable
        ...
        sb.Append("   ) ")
        'sb.Append(" INNER JOIN M0006_STRUCT D ON ")
        'sb.Append("         A.CAMPCODE = D.CAMPCODE ")
        'sb.Append("   and   A.OBJECT   = D.OBJECT ")
        'sb.Append("   and   D.STRUCT   = '勤怠管理組織' ")
        'sb.Append("   and   D.CODE     = C.GRCODE01 ")
        'sb.Append("   and   D.STYMD   <= @P5 ")
        'sb.Append("   and   D.ENDYMD  >= @P4 ")
        'sb.Append("   and   D.DELFLG  <> @P8 ")
        sb.Append(" WHERE ")
