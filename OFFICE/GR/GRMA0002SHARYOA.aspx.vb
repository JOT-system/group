        ...
        For Each XLSTBLrow As DataRow In CS0023XLSUPLOAD.TBLDATA.Rows
            ...
            If WW_COLUMNS.IndexOf("CAMPCODE") >= 0 AndAlso
               ...
               WW_COLUMNS.IndexOf("TSHABAN") >= 0 Then
                ...
                For Each MA0002row As DataRow In MA0002tbl.Rows
                    If XLSTBLrow("CAMPCODE").ToString.PadLeft(2, "0") = MA0002row("CAMPCODE") AndAlso
                    ...
                    Using SQLdr As SqlDataReader = SQLcmd.ExecuteReader()
                        ...
                        While SQLdr.Read
                            ...
                            If IsDBNull(SQLdr("BASERDATE")) OrElse SQLdr("BASERDATE") = "" Then
                                MA0002row("BASERDATE") = ""
                                MA0002row("BASERAGEMM") = "0"
                                MA0002row("BASERAGEYY") = "0"
                                MA0002row("BASERAGE") = "0"
                            Else
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("CAMPCODE") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("SHARYOTYPE") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("DELFLG") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGMORG") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGSORG") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGOILTYPE") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
                ...
                If isNormal(WW_CS0024FCHECKERR) Then
                    ...
                    If MA0002INProw("MANGPROD1") <> "" Then
                        ...
                        If Not isNormal(WW_RTN_SW) Then
                            ...
                            WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGPROD1") & ")"
                            WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                            WW_LINEERR_SW = "ERR"
                            O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                        End If
                ...
                If isNormal(WW_CS0024FCHECKERR) Then
                    ...
                    If MA0002INProw("MANGPROD2") <> "" Then
                        ...
                        If Not isNormal(WW_RTN_SW) Then
                            ...
                            WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGPROD2") & ")"
                            WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                            WW_LINEERR_SW = "ERR"
                            O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                        End If
                ...
                If isNormal(WW_CS0024FCHECKERR) Then
                    ...
                    If MA0002INProw("MANGOWNCODE") <> "" Then
                        ...
                        If Not isNormal(WW_RTN_SW) Then
                            ...
                            WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGOWNCODE") & ")"
                            WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                            WW_LINEERR_SW = "ERR"
                            O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                        End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGOWNCONT") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
                ...
                If isNormal(WW_CS0024FCHECKERR) Then
                    ...
                    If MA0002INProw("MANGSUPPL") <> "" Then
                        ...
                        If Not isNormal(WW_RTN_SW) Then
                            ...
                            WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("MANGSUPPL") & ")"
                            WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                            WW_LINEERR_SW = "ERR"
                            O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                        End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("BASELEASE") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
            ...
            If isNormal(WW_CS0024FCHECKERR) Then
                ...
                Else
                    ...
                    If Not isNormal(WW_RTN_SW) Then
                        ...
                        WW_CheckMES2 = " マスタに存在しません。(" & MA0002INProw("SHARYOSTATUS") & ")"
                        WW_CheckERR(WW_CheckMES1, WW_CheckMES2, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR, MA0002INProw)
                        WW_LINEERR_SW = "ERR"
                        O_RTN = C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR
                    End If
