...
Public Class GRTA0003KYUYOLIST_V2
    Inherits Page
    ...
    ''' 営勤共通
    ''' </summary>
    Private T0009COM As New GRT00009COM_V2                          '営勤共通
    ''' <summary>
    ''' 時間調整共通
    ''' </summary>
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = GRTA0003WRKINC_V2.MAPID
        Master.VERSION = "V2"
        ...
        Using TBLview As DataView = New DataView(TA0003VIEWtbl)
            ...
            CS0013ProfView.MAPID = GRTA0003WRKINC_V2.MAPID
    ...
    Protected Sub WF_ButtonPDF_Click()
        ...
        CS0030REPORT.MAPID = GRTA0003WRKINC_V2.MAPID                       '画面ID
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050Session.getConnection
                ...
                Dim SQLStr As String =
                   ...
                   & "       0 as SWORKTIME_V2 , " _
                   & "       0 as SWORKTIMECHO_V2 , " _
                   & "       0 as SWORKTIMETTL_V2 , " _
                   & "       0 as HWORKTIME_V2 , " _
                   & "       0 as HWORKTIMECHO_V2 , " _
                   & "       0 as HWORKTIMETTL_V2 , " _
                   & "       0 as WNIGHTTIME_V2 , " _
                   & "       0 as WNIGHTTIMECHO_V2 , " _
                   & "       0 as WNIGHTTIMETTL_V2 , " _
                   ...
                   & "       isnull(A.ROSAIYUKYNIUSSU, 0) + isnull(A.ROSAIYUKYNIUSSUCHO, 0) as ROSAIYUKYNIUSSUTTL , " _
                   & "       isnull(A.TOKUKYUMUKYUNISSU,0) as TOKUKYUMUKYUNISSU , " _
                   & "       isnull(A.TOKUKYUMUKYUNISSUCHO,0) as TOKUKYUMUKYUNISSUCHO , " _
                   & "       isnull(A.TOKUKYUMUKYUNISSU, 0) + isnull(A.TOKUKYUMUKYUNISSUCHO, 0) as TOKUKYUMUKYUNISSUTTL , " _
                   & "       isnull(A.KOKANGOYUKYUNISSU,0) as KOKANGOYUKYUNISSU , " _
                   & "       isnull(A.KOKANGOYUKYUNISSUCHO,0) as KOKANGOYUKYUNISSUCHO , " _
                   & "       isnull(A.KOKANGOYUKYUNISSU, 0) + isnull(A.KOKANGOYUKYUNISSUCHO, 0) as KOKANGOYUKYUNISSUTTL , " _
                   & "       isnull(A.KOKANGOMUKYUNISSU,0) as KOKANGOMUKYUNISSU , " _
                   & "       isnull(A.KOKANGOMUKYUNISSUCHO,0) as KOKANGOMUKYUNISSUCHO , " _
                   & "       isnull(A.KOKANGOMUKYUNISSU, 0) + isnull(A.KOKANGOMUKYUNISSUCHO, 0) as KOKANGOMUKYUNISSUTTL , " _
                   ...
                   & "       0 as HDAIWORKTIME_V2 , " _
                   & "       0 as HDAIWORKTIMECHO_V2 , " _
                   & "       0 as HDAIWORKTIMETTL_V2 , " _
                   & "       0 as SDAIWORKTIME_V2 , " _
                   & "       0 as SDAIWORKTIMECHO_V2 , " _
                   & "       0 as SDAIWORKTIMETTL_V2 , " _
                   ...
                   & "       isnull(A.OUENKAISU, 0) + isnull(A.OUENKAISUCHO, 0) as OUENKAISUTTL , " _
                   & "       isnull(A.HANCHOKAISU,0) as HANCHOKAISU , " _
                   & "       isnull(A.HANCHOKAISUCHO,0) as HANCHOKAISUCHO , " _
                   & "       isnull(A.HANCHOKAISU, 0) + isnull(A.HANCHOKAISUCHO, 0) as HANCHOKAISUTTL , " _
                ...
                Using SQLcmd0 As New SqlCommand(SQLStr0, SQLcon), SQLcmd1 As New SqlCommand(SQLStr1, SQLcon), SQLcmd As New SqlCommand(SQLStr, SQLcon)
                    ...
                    For Each TA0003ALLrow As DataRow In TA0003ALL.Rows
                        ...
                        TA0003ALLrow("WNIGHTTIMETTL") = T0009TIME.MinutesToHHMM(Val(TA0003ALLrow("WNIGHTTIMETTL")))
                        ...
                        TA0003ALLrow("HNIGHTTIMETTL") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HNIGHTTIMETTL"))
                        ...
                        '2020/04/13 ADD
                        TA0003ALLrow("ORVERTIME_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("ORVERTIME_V2"))
                        TA0003ALLrow("ORVERTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("ORVERTIMECHO_V2"))
                        TA0003ALLrow("ORVERTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("ORVERTIMETTL_V2"))
                        TA0003ALLrow("SWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("SWORKTIME_V2"))
                        TA0003ALLrow("SWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("SWORKTIMECHO_V2"))
                        TA0003ALLrow("SWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("SWORKTIMETTL_V2"))
                        TA0003ALLrow("HWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HWORKTIME_V2"))
                        TA0003ALLrow("HWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HWORKTIMECHO_V2"))
                        TA0003ALLrow("HWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HWORKTIMETTL_V2"))
                        TA0003ALLrow("WNIGHTTIME_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("WNIGHTTIME_V2"))
                        TA0003ALLrow("WNIGHTTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("WNIGHTTIMECHO_V2"))
                        TA0003ALLrow("WNIGHTTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("WNIGHTTIMETTL_V2"))
                        TA0003ALLrow("HDAIWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HDAIWORKTIME_V2"))
                        TA0003ALLrow("HDAIWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HDAIWORKTIMECHO_V2"))
                        TA0003ALLrow("HDAIWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("HDAIWORKTIMETTL_V2"))
                        TA0003ALLrow("SDAIWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("SDAIWORKTIME_V2"))
                        TA0003ALLrow("SDAIWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("SDAIWORKTIMECHO_V2"))
                        TA0003ALLrow("SDAIWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0003ALLrow("SDAIWORKTIMETTL_V2"))
                        TA0003ALLrow("OUENKAISU") = Val(TA0003ALLrow("OUENKAISU"))
                        TA0003ALLrow("OUENKAISUCHO") = Val(TA0003ALLrow("OUENKAISUCHO"))
                        TA0003ALLrow("OUENKAISUTTL") = Val(TA0003ALLrow("OUENKAISUTTL"))
                        TA0003ALLrow("HANCHOKAISU") = Val(TA0003ALLrow("HANCHOKAISU"))
                        TA0003ALLrow("HANCHOKAISUCHO") = Val(TA0003ALLrow("HANCHOKAISUCHO"))
                        TA0003ALLrow("HANCHOKAISUTTL") = Val(TA0003ALLrow("HANCHOKAISUTTL"))
                        TA0003ALLrow("YOKSAIKENSADAISU") = Val(TA0003ALLrow("YOKSAIKENSADAISU"))
                        TA0003ALLrow("YOKSAIKENSADAISUCHO") = Val(TA0003ALLrow("YOKSAIKENSADAISUCHO"))
                        TA0003ALLrow("YOKSAIKENSADAISUTTL") = Val(TA0003ALLrow("YOKSAIKENSADAISUTTL"))
                        TA0003ALLrow("KIMITUKENSADAISU") = Val(TA0003ALLrow("KIMITUKENSADAISU"))
                        TA0003ALLrow("KIMITUKENSADAISUCHO") = Val(TA0003ALLrow("KIMITUKENSADAISUCHO"))
                        TA0003ALLrow("KIMITUKENSADAISUTTL") = Val(TA0003ALLrow("KIMITUKENSADAISUTTL"))
                        '2020/04/13 ADD END
    ...
    Protected Sub ListEdit(ByRef IO_TBL As DataTable)
        ...
        For i As Integer = 0 To IO_TBL.Rows.Count - 1
            ...
            '2020/04/13 ADD
            WW_TA0003row("ORVERTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("ORVERTIME_V2"))
            WW_TA0003row("ORVERTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("ORVERTIMECHO_V2"))
            WW_TA0003row("ORVERTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("ORVERTIMETTL_V2"))
            WW_TA0003row("WNIGHTTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("WNIGHTTIME_V2"))
            WW_TA0003row("WNIGHTTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("WNIGHTTIMECHO_V2"))
            WW_TA0003row("WNIGHTTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("WNIGHTTIMETTL_V2"))
            WW_TA0003row("SWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("SWORKTIME_V2"))
            WW_TA0003row("SWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("SWORKTIMECHO_V2"))
            WW_TA0003row("SWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("SWORKTIMETTL_V2"))
            WW_TA0003row("HWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("HWORKTIME_V2"))
            WW_TA0003row("HWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("HWORKTIMECHO_V2"))
            WW_TA0003row("HWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("HWORKTIMETTL_V2"))
            '2020/04/13 ADD END
            ...
            '2020/04/13 ADD
            WW_TA0003row("ROSAIYUKYNIUSSU") = T0009TIME.ZeroToSpace(WW_TA0003row("ROSAIYUKYNIUSSU"))
            WW_TA0003row("ROSAIYUKYNIUSSUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("ROSAIYUKYNIUSSUCHO"))
            WW_TA0003row("ROSAIYUKYNIUSSUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("ROSAIYUKYNIUSSUTTL"))
            WW_TA0003row("TOKUKYUMUKYUNISSU") = T0009TIME.ZeroToSpace(WW_TA0003row("TOKUKYUMUKYUNISSU"))
            WW_TA0003row("TOKUKYUMUKYUNISSUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("TOKUKYUMUKYUNISSUCHO"))
            WW_TA0003row("TOKUKYUMUKYUNISSUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("TOKUKYUMUKYUNISSUTTL"))
            WW_TA0003row("KOKANGOYUKYUNISSU") = T0009TIME.ZeroToSpace(WW_TA0003row("KOKANGOYUKYUNISSU"))
            WW_TA0003row("KOKANGOYUKYUNISSUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("KOKANGOYUKYUNISSUCHO"))
            WW_TA0003row("KOKANGOYUKYUNISSUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("KOKANGOYUKYUNISSUTTL"))
            WW_TA0003row("KOKANGOMUKYUNISSU") = T0009TIME.ZeroToSpace(WW_TA0003row("KOKANGOMUKYUNISSU"))
            WW_TA0003row("KOKANGOMUKYUNISSUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("KOKANGOMUKYUNISSUCHO"))
            WW_TA0003row("KOKANGOMUKYUNISSUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("KOKANGOMUKYUNISSUTTL"))
            '2020/04/13 ADD END
            ...
            '2020/04/13 ADD
            WW_TA0003row("SDAIWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("SDAIWORKTIME_V2"))
            WW_TA0003row("SDAIWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("SDAIWORKTIMECHO_V2"))
            WW_TA0003row("SDAIWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("SDAIWORKTIMETTL_V2"))
            WW_TA0003row("HDAIWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("HDAIWORKTIME_V2"))
            WW_TA0003row("HDAIWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("HDAIWORKTIMECHO_V2"))
            WW_TA0003row("HDAIWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0003row("HDAIWORKTIMETTL_V2"))
            '2020/04/13 ADD END
            ...
            '2020/04/13 ADD
            WW_TA0003row("OUENKAISU") = T0009TIME.ZeroToSpace(WW_TA0003row("OUENKAISU"))
            WW_TA0003row("OUENKAISUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("OUENKAISUCHO"))
            WW_TA0003row("OUENKAISUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("OUENKAISUTTL"))
            WW_TA0003row("HANCHOKAISU") = T0009TIME.ZeroToSpace(WW_TA0003row("HANCHOKAISU"))
            WW_TA0003row("HANCHOKAISUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("HANCHOKAISUCHO"))
            WW_TA0003row("HANCHOKAISUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("HANCHOKAISUTTL"))
            WW_TA0003row("YOKSAIKENSADAISU") = T0009TIME.ZeroToSpace(WW_TA0003row("YOKSAIKENSADAISU"))
            WW_TA0003row("YOKSAIKENSADAISUCHO") = T0009TIME.ZeroToSpace(WW_TA0003row("YOKSAIKENSADAISUCHO"))
            WW_TA0003row("YOKSAIKENSADAISUTTL") = T0009TIME.ZeroToSpace(WW_TA0003row("YOKSAIKENSADAISUTTL"))
            WW_TA0003row("KIMITUKENSADAISU") = T0009TIME.ZeroToSpace(WW_TA0003row("KIMITUKENSADAISU"))
    ...
    Protected Sub WF_Grid_DBclick()
        ...
        For Each TA003row As DataRow In WW_TA003TTLtbl.Rows
            ...
            Select Case work.WF_SEL_CAMPCODE.Text
                Case GRTA0003WRKINC_V2.CONST_CAMP_ENEX  'エネックス
                    ...
                    '2020/04/13 ADD
                    WF_ROSAIYUKYNIUSSUTTL.Text = TA003row("ROSAIYUKYNIUSSUTTL") '労災
                    WF_TOKUKYUMUKYUNISSUTTL.Text = TA003row("TOKUKYUMUKYUNISSUTTL") '特休無給
                    WF_KOKANGOYUKYUNISSUTTL.Text = TA003row("KOKANGOYUKYUNISSUTTL") '子看護有給
                    WF_KOKANGOMUKYUNISSUTTL.Text = TA003row("KOKANGOMUKYUNISSUTTL") '子看護無給
                    '2020/04/13 ADD END
                    ...
                    '2020/04/13 ADD
                    WF_YOKSAIKENSADAISUTTL.Text = TA003row("YOKSAIKENSADAISUTTL") '容器再検査台数
                    WF_KIMITUKENSADAISUTTL.Text = TA003row("KIMITUKENSADAISUTTL") '機密検査台数
                    '2020/04/13 ADD END
                ...
                Case GRTA0003WRKINC_V2.CONST_CAMP_KNK  '近石
                    '月合計（編集）
                    ...
                    '2020/04/13 ADD
                    WF_ROSAIYUKYNIUSSUTTL_KNK.Text = TA003row("ROSAIYUKYNIUSSUTTL") '労災
                    WF_TOKUKYUMUKYUNISSUTTL_KNK.Text = TA003row("TOKUKYUMUKYUNISSUTTL") '特休無給
                    WF_KOKANGOYUKYUNISSUTTL_KNK.Text = TA003row("KOKANGOYUKYUNISSUTTL") '子看護有給
                    WF_KOKANGOMUKYUNISSUTTL_KNK.Text = TA003row("KOKANGOMUKYUNISSUTTL") '子看護無給
                    '2020/04/13 ADD END
                    ...
                    '2020/04/13 ADD
                    WF_TENKOKAISUTTL_KNK.Text = TA003row("TENKOKAISUTTL") '点呼回数
                    WF_SHACHUHAKNISSUTTL_KNK.Text = TA003row("SHACHUHAKNISSUTTL") '車中泊
                    WF_OUENKAISUTTL_KNK.Text = TA003row("OUENKAISUTTL") '応援手当回数
                ...
                Case GRTA0003WRKINC_V2.CONST_CAMP_NJS  'NJS
                    ...
                    '2020/04/13 ADD
                    WF_ROSAIYUKYNIUSSUTTL_NJS.Text = TA003row("ROSAIYUKYNIUSSUTTL") '労災
                    WF_TOKUKYUMUKYUNISSUTTL_NJS.Text = TA003row("TOKUKYUMUKYUNISSUTTL") '特休無給
                    WF_KOKANGOYUKYUNISSUTTL_NJS.Text = TA003row("KOKANGOYUKYUNISSUTTL") '子看護有給
                    WF_KOKANGOMUKYUNISSUTTL_NJS.Text = TA003row("KOKANGOMUKYUNISSUTTL") '子看護無給
                    '2020/04/13 ADD END
                ...
                Case GRTA0003WRKINC_V2.CONST_CAMP_JKT 'ＪＫトランス
                    '月合計（編集）
                    ...
                    '2020/04/13 ADD
                    WF_ROSAIYUKYNIUSSUTTL_JKT.Text = TA003row("ROSAIYUKYNIUSSUTTL") '労災
                    WF_TOKUKYUMUKYUNISSUTTL_JKT.Text = TA003row("TOKUKYUMUKYUNISSUTTL") '特休無給
                    WF_KOKANGOYUKYUNISSUTTL_JKT.Text = TA003row("KOKANGOYUKYUNISSUTTL") '子看護有給
                    WF_KOKANGOMUKYUNISSUTTL_JKT.Text = TA003row("KOKANGOMUKYUNISSUTTL") '子看護無給
                    '2020/04/13 ADD END
                    ...
                    WF_UNLOADADDCNT4TTL_JKT.Text = TA003row("UNLOADADDCNT4TTL") '卸危険品800
                    ...
                    WF_UNLOADCNTTTL_JKT.Text = Val(TA003row("UNLOADCNTTTL"))  '荷卸回数
    ...
    Protected Sub AddColumToTA0003Tbl(ByRef IO_TBL As DataTable)
        ...
        '2020/4113 ADD
        IO_TBL.Columns.Add("ROSAIYUKYNIUSSU", GetType(String))
        IO_TBL.Columns.Add("ROSAIYUKYNIUSSUCHO", GetType(String))
        IO_TBL.Columns.Add("ROSAIYUKYNIUSSUTTL", GetType(String))
        IO_TBL.Columns.Add("TOKUKYUMUKYUNISSU", GetType(String))
        IO_TBL.Columns.Add("TOKUKYUMUKYUNISSUCHO", GetType(String))
        IO_TBL.Columns.Add("TOKUKYUMUKYUNISSUTTL", GetType(String))
        IO_TBL.Columns.Add("KOKANGOYUKYUNISSU", GetType(String))
        IO_TBL.Columns.Add("KOKANGOYUKYUNISSUCHO", GetType(String))
        IO_TBL.Columns.Add("KOKANGOYUKYUNISSUTTL", GetType(String))
        IO_TBL.Columns.Add("KOKANGOMUKYUNISSU", GetType(String))
        IO_TBL.Columns.Add("KOKANGOMUKYUNISSUCHO", GetType(String))
        IO_TBL.Columns.Add("KOKANGOMUKYUNISSUTTL", GetType(String))
        '2020/4113 ADD END
        ...
        '2020/04/13 ADD
        IO_TBL.Columns.Add("HDAIWORKTIME_V2", GetType(String))
        IO_TBL.Columns.Add("HDAIWORKTIMECHO_V2", GetType(String))
        IO_TBL.Columns.Add("HDAIWORKTIMETTL_V2", GetType(String))
        IO_TBL.Columns.Add("SDAIWORKTIME_V2", GetType(String))
        IO_TBL.Columns.Add("SDAIWORKTIMECHO_V2", GetType(String))
        IO_TBL.Columns.Add("SDAIWORKTIMETTL_V2", GetType(String))
        '2020/04/13 ADD END
        ...
        IO_TBL.Columns.Add("HANCHOKAISU", GetType(String))
        IO_TBL.Columns.Add("HANCHOKAISUCHO", GetType(String))
        IO_TBL.Columns.Add("HANCHOKAISUTTL", GetType(String))
        IO_TBL.Columns.Add("YOKSAIKENSADAISU", GetType(String))
        IO_TBL.Columns.Add("YOKSAIKENSADAISUCHO", GetType(String))
        IO_TBL.Columns.Add("YOKSAIKENSADAISUTTL", GetType(String))
    ...
    Protected Sub CopyT7EditTbl(ByVal I_TBL As DataTable, ByRef O_TBL As DataTable)
        ...
        For Each Orow As DataRow In O_TBL.Rows
            ...
            WW_WNIGHTTIME = Orow("WNIGHTTIMETTL")
            Orow("WNIGHTTIMETTL") = T0009TIME.MinutesToHHMM(T0009TIME.HHMMToMinutes(Orow("WNIGHTTIMETTL")) +
            ...
            WW_HNIGHTTIME = Orow("HNIGHTTIMETTL")
    ...
    Protected Sub MapRefelence()
        ...
        If Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.TA0003S Then                                                   '条件画面からの画面遷移
            ...
            If IsNothing(Master.MAPID) Then Master.MAPID = GRTA0003WRKINC_V2.MAPID
            '○Grid情報保存先のファイル名
