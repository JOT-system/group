...
Public Class GRT00007SELECT
            ...
            If Not String.IsNullOrEmpty(WF_ButtonClick.Value) Then
                ...
                Select Case WF_ButtonClick.Value
                    ...
                    Case "WF_ButtonDO"                  '実行ボタン押下
                        WF_ButtonDO_Click()
                    Case "WF_ButtonDO_V2"               '実行（新）ボタン押下
    ...
    Protected Sub Initialize()
        ...
        If System.IO.File.Exists(work.WF_T7SEL_XMLsaveTmp.Text) Or
            System.IO.File.Exists(work.WF_T7SEL_XMLsaveTmp.Text) Then
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MENU Then
            ...
            work.WF_T7SEL_XMLsaveTmp.Text = work.WF_T7SEL_XMLsaveTmp.Text
            work.WF_T7SEL_XMLsavePARM.Text = work.WF_T7SEL_XMLsavePARM.Text
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007I_V2 OrElse
            Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007INJS_V2 OrElse
            Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007IKNK_V2 OrElse
            Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007IJKT_V2 Then
        ...
        Master.Btn_Control(work.WF_T7SEL_CAMPCODE.Text, GRT00007WRKINC.MAPIDS, "WF_ButtonDO", WW_DUMMY)
        Master.Btn_Control(work.WF_T7SEL_CAMPCODE.Text, GRT00007WRKINC.MAPIDS, "WF_ButtonDO_V2", WW_DUMMY)
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        '権限テーブル取得
        Dim WW_PERMITCODE As String = "0"
        T0007COM.OrgCheck(WF_CAMPCODE.Text, WF_HORG.Text, Master.ROLE_ORG, WW_PERMITCODE, WW_ERRCODE)
        If WW_ERRCODE <> C_MESSAGE_NO.NORMAL Then
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "S0012_SRVAUTHOR")
            Exit Sub
        End If
