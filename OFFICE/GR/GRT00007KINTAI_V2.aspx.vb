...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007KINTAI_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC_V2.MAPID
        ...
        '○ 右ボックスへの値設定
        rightview.MAPID = GRT00007WRKINC_V2.MAPID
    ...
    Protected Sub WF_FIELD_Change()
        ...
        Select Case WF_FIELD.Value
            ...
            Case "WF_TENKOKAISU"
                WF_PAYKBN.Focus()
            Case "WF_PAYKBN"
                WF_YOKSAIKENSADAISU.Focus()
            Case "WF_YOKSAIKENSADAISU"
                WF_KIMITUKENSADAISU.Focus()
        End Select
    ...
    Protected Sub ItemChangeCheck(ByRef oRtn As String)
        ...
        For Each T0007INProw As DataRow In T0007INPtbl.Rows
            ...
            If T0007INProw("HDKBN") = "H" And T0007INProw("RECODEKBN") = "0" Then
                ...
                T0007INProw("YOKSAIKENSADAISU") = WF_YOKSAIKENSADAISU.Text
                T0007INProw("YOKSAIKENSADAISUTTL") = WF_YOKSAIKENSADAISU.Text
                T0007INProw("KIMITUKENSADAISU") = WF_KIMITUKENSADAISU.Text
                T0007INProw("KIMITUKENSADAISUTTL") = WF_KIMITUKENSADAISU.Text
        ...
        For Each T0007INProw As DataRow In T0007INPtbl.Rows
            ...
            If T0007INProw("HDKBN") = "H" And T0007INProw("RECODEKBN") = "2" Then
                ...
                T0007INProw("YOKSAIKENSADAISUCHO") = Val(WF_YOKSAIKENSADAISUTTL.Text) - T0007INProw("YOKSAIKENSADAISU")
                T0007INProw("YOKSAIKENSADAISUTTL") = Val(T0007INProw("YOKSAIKENSADAISU")) + Val(T0007INProw("YOKSAIKENSADAISUCHO"))
                T0007INProw("KIMITUKENSADAISUCHO") = Val(WF_KIMITUKENSADAISUTTL.Text) - T0007INProw("KIMITUKENSADAISU")
                T0007INProw("KIMITUKENSADAISUTTL") = Val(T0007INProw("KIMITUKENSADAISU")) + Val(T0007INProw("KIMITUKENSADAISUCHO"))
    ...
    Protected Sub InpCHARstr()
        ...
        WF_YOKSAIKENSADAISU.Text = charStr(WF_YOKSAIKENSADAISU.Text)
        WF_KIMITUKENSADAISU.Text = charStr(WF_KIMITUKENSADAISU.Text)
        ...
        WF_YOKSAIKENSADAISUTTL.Text = charStr(WF_YOKSAIKENSADAISUTTL.Text)
        WF_KIMITUKENSADAISUTTL.Text = charStr(WF_KIMITUKENSADAISUTTL.Text)
            ...
            If T0007INProw("OPERATION") = "更新" And T0007INProw("HDKBN") = "H" Then
                For i As Integer = WW_IDX To T0007tbl.Rows.Count - 1
                    ...
                    If WW_KEYTBL = WW_KEYINP Then
                        ...
                        '-----------------------------------------------------------------------------------------------
                        If T0007row("TAISHOYM") < GRT00007WRKINC_V2.CONST_ZAN202004 Then
    ...
    Private Sub GRID_INITset()
        ...
        Try
            ...
            '早出補填を入力する部署取得
            Dim hayadeOrg As ListBox = T0007COM.getList(work.WF_T7SEL_CAMPCODE.Text, GRT00007WRKINC_V2.CONST_HAYA)
        ...
        For Each T0007INProw As DataRow In iTbl.Rows
            ...
            If T0007INProw("RECODEKBN") = "0" Then
                If T0007INProw("HDKBN") = "H" Then
                    ...
                    WF_YOKSAIKENSADAISU.Text = Val(T0007INProw("YOKSAIKENSADAISUTTL")).ToString("0")
                    WF_KIMITUKENSADAISU.Text = Val(T0007INProw("KIMITUKENSADAISUTTL")).ToString("0")
            ...
            If T0007INProw("RECODEKBN") = "2" Then
                If T0007INProw("HDKBN") = "H" Then
                    ...
                    WF_YOKSAIKENSADAISUTTL.Text = Val(T0007INProw("YOKSAIKENSADAISUTTL")).ToString("0") '容器再検査台数
                    WF_KIMITUKENSADAISUTTL.Text = Val(T0007INProw("KIMITUKENSADAISUTTL")).ToString("0") '気密検査台数
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC_V2.MAPID
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "0" Then
            ...
            If WF_STTIME.Text <> "" Then
                ...
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    ...
                    End If
                    If work.WF_T7SEL_TAISHOYM.Text > "2019/09" Then
                        If Replace(WF_BINDSTDATE.Text, ":", "").PadLeft(4, "0"c) <> "0800" Then
            ...
            '・キー項目(容器再検査台数：YOKSAIKENSADAISU)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "YOKSAIKENSADAISU"
            CS0036FCHECK.VALUE = WF_YOKSAIKENSADAISU.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_YOKSAIKENSADAISU.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(容器再検査台数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(気密検査台数：KIMITUKENSADAISU)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "KIMITUKENSADAISU"
            CS0036FCHECK.VALUE = WF_KIMITUKENSADAISU.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_KIMITUKENSADAISU.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(気密検査台数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "2" Then
            ...
            '・キー項目(容器再検査台数：YOKSAIKENSADAISUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "YOKSAIKENSADAISUTTL"
            CS0036FCHECK.VALUE = WF_YOKSAIKENSADAISUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_YOKSAIKENSADAISUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(容器再検査台数エラー)です。"
            ...
            '・キー項目(気密検査台数：KIMITUKENSADAISUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "KIMITUKENSADAISUTTL"
            CS0036FCHECK.VALUE = WF_KIMITUKENSADAISUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_KIMITUKENSADAISUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(気密検査台数エラー)です。"
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "0" Then
            ...
            If T0007COM.CheckHOLIDAY("0", WF_PAYKBN.Text) Then
                ...
                If Val(WF_TENKOKAISU.Text) > 0 Then
                    ...
                    WW_ERR = "ON"
                End If
                If Val(WF_YOKSAIKENSADAISU.Text) > 0 Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 容器再検査台数 =" & WF_YOKSAIKENSADAISU.Text & " , "
                    WW_ERR = "ON"
                End If
                If Val(WF_KIMITUKENSADAISU.Text) > 0 Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 気密検査台数 =" & WF_KIMITUKENSADAISU.Text & " , "
                    WW_ERR = "ON"
                End If
    ...
    Private Sub NIPPO_Screen()
        ...
        If T0005tbl.Rows.Count > 0 Then
            ...
            '呼出元MAPID　
            work.WF_T5_FROMMAPID.Text = GRT00007WRKINC_V2.MAPID
            '画面一覧保存パス
            ...
            '呼出元VARIANT
            work.WF_T5_FROMMAPVARIANT.Text = Master.MAPvariant & GRT00007WRKINC_V2.MAPVR
