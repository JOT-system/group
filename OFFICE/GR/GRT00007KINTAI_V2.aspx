<%@ Page Title="T00007_V2" Language="vb" AutoEventWireup="false" CodeBehind="GRT00007KINTAI_V2.aspx.vb" Inherits="OFFICE.GRT00007KINTAI_V2" %>
...
<%@ Register Src="~/GR/inc/GRT00007WRKINC_V2.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="T00007H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00007_V2.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00007_V2.js")%>'></script>
        ...
        <asp:MultiView ID="WF_DetailMView" runat="server">
            ...
            <asp:View ID="WF_DView1" runat="server" >
                ...
                <a style="position:fixed;top:12.9em;left:49em; width:32em;">
                    <asp:Label ID="WF_YOKSAIKENSADAISU_LABEL" runat="server" Text="容器再検査台数" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                ...
                <a style="position:fixed;top:14em;left:49em; width:32em;">
                    <asp:Label ID="WF_KIMITUKENSADAISU_LABEL" runat="server" Text="気密検査台数" Height="1.2em" Width="5em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                    <b>
                ...
                <!-- ■　荷卸回数　■ -->
                <a style="position:fixed;top:15.6em;left:49em; width:32em;">
                ...
                <!-- ■　走行距離　■ -->
                <a style="position:fixed;top:14.5em;left:67em; width:32em;">
                ...
                <a style="position:fixed;top:14.5em;left:73em; width:32em;">
                ...
                <a style="position:fixed;top:15.6em;left:61em; width:32em;">
                ...
                <a style="position:fixed;top:15.6em;left:71.1em; width:32em;">
                    <b>
            ...
            <!--◆◆◆◆◆◆ Tab No2　（月調整） ◆◆◆◆◆◆◆-->
                <asp:View ID="WF_DView2" runat="server" >
                    ...
                    <a style="position:fixed;top:12.2em;left:3em; width:32em;" >
                        <asp:Label ID="WF_KOKANGOYUKYUNISSUTTL_LABEL" runat="server" Text="子 看 有 給" Height="1.2em" Width="5.3em" CssClass="WF_TEXT_LEFT" Font-Bold="false" Font-Underline="false"></asp:Label>
                        <b>
                        <asp:TextBox ID="WF_KOKANGOYUKYUNISSUTTL" runat="server" Height="1.2em" Width="6em" CssClass="WF_TEXTBOX_CSS" Enabled="true" style="text-align: right; "></asp:TextBox>
                        </b>
                    </a>
                    ...
                    <a style="position:fixed;top:15.4em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:14.3em;left:14em; width:32em;" >
                    ...
                    <a style="position:fixed;top:14.3em;left:25em; width:32em;" >
                    ...
                    <!-- ■■■　手当関連２　■■■ -->
                    <a style="position:fixed;top:15.4em;left:14em; width:32em;" >
                    ...
                    <a style="position:fixed;top:15.4em;left:25em; width:32em;" >
                    ...
                    <!-- ■■■　手当関連３　■■■ -->
                    <a style="position:fixed;top:16.5em;left:25em; width:32em;" >
                    ...
                    <!-- ■■■　手当関連３　■■■ -->
                    <a style="position:fixed;top:17.6em;left:25em; width:32em;" >
                    ...
                    <!-- ■■■　手当関連６　■■■ -->
                    <a style="position:fixed;top:22.9em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:22.9em;left:14em; width:32em;" >
                    ...
                    <!-- ■■■　残業関連１　■■■ -->
                    <a style="position:fixed;top:27.2em;left:8.5em; width:32em;" >
                    ...
                    <a style="position:fixed;top:27.2em;left:14em; width:32em;" >
                    ...
                    <a style="position:fixed;top:28.3em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:29.4em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:30.5em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:31.6em;left:3em; width:32em;" >
                    ...
                    <a style="position:fixed;top:31.6em;left:13.5em; width:32em;" >
                        <b>
                    ...
                    <a style="position:fixed;top:28.3em;left:25em; width:32em;" >
                    ...
                    <a style="position:fixed;top:29.4em;left:25em; width:32em;" >
                    ...
                    <a style="position:fixed;top:30.5em;left:25em; width:32em;" >
                    ...
                    <a style="position:fixed;top:31.6em;left:25em; width:32em;" >
