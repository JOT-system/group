...
Public Class GRTA0007JIMKYUYOLIST_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = GRTA0007WRKINC_V2.MAPID
        Master.VERSION = "V2"
        ...
        Using TBLview As DataView = New DataView(TA0007VIEWtbl)
            ...
            CS0013ProfView.MAPID = GRTA0007WRKINC_V2.MAPID
    ...
    Protected Sub WF_ButtonPDF_Click()
        ...
        CS0030REPORT.MAPID = GRTA0007WRKINC_V2.MAPID                       '画面ID
            ...
            Using SQLcon As SqlConnection = CS0050Session.getConnection
                ...
                Using SQLcmd0 As New SqlCommand(SQLStr0, SQLcon), SQLcmd1 As New SqlCommand(SQLStr1, SQLcon), SQLcmd As New SqlCommand(SQLStr, SQLcon)
                    ...
                    For Each TA0007ALLrow As DataRow In TA0007ALL.Rows
                        ...
                        '2020/04/13 ADD
                        TA0007ALLrow("ORVERTIME_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("ORVERTIME_V2"))
                        TA0007ALLrow("ORVERTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("ORVERTIMECHO_V2"))
                        TA0007ALLrow("ORVERTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("ORVERTIMETTL_V2"))
                        TA0007ALLrow("SWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SWORKTIME_V2"))
                        TA0007ALLrow("SWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SWORKTIMECHO_V2"))
                        TA0007ALLrow("SWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SWORKTIMETTL_V2"))
                        TA0007ALLrow("HWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("HWORKTIME_V2"))
                        TA0007ALLrow("HWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("HWORKTIMECHO_V2"))
                        TA0007ALLrow("HWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("HWORKTIMETTL_V2"))
                        TA0007ALLrow("WNIGHTTIME_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("WNIGHTTIME_V2"))
                        TA0007ALLrow("WNIGHTTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("WNIGHTTIMECHO_V2"))
                        TA0007ALLrow("WNIGHTTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("WNIGHTTIMETTL_V2"))
                        TA0007ALLrow("HDAIWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("HDAIWORKTIME_V2"))
                        TA0007ALLrow("HDAIWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("HDAIWORKTIMECHO_V2"))
                        TA0007ALLrow("HDAIWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("HDAIWORKTIMETTL_V2"))
                        TA0007ALLrow("SDAIWORKTIME_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SDAIWORKTIME_V2"))
                        TA0007ALLrow("SDAIWORKTIMECHO_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SDAIWORKTIMECHO_V2"))
                        TA0007ALLrow("SDAIWORKTIMETTL_V2") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SDAIWORKTIMETTL_V2"))
                        TA0007ALLrow("ORVERTIMEADD") = T0009TIME.MinutesToHHMM(TA0007ALLrow("ORVERTIMEADD"))
                        TA0007ALLrow("WNIGHTTIMEADD") = T0009TIME.MinutesToHHMM(TA0007ALLrow("WNIGHTTIMEADD"))
                        TA0007ALLrow("SWORKTIMEADD") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SWORKTIMEADD"))
                        TA0007ALLrow("SNIGHTTIMEADD") = T0009TIME.MinutesToHHMM(TA0007ALLrow("SNIGHTTIMEADD"))
                        '2020/04/13 ADD END
    ...
    Protected Sub EditList(ByRef IO_TBL As DataTable)
        ...
        For i As Integer = 0 To IO_TBL.Rows.Count - 1
            ...
            '2020/04/13 ADD
            WW_TA0007row("ORVERTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("ORVERTIME_V2"))
            WW_TA0007row("ORVERTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("ORVERTIMECHO_V2"))
            WW_TA0007row("ORVERTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("ORVERTIMETTL_V2"))
            WW_TA0007row("WNIGHTTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("WNIGHTTIME_V2"))
            WW_TA0007row("WNIGHTTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("WNIGHTTIMECHO_V2"))
            WW_TA0007row("WNIGHTTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("WNIGHTTIMETTL_V2"))
            WW_TA0007row("SWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("SWORKTIME_V2"))
            WW_TA0007row("SWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("SWORKTIMECHO_V2"))
            WW_TA0007row("SWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("SWORKTIMETTL_V2"))
            WW_TA0007row("HWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("HWORKTIME_V2"))
            WW_TA0007row("HWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("HWORKTIMECHO_V2"))
            WW_TA0007row("HWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("HWORKTIMETTL_V2"))
            WW_TA0007row("ORVERTIMEADD") = T0009TIME.ZeroToSpace(WW_TA0007row("ORVERTIMEADD"))
            WW_TA0007row("WNIGHTTIMEADD") = T0009TIME.ZeroToSpace(WW_TA0007row("WNIGHTTIMEADD"))
            WW_TA0007row("SWORKTIMEADD") = T0009TIME.ZeroToSpace(WW_TA0007row("SWORKTIMEADD"))
            WW_TA0007row("SNIGHTTIMEADD") = T0009TIME.ZeroToSpace(WW_TA0007row("SNIGHTTIMEADD"))
            '2020/04/13 ADD END
            ...
            '2020/04/13 ADD
            WW_TA0007row("ROSAIYUKYNIUSSU") = T0009TIME.ZeroToSpace(WW_TA0007row("ROSAIYUKYNIUSSU"))
            WW_TA0007row("ROSAIYUKYNIUSSUCHO") = T0009TIME.ZeroToSpace(WW_TA0007row("ROSAIYUKYNIUSSUCHO"))
            WW_TA0007row("ROSAIYUKYNIUSSUTTL") = T0009TIME.ZeroToSpace(WW_TA0007row("ROSAIYUKYNIUSSUTTL"))
            WW_TA0007row("TOKUKYUMUKYUNISSU") = T0009TIME.ZeroToSpace(WW_TA0007row("TOKUKYUMUKYUNISSU"))
            WW_TA0007row("TOKUKYUMUKYUNISSUCHO") = T0009TIME.ZeroToSpace(WW_TA0007row("TOKUKYUMUKYUNISSUCHO"))
            WW_TA0007row("TOKUKYUMUKYUNISSUTTL") = T0009TIME.ZeroToSpace(WW_TA0007row("TOKUKYUMUKYUNISSUTTL"))
            WW_TA0007row("KOKANGOYUKYUNISSU") = T0009TIME.ZeroToSpace(WW_TA0007row("KOKANGOYUKYUNISSU"))
            WW_TA0007row("KOKANGOYUKYUNISSUCHO") = T0009TIME.ZeroToSpace(WW_TA0007row("KOKANGOYUKYUNISSUCHO"))
            WW_TA0007row("KOKANGOYUKYUNISSUTTL") = T0009TIME.ZeroToSpace(WW_TA0007row("KOKANGOYUKYUNISSUTTL"))
            WW_TA0007row("KOKANGOMUKYUNISSU") = T0009TIME.ZeroToSpace(WW_TA0007row("KOKANGOMUKYUNISSU"))
            WW_TA0007row("KOKANGOMUKYUNISSUCHO") = T0009TIME.ZeroToSpace(WW_TA0007row("KOKANGOMUKYUNISSUCHO"))
            WW_TA0007row("KOKANGOMUKYUNISSUTTL") = T0009TIME.ZeroToSpace(WW_TA0007row("KOKANGOMUKYUNISSUTTL"))
            '2020/04/13 ADD END
            ...
            WW_TA0007row("SDAINIGHTTIMETTL") = T0009TIME.ZeroToSpace(WW_TA0007row("SDAINIGHTTIMETTL"))
            '2020/04/13 ADD
            WW_TA0007row("SDAIWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("SDAIWORKTIME_V2"))
            WW_TA0007row("SDAIWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("SDAIWORKTIMECHO_V2"))
            WW_TA0007row("SDAIWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("SDAIWORKTIMETTL_V2"))
            WW_TA0007row("HDAIWORKTIME_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("HDAIWORKTIME_V2"))
            WW_TA0007row("HDAIWORKTIMECHO_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("HDAIWORKTIMECHO_V2"))
            WW_TA0007row("HDAIWORKTIMETTL_V2") = T0009TIME.ZeroToSpace(WW_TA0007row("HDAIWORKTIMETTL_V2"))
            '2020/04/13 ADD END
    ...
    Protected Sub CopyT7Edit(ByVal I_TBL As DataTable, ByRef O_TBL As DataTable)
        ...
        For Each Orow As DataRow In O_TBL.Rows
            ...
            Dim WW_RTN As String = C_MESSAGE_NO.NORMAL
            CodeToName("OVERTIMESTAFFKBN", Orow("STAFFKBN"), WW_TEXT, WW_RTN)
            If Not String.IsNullOrEmpty(WW_TEXT) Then WW_FIND = "ON"
            If WW_FIND = "ON" Then
                Orow("ORVERTIMETTL_V2") = "00:00"
                Orow("SWORKTIMETTL_V2") = "00:00"
                Orow("HWORKTIMETTL_V2") = "00:00"
    ...
    Protected Sub MapRefelence()
        ...
        If Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.TA0007S Then                                                       '条件画面からの画面遷移
            ...
            If Not IsNothing(Master.MAPID) Then Master.MAPID = GRTA0007WRKINC_V2.MAPID
            '○Grid情報保存先のファイル名
