<%@ Page Title="T00009S" Language="vb" AutoEventWireup="false" CodeBehind="GRT00014SELECT.aspx.vb" Inherits="OFFICE.GRT00014SELECT" %>
...
<asp:Content ID="T00014SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00014S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00014S.js")%>'></script>
</asp:Content>

<asp:Content ID="T00014S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
