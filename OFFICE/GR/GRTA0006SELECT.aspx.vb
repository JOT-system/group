...
Public Class GRTA0006SELECT
    ...
    Protected Sub WF_ButtonDO_V2_Click()
        ...
        If Not Master.MAPpermitcode = C_PERMISSION.INVALID Then
            ...
            CS0007CheckAuthority.MAPID = GRTA0006WRKINC_V2.MAPID
            ...
            If isNormal(CS0007CheckAuthority.ERR) Then
                ...
                If Master.MAPpermitcode < C_PERMISSION.REFERLANCE Then
                    Master.Output(C_MESSAGE_NO.AUTHORIZATION_ERROR, C_MESSAGE_TYPE.ABORT, "画面:" & GRTA0006WRKINC_V2.MAPID)
                    Exit Sub
                End If
            Else
                Master.Output(C_MESSAGE_NO.AUTHORIZATION_ERROR, C_MESSAGE_TYPE.ABORT, "画面:" & GRTA0006WRKINC_V2.MAPID)
    ...
    Protected Sub SetMapValue()
        ...
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.TA0006 OrElse
               Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.TA0006_V2 Then           '実行画面からの画面遷移
            '画面設定
        ...
        Master.Btn_Control(work.WF_SEL_CAMPCODE.Text, GRTA0006WRKINC.MAPIDS, "WF_ButtonDO", WW_DUMMY)
        Master.Btn_Control(work.WF_SEL_CAMPCODE.Text, GRTA0006WRKINC.MAPIDS, "WF_ButtonDO_V2", WW_DUMMY)
