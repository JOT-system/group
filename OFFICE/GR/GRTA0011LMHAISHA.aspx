<%@ Page Title="TA0011" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0011LMHAISHA.aspx.vb" Inherits="OFFICE.GRTA0011LMHAISHA" %>
...
<%@ register src="inc/GRTA0011WRKINC.ascx" tagname="work" tagprefix="LSINC" %>
<asp:Content ID="GRTA0011H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0011.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0011.js")%>"></script>
</asp:Content>
<asp:Content ID="GRTA0011" ContentPlaceHolderID="contents1" runat="server">
        ...
        <div hidden="hidden">
            ...
            <input id="WF_CheckBox_Chg" runat="server" value=""  type="text" />         <!-- チェックボックスの選択値 -->
