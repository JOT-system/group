...
#Region "<< JOTマスタ関連 >>"
    ...
    Public Class JOT_MASTER
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Function GetKProduct(ByVal I_KCODE As String) As PRODUCT
            Dim wkValue As PRODUCT = Nothing
            Dim wkKey As String = String.Format("K{0}{1}{0}{2}{0}{3}", C_VALUE_SPLIT_DELIMITER, Me.CAMPCODE, Me.ORGCODE, I_KCODE)
...
#Region "<< 光英オーダー連携関連 >>"
    ...
    Public Class GRW0001KOUEIORDER
        ...
        ''' 項目№
        ''' </summary>
        ''' <remarks>0から(ListIndex) 光英からの仕様書（コースファイル編集要領）の項目№から-1</remarks>
        Public Enum FIELDNO
            TRIP = 0            'トリップ
            SHABANCD = 5        '車番
            ROUTENO = 7         'ルート番号
            ...
            POSI_Y = 26         '光英Y座標
            SHARYOCODE = 27     '車両コード
            STAFFCODE = 28      '正乗務員コード
            SUBSTAFFCODE = 29   '副乗務員コード
            DEPOFLAG = 50       'デポフラグ
            SHABANF = 55        '前車番
            SHABANB = 56        '後車番
            STAFFINFO = 57      '乗務員情報
            SUBSTAFFINFO = 58   '副乗務員情報
            MEMO1 = 68          '注釈１
            MEMO2 = 87          '注釈２
            JOINT = 71          'ジョイント情報
            PRODUCTNAME = 72    '受注品名名称
            PRODUCTCODE = 73    '受注品名コード
            PRODUCTNUM = 74     '受注品名別量
            OWNERINFO = 78      '注文主情報
            COURSEBASEKEY = 85  'コースベースキー
            STTIME = 104        '指定出勤分
        End Enum
        ...
        Public Class KOUEI_ORDER
            ...
            ''' <remarks >№1～№110まで</remarks>
            Public Function FIELD(ByVal fieldNo As Integer) As String
                If fieldNo < 1 OrElse fieldNo > C_KOUEI_CSV_COLUMS Then Return String.Empty
            ...
            Public ReadOnly Property SHABANCD As String
                Get
                    Return _csvData(FIELDNO.SHABANCD)
                End Get
            End Property
            ''' <summary>
            ...
            Public ReadOnly Property ROUTENO As String
                Get
                    Return _csvData(FIELDNO.ROUTENO)
                End Get
            End Property
            ''' <summary>
            ''' 光英オーダーCSV No.9:回順
            ...
            Public ReadOnly Property TRIPSEQ As String
                Get
                    Return _csvData(FIELDNO.TRIPSEQ)
                End Get
            End Property
            ...
            Public ReadOnly Property DESTCODE As String
                Get
                    Return _csvData(FIELDNO.DESTCODE)
                End Get
            End Property
            ...
            Public ReadOnly Property DESTNAME As String
                Get
                    Return _csvData(FIELDNO.DESTNAME)
                End Get
            End Property
            ...
            Public ReadOnly Property POSI_X As String
                Get
                    Return _csvData(FIELDNO.POSI_X)
                End Get
            End Property
            ''' <summary>
            ...
            Public ReadOnly Property POSI_Y As String
                Get
                    Return _csvData(FIELDNO.POSI_Y)
                End Get
            End Property
            ...
            Public ReadOnly Property SHARYOCODE As String
                Get
                    Return _csvData(FIELDNO.SHARYOCODE)
                End Get
            End Property
            ''' <summary>
            ''' 光英オーダーCSV No.29:正乗務員コード
            ''' </summary>
            Public Property STAFFCODE As String
                Get
                    Return _csvData(FIELDNO.STAFFCODE)
                End Get
                Set(value As String)
                    _csvData(FIELDNO.STAFFCODE) = value
                    TARGET = True
                End Set
            End Property
            ''' <summary>
            ''' 光英オーダーCSV No.30:副乗務員コード
            ''' </summary>
            Public Property SUBSTAFFCODE As String
                Get
                    Return _csvData(FIELDNO.SUBSTAFFCODE)
                End Get
                Set(value As String)
                    _csvData(FIELDNO.SUBSTAFFCODE) = value
                End Set
            End Property
            ''' <summary>
            ...
            Public ReadOnly Property DEPOFLAG As String
                Get
                    Return _csvData(FIELDNO.DEPOFLAG)
                End Get
            End Property
            ''' <summary>
            ''' 光英オーダーCSV No.56:前車番
            ...
            Public ReadOnly Property SHABANF As String
                Get
                    Return _csvData(FIELDNO.SHABANF)
                End Get
            End Property
            ''' <summary>
            ''' 光英オーダーCSV No.57:後車番
            ...
            Public ReadOnly Property SHABANB As String
                Get
                    Return _csvData(FIELDNO.SHABANB)
                End Get
            End Property
            ''' <summary>
            ...
            Public Property STAFFINFO As String
                Get
                    Return _csvData(FIELDNO.STAFFINFO)
                End Get
                Set(value As String)
                    _csvData(FIELDNO.STAFFINFO) = value
                End Set
            End Property
            ''' <summary>
            ...
            Public Property SUBSTAFFINFO As String
                Get
                    Return _csvData(FIELDNO.SUBSTAFFINFO)
                End Get
                Set(value As String)
                    _csvData(FIELDNO.SUBSTAFFINFO) = value
                End Set
            End Property
            ''' <summary>
            ''' 光英オーダーCSV No.69:注釈１
            ...
            Public ReadOnly Property PRODUCTNAME As String()
                Get
                    Return _csvData(FIELDNO.PRODUCTNAME).Split(C_KOUEI_CSV_COLUMS_DELIMITER)
                End Get
            End Property
            ...
            Public ReadOnly Property PRODUCTCODE As String()
                Get
                    Return _csvData(FIELDNO.PRODUCTCODE).Split(C_KOUEI_CSV_COLUMS_DELIMITER)
                End Get
            End Property
            ...
            Public ReadOnly Property PRODUCTNUM As String()
                Get
                    Return _csvData(FIELDNO.PRODUCTNUM).Split(C_KOUEI_CSV_COLUMS_DELIMITER)
                End Get
            End Property
            ...
            Public ReadOnly Property OWNERINFO As String
                Get
                    Return _csvData(FIELDNO.OWNERINFO)
                End Get
            End Property
            ...
            Public Property STTIME As String
                Get
                    Return _csvData(FIELDNO.STTIME)
                End Get
                Set(value As String)
                    _csvData(FIELDNO.STTIME) = value
                End Set
            End Property
            ...
            ''' CSVデータ指定出勤分設定
            ''' </summary>
            ''' <param name="stTime">出勤時刻</param> 
            ''' <remarks>分単位 ex. 07:00→420,09:45→585</remarks> 
            Public Sub SetSTTime(ByVal stTime As DateTime)
                Me.STTIME = (stTime.Hour * 60 + stTime.Minute).ToString
            End Sub
        ...
        ''' <returns>TRUE|FALSE</returns>
        ''' <remarks> OK:00000</remarks> 
        Public Function ReadOrder(ByVal iTbl As DataTable) As Boolean
            ...
            Try
                ...
                'フィールド名とフィールドの型を取得
                While SQLdr.Read()
                    Dim tbl = iTbl.AsEnumerable.
                            Where(Function(x) x.Item("OPERATION") = "on" AndAlso
                                  x.Item("JXORDERID").Replace("W", "") = SQLdr.Item("ORDERID"))
                    ...
                    If tbl.Count > 0 Then
                        ...
                        _dicOrder.Add(order.MakeDicKey, order)
                    Else
                        Dim WW As String = SQLdr.Item("ORDERID").ToString
                    End If
                End While
        ...
        ''' <returns>TRUE|FALSE</returns>
        ''' <remarks> OK:00000</remarks> 
        Public Function ReadCSV(ByVal file As FileInfo, ByRef msg As String) As Boolean
            'ファイル名（PATHなし、拡張子なし）
                ...
                Using WW_Text As New FileIO.TextFieldParser(fileName, System.Text.Encoding.GetEncoding(932))
                    ...
                    While Not WW_Text.EndOfData
                        ...
                        If fields.Length <> C_KOUEI_CSV_COLUMS Then
                            Me.ERR = C_MESSAGE_NO.FILE_IO_ERROR
                        ...
                        If _dicOrder.ContainsKey(data.MakeDicKey) Then
                            If data.TRIPSEQ = TRIPSEQ_TYPE.START Then
                                Me.ERR = C_MESSAGE_NO.ALREADY_UPDATE_ERROR
                                PutLog(C_MESSAGE_NO.ALREADY_UPDATE_ERROR, C_MESSAGE_TYPE.ABORT, "光英データ重複キー：" & data.MakeDicKey)
                                msg = msg & ControlChars.NewLine & "更新できないレコード(光英データ重複)です。"
                                msg = msg & ControlChars.NewLine & "  --> 日付   =" & fileDate & " , "
                                msg = msg & ControlChars.NewLine & "  --> 車番   =" & data.SHABANCD & " , "
                                msg = msg & ControlChars.NewLine & "  --> 便番号 =" & data.TRIP & " , "
                            End If
                            Continue While
                            'Return False
                        End If
    ...
    Public Class KOUEI_MASTER
        ...
        ''' </summary>
        ''' <param name="koueiType">光英タイプ</param>
        ''' <param name="shaban">登録車番</param>
        ''' <returns>光英車両</returns>
        ''' <remarks >複数存在時は先頭</remarks>
        Public Function GetSharyo2RegistShaban(ByVal koueiType As String, ByVal shaban As String) As KOUEI_SHARYO
            Dim koueiTypeMst As String = _getMasterKOUEITYPE(koueiType)

            Dim sharyo = From dic In _dicSharyo
                         Select dic.Value
                         Where Value.KOUEITYPE = koueiTypeMst And Value.REGISTERSHABAN = shaban And Value.TRACTORTYPE <> "4"
            If sharyo.Count > 0 Then
                Return sharyo.First
            Else
                Return Nothing
            End If
...
#Region "<< 届先マスタ更新処理関連 >>"
    ...
    Public Class GRMC006UPDATE
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Update(ByVal order As Dictionary(Of String, GRW0001KOUEIORDER.KOUEI_ORDER), ByRef koueiMaster As KOUEI_MASTER, ByRef master As JOT_MASTER)
            ...
            '追加データ（出荷場所）
            Dim shukabasho = (From x In order.Values
                              Where x.OWNERINFO = "|基地"
                              Select koueitype = x.KOUEITYPE,
                                ...
                                destCode = x.DESTCODE,
                                destName = x.DESTNAME).Distinct

            For Each row In shukabasho
                '名称・緯度経度を光英マスタから補完
                Dim todoke = koueiMaster.GetTodoke(row.koueitype, row.destCode)
                ...
                ElseIf String.IsNullOrEmpty(todoke.NAME) Then
                    '光英マスタ名称未設定時は名称はオーダーから
                    todoke.NAME = row.destName
                End If
                'JOT届先マスタ存在チェック
                Dim jotTodoke = master.GetTodoke(todoke.GetDBEntryCode)
                If Not IsNothing(jotTodoke) Then
                    Continue For
                End If

                '届先マスタ追加データ編集
                MC006_set(row.koueitype, row.toriCode, todoke.TODOKESAKICODE, "2", todoke.NAME, todoke.LATITUDE, todoke.LONGTIDUDE)
                '届先マスタ追加
                MC006_Update(WW_RTN)
            ...
            '追加データ（届先）
            Dim todokesaki = (From x In order.Values
                              Where x.COURSEBASEKEY <> ""
                              Select koueitype = x.KOUEITYPE,
                                toriCode = If(x.KOUEITYPE = GRW0001KOUEIORDER.KOUEITYPE_PREFIX.JX, GRT00004WRKINC.C_TORICODE_JX, GRT00004WRKINC.C_TORICODE_COSMO),
                                destCode = x.DESTCODE,
                                destName = x.DESTNAME).Distinct

            For Each row In todokesaki
                '名称・緯度経度を光英マスタから補完
                Dim todoke = koueiMaster.GetTodoke(row.koueitype, row.destCode)
                If IsNothing(todoke) Then
                    'マスタ未登録時は名称はオーダーから
                ...
                '届先マスタ追加データ編集
                MC006_set(row.koueitype, row.toriCode, todoke.TODOKESAKICODE, "1", todoke.NAME, todoke.LATITUDE, todoke.LONGTIDUDE)
                '届先マスタ追加
                MC006_Update(WW_RTN)
                If Not isNormal(WW_RTN) Then
                    ERR = WW_RTN
            ...
            If updFlg = True Then
                'マスタ追加発生時は届先マスタ再読込
                master.InitTodoke(master.CAMPCODE, master.ORGCODE)
            End If
