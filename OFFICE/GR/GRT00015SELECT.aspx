<%@ Page Title="T00015S" Language="vb" AutoEventWireup="false" CodeBehind="GRT00015SELECT.aspx.vb" Inherits="OFFICE.GRT00015SELECT" %>
...
<asp:Content ID="T00015SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/T00015S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/T00015S.js")%>"></script>
</asp:Content> 
<asp:Content ID="T00015S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　searchbox -->
        <div  class="searchbox" id="searchbox">
            ...
            <div id="searchkeybox" class="searchkeybox">
                ...
                <p class="LINE_6">
                    <!-- 　油種　 -->
                    <a style="position:fixed;top:18.7em;left:4em;font-weight:bold;text-decoration:underline">油種</a>
                    <a style="position:fixed;top:18.7em;left:11.5em;"></a>
                    <a style="position:fixed;top:18.7em;left:18em;" ondblclick="Field_DBclick('WF_OILTYPE' ,<%= LIST_BOX_CLASSIFICATION.LC_OILTYPE%>)" onchange="TextBox_change('WF_OILTYPE')">
