...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007ICHIRAN_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC_V2.MAPIDI
        Master.VERSION = "V2"
    ...
    Protected Sub WF_ButtonCALC_Click()
        ...
        For Each WW_T7row As DataRow In WW_T0007SELtbl.Rows
            WW_T7row("TIMSTP") = "0"
            '-----------------------------------------------------------------------------------------------
            '～2020/03までは、日跨りで翌日が休みで稼働有り無しにより残業計算結果が変わる警告メッセージ出力
            '-----------------------------------------------------------------------------------------------
            If WW_T7row("TAISHOYM") < GRT00007WRKINC_V2.CONST_ZAN202004 Then
    ...
    Protected Sub WF_ButtonNIPPO_Click()
        ...
        For i As Integer = 0 To T0007tbl.Rows.Count - 1
            ...
            '～2020/03までは、日跨りで翌日が休みで稼働有り無しにより残業計算結果が変わる警告メッセージ出力
            '-----------------------------------------------------------------------------------------------
            If WW_TBLrow("TAISHOYM") < GRT00007WRKINC_V2.CONST_ZAN202004 Then
    ...
    Protected Sub WF_ButtonEND_Click()
        ...
        ''■■■ 画面戻先URL取得 ■■■
        'CS0017RETURNURLget.MAPID = GRT00007WRKINC_V2.MAPIDI
    ...
    '            CS0049UPROFview.MAPID = GRT00007WRKINC_V2.MAPIDI
    ...
    Private Sub GRID_INITset()
        ...
        Try
            ...
            Dim SQLStr As String =
               ...
               & "       isnull(A.YOKSAIKENSADAISU,0) as YOKSAIKENSADAISU , " _
               & "       isnull(A.YOKSAIKENSADAISUCHO,0) as YOKSAIKENSADAISUCHO , " _
            ...
            For i As Integer = 0 To T0007tbl.Rows.Count - 1
                ...
                T0007row("YOKSAIKENSADAISUTTL") = Val(T0007row("YOKSAIKENSADAISU")) + Val(T0007row("YOKSAIKENSADAISUCHO"))
                T0007row("KIMITUKENSADAISUTTL") = Val(T0007row("KIMITUKENSADAISU")) + Val(T0007row("KIMITUKENSADAISUCHO"))
    ...
    Private Sub T0007_InsertEdit(ByRef iTbl As DataTable, ByVal iDATENOW As Date, ByRef oTBL As DataTable, ByRef oRtn As String)
        ...
        For i As Integer = 0 To iTbl.Rows.Count - 1
            ...
            WW_row("YOKSAIKENSADAISU") = iRow("YOKSAIKENSADAISU")                                  '容器再検査台数
            WW_row("YOKSAIKENSADAISUCHO") = iRow("YOKSAIKENSADAISUCHO")                            '容器再検査台数調整
            WW_row("KIMITUKENSADAISU") = iRow("KIMITUKENSADAISU")                                  '気密検査台数
            WW_row("KIMITUKENSADAISUCHO") = iRow("KIMITUKENSADAISUCHO")                            '気密検査台数調整
    ...
    Public Sub T0007Insert(ByVal iRow As DataRow, ByRef I_SQLcon As SqlConnection)
        ...
        Dim SQLStr As String =
                ...
                & "        YOKSAIKENSADAISU," _
                & "        YOKSAIKENSADAISUCHO," _
                & "        KIMITUKENSADAISU," _
                & "        KIMITUKENSADAISUCHO," _
                & "        DAIKYUNISSU," _
                & "        DAIKYUNISSUCHO," _
                & "        NENSHINISSU," _
                & "        NENSHINISSUCHO," _
        ...
        Dim P_YOKSAIKENSADAISU As SqlParameter = SQLcmd.Parameters.Add("@YOKSAIKENSADAISU", System.Data.SqlDbType.Int)
        Dim P_YOKSAIKENSADAISUCHO As SqlParameter = SQLcmd.Parameters.Add("@YOKSAIKENSADAISUCHO", System.Data.SqlDbType.Int)
        Dim P_KIMITUKENSADAISU As SqlParameter = SQLcmd.Parameters.Add("@KIMITUKENSADAISU", System.Data.SqlDbType.Int)
        Dim P_KIMITUKENSADAISUCHO As SqlParameter = SQLcmd.Parameters.Add("@KIMITUKENSADAISUCHO", System.Data.SqlDbType.Int)
        ...
        P_YOKSAIKENSADAISU.Value = iRow("YOKSAIKENSADAISU")
        P_YOKSAIKENSADAISUCHO.Value = iRow("YOKSAIKENSADAISUCHO")
        P_KIMITUKENSADAISU.Value = iRow("KIMITUKENSADAISU")
        P_KIMITUKENSADAISUCHO.Value = iRow("KIMITUKENSADAISUCHO")
    ...
    Protected Sub WF_FILEUPLOAD()
        ...
        'Master.CreateEmptyTable(T0007INPtbl)
        ...
        'その他作業部署取得
        Dim otherOrg As ListBox = T0007COM.getList(work.WF_T7SEL_CAMPCODE.Text, GRT00007WRKINC_V2.CONST_OTHER)
                    ...
                    If T0007row("WORKDATE") = WW_HEADrow("WORKDATE") And
                       ...
                       T0007row("SELECT") = "1" Then
                        ...
                        If T0007row("HDKBN") = "H" Then
                            ...
                            WW_T0007row("YOKSAIKENSADAISUCHO") = Val(WW_HEADrow("YOKSAIKENSADAISUTTL")) - T0007row("YOKSAIKENSADAISU")
                            WW_T0007row("YOKSAIKENSADAISUTTL") = Val(T0007row("YOKSAIKENSADAISU")) + Val(T0007row("YOKSAIKENSADAISUCHO"))
                            WW_T0007row("KIMITUKENSADAISUCHO") = Val(WW_HEADrow("KIMITUKENSADAISUTTL")) - T0007row("KIMITUKENSADAISU")
                            WW_T0007row("KIMITUKENSADAISUTTL") = Val(T0007row("KIMITUKENSADAISU")) + Val(T0007row("KIMITUKENSADAISUCHO"))
    ...
    '        'WW_TTLDTLtbl = DTLquery.CopyToDataTable
    '        'WW_Filter = ""
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC_V2.MAPIDI
        ...
        If T0007INProw("RECODEKBN") = "2" Then
            ...
            ' *** 容器再検査台数合計(YOKSAIKENSADAISUTTL)
            If T0007INProw("YOKSAIKENSADAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(容器再検査台数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "YOKSAIKENSADAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("YOKSAIKENSADAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("YOKSAIKENSADAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
                    WW_CheckMES1 = "・更新できないレコード(容器再検査台数エラー)です。"
                    WW_CheckMES2 = CS0036FCHECK.CHECKREPORT
                    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
                End If
            End If

            ' *** 気密検査台数合計(KIMITUKENSADAISUTTL)
            If T0007INProw("KIMITUKENSADAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(気密検査台数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "KIMITUKENSADAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("KIMITUKENSADAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("KIMITUKENSADAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
                    WW_CheckMES1 = "・更新できないレコード(気密検査台数エラー)です。"
                    WW_CheckMES2 = CS0036FCHECK.CHECKREPORT
                    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
                End If
            End If
    ...
    Private Sub NIPPOget_T7Format(ByVal iKBN As String, ByRef ioT7tbl As DataTable, ByVal iT0005tbl As DataTable)
        ...
        For i As Integer = 0 To iT0005tbl.Rows.Count - 1
            ...
            T0007row("YOKSAIKENSADAISU") = "0"
            T0007row("YOKSAIKENSADAISUCHO") = "0"
            T0007row("YOKSAIKENSADAISUTTL") = "0"
            T0007row("KIMITUKENSADAISU") = "0"
            T0007row("KIMITUKENSADAISUCHO") = "0"
            T0007row("KIMITUKENSADAISUTTL") = "0"
        ...
        For i As Integer = 0 To CS0021PROFXLS.FIELD.Count - 1
            If CS0021PROFXLS.EFFECT(i) = "Y" AndAlso CS0021PROFXLS.POSIX(i) > 0 AndAlso CS0021PROFXLS.POSIY(i) > 0 Then
                ...
                If (CS0021PROFXLS.FIELD(i) = "KYOTEIWEEKNISSUTTL") OrElse
                   ...
                   (CS0021PROFXLS.FIELD(i) = "YOKSAIKENSADAISUTTL") OrElse
                   (CS0021PROFXLS.FIELD(i) = "KIMITUKENSADAISUTTL") OrElse
    ...
    Protected Sub T0007INPmake(ByRef iTBL As DataTable, ByRef iTTLFLG As String)
        ...
        For i As Integer = 0 To iTBL.Rows.Count - 1
            ...
            ' *** 容器再検査台数(YOKSAIKENSADAISU)
            If WW_COLUMNS.IndexOf("YOKSAIKENSADAISU") < 0 Then
                T0007INProw("YOKSAIKENSADAISU") = ""
            Else
                T0007INProw("YOKSAIKENSADAISU") = iTBL.Rows(i)("YOKSAIKENSADAISU")
            End If

            ' *** 気密検査台数(KIMITUKENSADAISU)
            If WW_COLUMNS.IndexOf("KIMITUKENSADAISU") < 0 Then
                T0007INProw("KIMITUKENSADAISU") = ""
            Else
                T0007INProw("KIMITUKENSADAISU") = iTBL.Rows(i)("KIMITUKENSADAISU")
            End If
            ...
            ' *** 容器再検査台数合計(YOKSAIKENSADAISUTTL)
            If WW_COLUMNS.IndexOf("YOKSAIKENSADAISUTTL") < 0 Then
                T0007INProw("YOKSAIKENSADAISUTTL") = ""
            Else
                T0007INProw("YOKSAIKENSADAISUTTL") = iTBL.Rows(i)("YOKSAIKENSADAISUTTL")
            End If

            ' *** 気密検査台数合計(KIMITUKENSADAISUTTL)
            If WW_COLUMNS.IndexOf("KIMITUKENSADAISUTTL") < 0 Then
                T0007INProw("KIMITUKENSADAISUTTL") = ""
            Else
                T0007INProw("KIMITUKENSADAISUTTL") = iTBL.Rows(i)("KIMITUKENSADAISUTTL")
            End If
    ...
    Protected Sub MAPrefelence(ByRef O_MSG As String, ByRef O_RTN As String)
        ...
        '■■■ 選択画面の入力初期値設定 ■■■
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007_V2 Then
