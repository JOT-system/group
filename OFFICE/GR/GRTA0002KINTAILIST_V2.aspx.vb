...
Public Class GRTA0002KINTAILIST_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        '○ 画面ID設定
        Master.MAPID = GRTA0002WRKINC_V2.MAPID
        Master.VERSION = "V2"
    ...
    Protected Sub GetAllTA0002()
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050SESSION.getConnection
               ...
               & "       isnull(A.HDAIWORKTIME,0) + isnull(A.HDAINIGHTTIME,0) as HDAIWORKTIME_V2 , " _
               & "       isnull(A.HDAIWORKTIMECHO,0) + isnull(A.HDAINIGHTTIMECHO,0) as HDAIWORKTIMECHO_V2 , " _
               & "       isnull(A.HDAIWORKTIME,0) + isnull(A.HDAIWORKTIMECHO,0) + isnull(A.HDAINIGHTTIME,0) + isnull(A.HDAINIGHTTIMECHO,0) as HDAIWORKTIMETTL_V2 , " _
               & "       isnull(A.SDAIWORKTIME,0) + isnull(A.SDAINIGHTTIME,0) as SDAIWORKTIME_V2 , " _
               & "       isnull(A.SDAIWORKTIMECHO,0) + isnull(A.SDAINIGHTTIMECHO,0) as SDAIWORKTIMECHO_V2 , " _
               & "       isnull(A.SDAIWORKTIME,0) + isnull(A.SDAIWORKTIMECHO,0) + isnull(A.SDAINIGHTTIME,0) + isnull(A.SDAINIGHTTIMECHO,0) as SDAIWORKTIMETTL_V2 , " _
                ...
                Using SQLcmd1 As New SqlCommand(SQLStr0, SQLcon), SQLcmd2 As New SqlCommand(SQLStr1, SQLcon), SQLcmd As New SqlCommand(SQLStr, SQLcon)
                    ...
                    For Each TA0002ALLrow As DataRow In TA0002ALL.Rows
                        ...
                        If IsDate(TA0002ALLrow("STTIME")) Then
                            TA0002ALLrow("STTIME") = CDate(TA0002ALLrow("STTIME")).ToString("HH:mm")
                        Else
                            TA0002ALLrow("STTIME") = ""
                        End If
                        ...
                        If IsDate(TA0002ALLrow("ENDTIME")) Then
                            TA0002ALLrow("ENDTIME") = CDate(TA0002ALLrow("ENDTIME")).ToString("HH:mm")
                        Else
                            TA0002ALLrow("ENDTIME") = ""
                        End If
                        If IsDate(TA0002ALLrow("BINDSTDATE")) Then
                            TA0002ALLrow("BINDSTDATE") = CDate(TA0002ALLrow("BINDSTDATE")).ToString("HH:mm")
                        Else
                        ...
                        Dim stDt As Date
                        Dim endDt As Date
                        Date.TryParse(TA0002ALLrow("STDATE") & " " & TA0002ALLrow("STTIME"), stDt)
                        Date.TryParse(TA0002ALLrow("ENDDATE") & " " & TA0002ALLrow("ENDTIME"), endDt)
                        If stDt = endDt Then
                            TA0002ALLrow("STTIME") = ""
                            TA0002ALLrow("ENDTIME") = ""
                            TA0002ALLrow("BINDSTDATE") = ""
                        ...
                        TA0002ALLrow("HDAIWORKTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(TA0002ALLrow("HDAIWORKTIMETTL_V2")))
                        TA0002ALLrow("SDAIWORKTIME_V2") = ZeroToSpace(MinituesToHHMM(TA0002ALLrow("SDAIWORKTIME_V2")))
                        TA0002ALLrow("SDAIWORKTIMECHO_V2") = ZeroToSpace(MinituesToHHMM(TA0002ALLrow("SDAIWORKTIMECHO_V2")))
                        TA0002ALLrow("SDAIWORKTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(TA0002ALLrow("SDAIWORKTIMETTL_V2")))
                        '2020/04/13 ADD END
    ...
    Protected Sub EditListEnex(ByRef IO_TBL As DataTable, ByRef O_RTN As String)
                ...
                For Each T0005row As DataRow In T0005tbl.Rows
                    ...
                    If T0005row("WORKKBN") = "F3" Then
                        ...
                        If WW_F3CNT = 1 Then
                            ...
                            WW_TA0002row("YOKSAIKENSADAISU") = ZeroToSpace(WW_TA0002row("YOKSAIKENSADAISU"))
                            WW_TA0002row("YOKSAIKENSADAISUCHO") = ZeroToSpace(WW_TA0002row("YOKSAIKENSADAISUCHO"))
                            WW_TA0002row("YOKSAIKENSADAISUTTL") = ZeroToSpace(WW_TA0002row("YOKSAIKENSADAISUTTL"))
                            WW_TA0002row("KIMITUKENSADAISU") = ZeroToSpace(WW_TA0002row("KIMITUKENSADAISU"))
                            WW_TA0002row("KIMITUKENSADAISUCHO") = ZeroToSpace(WW_TA0002row("KIMITUKENSADAISUCHO"))
                            WW_TA0002row("KIMITUKENSADAISUTTL") = ZeroToSpace(WW_TA0002row("KIMITUKENSADAISUTTL"))
                            '2020/04/13 ADD END
                        End If
        ...
        Dim WW_YOKSAIKENSADAISU As Integer = 0
        Dim WW_KIMITUKENSADAISU As Integer = 0
        ...
        For Each TA0002Row As DataRow In WW_TA0002tbl.Rows
            ...
            WW_YOKSAIKENSADAISU += Val(TA0002Row("YOKSAIKENSADAISUTTL"))
            WW_KIMITUKENSADAISU += Val(TA0002Row("KIMITUKENSADAISUTTL"))
        Next
        ...
        WW_TA0002row("ORVERTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(WW_ORVERTIME_V2))
        WW_TA0002row("WNIGHTTIMETTL") = ZeroToSpace(MinituesToHHMM(WW_WNIGHTTIME))
        WW_TA0002row("WNIGHTTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(WW_WNIGHTTIME_V2))
        WW_TA0002row("HWORKTIMETTL") = ZeroToSpace(MinituesToHHMM(WW_HWORKTIME))
        WW_TA0002row("HWORKTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(WW_HWORKTIME_V2))
        ...
        WW_TA0002row("SWORKTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(WW_SWORKTIME_V2))
        ...
        WW_TA0002row("YOKSAIKENSADAISUTTL") = ZeroToSpace(WW_YOKSAIKENSADAISU)
        WW_TA0002row("KIMITUKENSADAISUTTL") = ZeroToSpace(WW_KIMITUKENSADAISU)
    ...
    Protected Sub EditListKNK(ByRef IO_TBL As DataTable, ByRef O_RTN As String)
            ...
            If WW_TA0002row("RECODEKBN") = "0" Then
                ...
                For Each T0005row As DataRow In T0005tbl.Rows
                    ...
                    If T0005row("WORKKBN") = "F3" Then
                        ...
                        End If
                        '2020/05/25 ADD
                        If WW_KAIJI <> Val(WW_TA0002row("KAITENCNT")) Then
                            WW_TA0002row("TRIPNO") = WW_TA0002row("KAITENCNT")
                        End If
                        '2020/05/25 ADD END
                        ...
                        If WW_F3CNT = 1 Then
                            ...
                            WW_TA0002row("WNIGHTTIMECHO_V2") = ZeroToSpace(WW_TA0002row("WNIGHTTIMECHO_V2"))
                            WW_TA0002row("WNIGHTTIMETTL_V2") = ZeroToSpace(WW_TA0002row("WNIGHTTIMETTL_V2"))
                            WW_TA0002row("HDAIWORKTIME_V2") = ZeroToSpace(WW_TA0002row("HDAIWORKTIME_V2"))
                            WW_TA0002row("HDAIWORKTIMECHO_V2") = ZeroToSpace(WW_TA0002row("HDAIWORKTIMECHO_V2"))
                            WW_TA0002row("HDAIWORKTIMETTL_V2") = ZeroToSpace(WW_TA0002row("HDAIWORKTIMETTL_V2"))
                            WW_TA0002row("SDAIWORKTIME_V2") = ZeroToSpace(WW_TA0002row("SDAIWORKTIME_V2"))
                            WW_TA0002row("SDAIWORKTIMECHO_V2") = ZeroToSpace(WW_TA0002row("SDAIWORKTIMECHO_V2"))
                            WW_TA0002row("SDAIWORKTIMETTL_V2") = ZeroToSpace(WW_TA0002row("SDAIWORKTIMETTL_V2"))
                            WW_TA0002row("OUENKAISU") = ZeroToSpace(WW_TA0002row("OUENKAISU"))
                            WW_TA0002row("OUENKAISUCHO") = ZeroToSpace(WW_TA0002row("OUENKAISUCHO"))
                            WW_TA0002row("OUENKAISUTTL") = ZeroToSpace(WW_TA0002row("OUENKAISUTTL"))
                            WW_TA0002row("HANCHOKAISU") = ZeroToSpace(WW_TA0002row("HANCHOKAISU"))
                            WW_TA0002row("HANCHOKAISUCHO") = ZeroToSpace(WW_TA0002row("HANCHOKAISUCHO"))
                            WW_TA0002row("HANCHOKAISUTTL") = ZeroToSpace(WW_TA0002row("HANCHOKAISUTTL"))
                            '2020/04/13 ADD END
                        End If
        ...
        Dim WW_HAISOTIME As Integer = 0
        Dim WW_SHACHUHAKKBN As Integer = 0
        Dim WW_OUENKAISU As Integer = 0
        Dim WW_HANCHOKAISU As Integer = 0
        ...
        For Each TA0002Row As DataRow In WW_TA0002tbl.Rows
            ...
            WW_HDAIWORKTIME_V2 += HHMMtoMinutes(TA0002Row("HDAIWORKTIMETTL_V2"))
            WW_HDAINIGHTTIME += HHMMtoMinutes(TA0002Row("HDAINIGHTTIMETTL"))
            WW_SWORKTIME += HHMMtoMinutes(TA0002Row("SWORKTIMETTL"))
            WW_SWORKTIME_V2 += HHMMtoMinutes(TA0002Row("SWORKTIMETTL_V2"))
            WW_SNIGHTTIME += HHMMtoMinutes(TA0002Row("SNIGHTTIMETTL"))
            WW_SDAIWORKTIME += HHMMtoMinutes(TA0002Row("SDAIWORKTIMETTL"))
            WW_SDAIWORKTIME_V2 += HHMMtoMinutes(TA0002Row("SDAIWORKTIMETTL_V2"))
            ...
            WW_HAISOTIME += HHMMtoMinutes(TA0002Row("HAISOTIME"))
            WW_SHACHUHAKKBN += Val(TA0002Row("SHACHUHAKKBN"))
            WW_OUENKAISU += Val(TA0002Row("OUENKAISUTTL"))
            WW_HANCHOKAISU += Val(TA0002Row("HANCHOKAISUTTL"))
        Next
        ...
        WW_TA0002row("HDAIWORKTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(WW_HDAIWORKTIME_V2))
        ...
        WW_TA0002row("SDAIWORKTIMETTL_V2") = ZeroToSpace(MinituesToHHMM(WW_SDAIWORKTIME_V2))
        ...
        WW_TA0002row("HAISOTIME") = ZeroToSpace(MinituesToHHMM(WW_HAISOTIME))
        WW_TA0002row("SHACHUHAKKBN") = ZeroToSpace(WW_SHACHUHAKKBN)
        WW_TA0002row("OUENKAISUTTL") = ZeroToSpace(WW_OUENKAISU)
        WW_TA0002row("HANCHOKAISUTTL") = ZeroToSpace(WW_HANCHOKAISU)
    ...
    Protected Sub EditListJKT(ByRef IO_TBL As DataTable, ByRef O_RTN As String)
        ...
        For i As Integer = 0 To IO_TBL.Rows.Count - 1
            ...
            If WW_TA0002row("RECODEKBN") = "0" Then
                ...
                '        WW_B2CNT += 1
                '    End If
                '    If T0005row("WORKKBN") = "B2" AndAlso
                '      (T0005row("OILPAYKBN") = "02" OrElse
                '       T0005row("OILPAYKBN") = "03") AndAlso
                '       WW_B2CNT = 0 Then
                '        T0005row("TUMIOKIKBN") = "9"
                '        WW_B2CNT += 1
                '    End If
                'Next
                ...
                For Each T0005row As DataRow In T0005tbl.Rows
                    ...
                    '積置区分=1は、太陽油脂、インフィニアムの積置きを意味する
                    If T0005row("WORKKBN") = "B3" OrElse (T0005row("WORKKBN") = "B2" And T0005row("TUMIOKIKBN") = "9") Then
                        If T0005row("SUISOKBN") <> "1" Then
                            'カウント（届数）
                            If T0005row("WORKKBN") = "B3" Then
                                WW_B3CNT += 1
                    ...
                    If T0005row("WORKKBN") = "Z1" Then
                        ...
                        WW_TA0002row("UNLOADCNTCHO") = ZeroToSpace(Val(WW_B3CNT).ToString("#"))
                        WW_TA0002row("UNLOADCNTTTL") = ZeroToSpace(Val(WW_B3CNT).ToString("#"))
                        WW_TA0002row("LOADINGCNT1") = ZeroToSpace(Val(WW_LOADINGCNT).ToString("#"))
                        WW_TA0002row("LOADINGCNT1CHO") = ZeroToSpace(Val(WW_LOADINGCNT).ToString("#"))
                        WW_TA0002row("LOADINGCNT1TTL") = ZeroToSpace(Val(WW_LOADINGCNT).ToString("#"))
                        ...
                        If WW_F3CNT = 1 Then
                            ...
                            Dim stDt As Date
                            Dim endDt As Date
                            Date.TryParse(WW_TA0002row("STDATE") & " " & WW_TA0002row("STTIME"), stDt)
                            Date.TryParse(WW_TA0002row("ENDDATE") & " " & WW_TA0002row("ENDTIME"), endDt)
                            If stDt = endDt Then
                                WW_TA0002row("STTIME") = ""
                                WW_TA0002row("ENDTIME") = ""
                            End If
                            'WW_TA0002row("STTIME") = ZeroToSpace(WW_TA0002row("STTIME"))
                            'WW_TA0002row("ENDTIME") = ZeroToSpace(WW_TA0002row("ENDTIME"))
                            If WW_TA0002row("STTIME") = "" AndAlso WW_TA0002row("ENDTIME") = "" Then
        ...
        WW_NIPPOtbl.Columns.Add("TRIPNO", GetType(Integer))
        WW_NIPPOtbl.Columns.Add("UNLOADCNT", GetType(Integer))
        'WW_NIPPOtbl.Columns.Add("LOADINGCNT", GetType(Integer))
        WW_NIPPOtbl.Columns.Add("SURYO", GetType(Double))
        WW_NIPPOtbl.Columns.Add("HAIDISTANCE", GetType(Double))
        ...
        For Each TA0002Row As DataRow In WW_TA0002tbl.Rows
            ...
            WW_NIPPOrow("TRIPNO") = Val(TA0002Row("TRIPNO"))
            WW_NIPPOrow("UNLOADCNT") = Val(TA0002Row("UNLOADCNT"))
            'WW_NIPPOrow("LOADINGCNT") = Val(TA0002Row("LOADINGCNT1"))
            WW_NIPPOrow("SURYO") = Val(TA0002Row("SURYO"))
            WW_NIPPOrow("HAIDISTANCE") = Val(TA0002Row("HAIDISTANCE"))
        ...
        dtFilter.Columns.Add("TRIPNO", GetType(Integer))
        dtFilter.Columns.Add("UNLOADCNT", GetType(Integer))
        'dtFilter.Columns.Add("LOADINGCNT", GetType(Integer))
        dtFilter.Columns.Add("SURYO", GetType(Double))
        dtFilter.Columns.Add("HAIDISTANCE", GetType(Double))
        For Each row As DataRow In dtFilter.Rows
            Dim expr As String = String.Format("KEY = '{0}' AND PRODUCT1 = '{1}' AND PRODUCT1NAMES = '{2}'", row("KEY"), row("PRODUCT1"), row("PRODUCT1NAMES"))
            row("TRIPNO") = WW_NIPPOtbl.Compute("SUM(TRIPNO)", expr)
            row("UNLOADCNT") = WW_NIPPOtbl.Compute("SUM(UNLOADCNT)", expr)
            'row("LOADINGCNT") = WW_NIPPOtbl.Compute("SUM(LOADINGCNT)", expr)
            row("SURYO") = WW_NIPPOtbl.Compute("SUM(SURYO)", expr)
            row("HAIDISTANCE") = WW_NIPPOtbl.Compute("SUM(HAIDISTANCE)", expr)
        Next
        ...
        For Each row As DataRow In dtFilter.Rows
            ...
            WW_TA0002row("TRIPNO") = ZeroToSpace(row("TRIPNO"))
            WW_TA0002row("UNLOADCNTTTL") = ZeroToSpace(row("UNLOADCNT"))
            'WW_TA0002row("LOADINGCNT1TTL") = ZeroToSpace(row("LOADINGCNT"))
            WW_TA0002row("SURYO") = ZeroToSpace(Val(row("SURYO")).ToString("#0.000"))
            WW_TA0002row("HAIDISTANCETTL") = ZeroToSpace(Val(row("HAIDISTANCE")).ToString("#"))
            ...
            If TA002INProw("RECODEKBN") = "0" Then
                If TA002INProw("HDKBN") = "H" Then
                    ...
                    If work.WF_SEL_CAMPCODE.Text = CONST_CAMP_ENEX Then
                        ...
                        WF_YOKSAIKENSADAISU.Text = TA002INProw("YOKSAIKENSADAISUTTL")
                        WF_KIMITUKENSADAISU.Text = TA002INProw("KIMITUKENSADAISUTTL")
                    ...
                    If work.WF_SEL_CAMPCODE.Text = CONST_CAMP_KNK Then
                        ...
                        If TA002INProw("SHACHUHAKKBN") = "1" Then
                            WF_SHACHUHAKKBN_KNK.Checked = True
                        Else
                            WF_SHACHUHAKKBN_KNK.Checked = False
                        End If
                        WF_TENKOKAISU_KNK.Text = TA002INProw("TENKOKAISUTTL")
                        WF_OUENKAISU_KNK.Text = TA002INProw("OUENKAISUTTL")
                        WF_HANCHOKAISU_KNK.Text = TA002INProw("HANCHOKAISUTTL")
                    End If
                    ...
                    If work.WF_SEL_CAMPCODE.Text = CONST_CAMP_JKT Then
                        ...
                        'WF_LOADINGCNT_JKT.Text = TA002INProw("LOADINGCNT1TTL")
                    End If
                End If
            End If
        Next
    ...
    Private Sub GetNIPPO(ByRef IO_TBL As DataTable, ByVal I_WORKDATE As String, ByVal I_STAFFCODE As String, ByVal I_NIPPOLINKCODE As String, ByRef O_RTN As String)
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050SESSION.getConnection
               ...
               & "       CASE WORKKBN WHEN 'B3' THEN isnull(rtrim(F11.KEYCODE),'') ELSE '' END as OILPAYKBN , " _
               ...
               & "   and   F11.KEYCODE     = (CASE WHEN isnull(F10.VALUE1,'') <> '' THEN F10.VALUE1 ELSE MA6.OILKBN END) " _
               & "   and   F11.STYMD      <= @STYMD " _
               & "   and   F11.ENDYMD     >= @ENDYMD " _
               & "   and   F11.DELFLG     <> '1' " _
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050SESSION.getConnection
                ...
                Dim SQLStr As String =
                   ...
                   & "       CASE WHEN isnull(rtrim(F3.VALUE1),'') <> '' THEN F3.VALUE1 ELSE (CASE WHEN isnull(rtrim(F4.VALUE1),'') <> '' THEN F4.VALUE1 ELSE isnull(rtrim(MA6.OILKBN),'') END) END as OILPAYKBN ," _
                   ...
                   & "   and   F2.DELFLG     <> '1' " _
                   & " LEFT JOIN MC001_FIXVALUE F3 " _
                   & "   ON    F3.CAMPCODE     = A.CAMPCODE " _
                   & "   and   F3.CLASS        = 'SPECIALTORI' " _
                   & "   and   F3.KEYCODE      = A.L1TORICODE " _
                   & "   and   F3.STYMD       <= @P5 " _
                   & "   and   F3.ENDYMD      >= @P5 " _
                   & "   and   F3.DELFLG      <> '1' " _
                   & " LEFT JOIN MC001_FIXVALUE F4 " _
                   & "   ON    F4.CAMPCODE     = A.CAMPCODE " _
                   & "   and   F4.CLASS        = 'SPECIALSHUKABASHO' " _
                   & "   and   F4.KEYCODE      = A.L1SHUKABASHO " _
                   & "   and   F4.STYMD       <= @P5 " _
                   & "   and   F4.ENDYMD      >= @P5 " _
                   & "   and   F4.DELFLG      <> '1' " _
                   ...
                   & "   and   F5.KEYCODE     = (CASE WHEN isnull(F3.VALUE1,'') <> '' THEN F3.VALUE1 ELSE (CASE WHEN isnull(F4.VALUE1,'') <> '' THEN F4.VALUE1 ELSE MA6.OILKBN END) END) " _
                   & "   and   F5.STYMD      <= @P5 " _
                   & "   and   F5.ENDYMD     >= @P5 " _
                   & "   and   F5.DELFLG     <> '1' " _
