...
Public Class GRMA0007SELECT
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = GRMA0007WRKINC.MAPIDS
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        '荷主車番 
        Master.CheckField(WF_NSHABAN.Text, "NSHABAN", WF_NSHABAN.Text, WW_CS0024FCHECKERR, WW_CS0024FCHECKREPORT)
