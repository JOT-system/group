...
Public Class GRMC0014SELECT
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = GRMC0014WRKINC.MAPIDS
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        work.WF_SEL_PRODUCT1.Text = WF_PRODUCT1.Text           '売上費用区分
        work.WF_SEL_URIHIYOKBN.Text = WF_URIHIYOKBN.Text          '荷主車番
            ...
            With leftview
                If WF_LeftMViewChange.Value <> LIST_BOX_CLASSIFICATION.LC_CALENDAR Then
                    ...
                    Select Case WF_FIELD.Value
                        ...
                        Case "WF_PRODUCT1"       '売上費用区分
                            prmData = work.CreateFIXParam(WF_CAMPCODE.Text, "PRODUCT1")
                    End Select
    ...
    Protected Sub WW_LeftBoxReSet()
        ...
        Master.EraseCharToIgnore(WF_CAMPCODE.Text)          '会社コード
        Master.EraseCharToIgnore(WF_TORICODE.Text)          '取引先コード
        Master.EraseCharToIgnore(WF_PRODUCT1.Text)    '運賃計算機能コード
        Master.EraseCharToIgnore(WF_URIHIYOKBN.Text)           '荷主車番
        Master.EraseCharToIgnore(WF_STYMD.Text)             '有効年月日(From)
        Master.EraseCharToIgnore(WF_ENDYMD.Text)            '有効年月日(To)
        ...
        leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, WF_PRODUCT1.Text, WF_PRODUCT1_TEXT.Text, WW_DUMMY, work.CreateFIXParam(WF_CAMPCODE.Text))   '運賃計算機能コード
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MENU Then                       'メニューからの画面遷移
            ...
            Master.GetFirstValue(work.WF_SEL_CAMPCODE.Text, "PRODUCT1", WF_PRODUCT1.Text)    '運賃計算機能コード
            Master.GetFirstValue(work.WF_SEL_CAMPCODE.Text, "URIHIYOKBN", WF_URIHIYOKBN.Text)                  '荷主車番
            ...
            '○RightBox情報設定
            rightview.MAPID = GRMC0014WRKINC.MAPID
            rightview.MAPIDS = GRMC0014WRKINC.MAPIDS
            ...
            If Not isNormal(WW_ERR_SW) Then
                Exit Sub
            End If
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MC0014 Then         '実行画面からの画面遷移
            '○画面項目設定処理                                       
            WF_CAMPCODE.Text = work.WF_SEL_CAMPCODE.Text                     '会社コード                            
            WF_TORICODE.Text = work.WF_SEL_TORICODE.Text                     '取引先コード                            
            WF_PRODUCT1.Text = work.WF_SEL_PRODUCT1.Text         '運賃計算機能コード                            
            WF_URIHIYOKBN.Text = work.WF_SEL_URIHIYOKBN.Text                       '荷主車番                            
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        Master.CheckField(WF_CAMPCODE.Text, "TORICODE", WF_CAMPCODE.Text, WW_CS0024FCHECKERR, WW_CS0024FCHECKREPORT)
        If isNormal(WW_CS0024FCHECKERR) Then
            '存在チェック
            If WW_TEXT = "" Then
                WF_TORICODE.Text = ""
        ...
        '運賃計算機能コード 
        WW_TEXT = WF_PRODUCT1.Text
        Master.CheckField(WF_CAMPCODE.Text, "PRODUCT1", WF_CAMPCODE.Text, WW_CS0024FCHECKERR, WW_CS0024FCHECKREPORT)
        If isNormal(WW_CS0024FCHECKERR) Then
            '存在チェック
            If WW_TEXT = "" Then
                WF_PRODUCT1.Text = ""
            Else
                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, WF_PRODUCT1.Text, WF_PRODUCT1_TEXT.Text, WW_RTN_SW, work.CreateFIXParam(WF_CAMPCODE.Text, "PRODUCT1"))
                If Not isNormal(WW_RTN_SW) Then
                    Master.Output(C_MESSAGE_NO.INVALID_SELECTION_DATA, C_MESSAGE_TYPE.ERR)
                    WF_PRODUCT1.Focus()
                    O_RTN = WW_RTN_SW
