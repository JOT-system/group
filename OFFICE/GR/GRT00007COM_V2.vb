...
Public Class GRT0007COM_V2
    ...
    ' ***  合計明細作成
    Public Sub CreTTLDTL(ByRef ioTBL As DataTable)
            ...
            If DTLcnt = 0 Then
                For i As Integer = 1 To 2
                    For j As Integer = 1 To 10
                        ...
                        INProw_Init(WW_HEADrow("CAMPCODE"), WW_T0007row)
    ...
    Public Sub T0007_ChoseiRecodeCreate(ByRef ioTbl As DataTable)
        ...
        Try
            ...
            Dim TTLquery = (From t As DataRow In ioTbl.Rows
                            Where t("SELECT") = "1" AndAlso t("HDKBN") = "H" AndAlso t("RECODEKBN") = "2"
                            Select t
                     )
            Dim ETCquery = (From e As DataRow In ioTbl.Rows
                            Where Not (e("SELECT") = "1" AndAlso e("HDKBN") = "H" AndAlso e("RECODEKBN") = "2") AndAlso e("RECODEKBN") <> "1"
                            Select e
                     )
            If TTLquery.Count > 0 Then
                WW_T0007TTLtbl = TTLquery.CopyToDataTable
            End If
            If ETCquery.Count > 0 Then
                WW_T0007ETCtbl = ETCquery.CopyToDataTable
            End If
            ...
            For Each WW_TTLrow As DataRow In WW_T0007TTLtbl.Rows
                ...
                '2020/04/13 ADD
                WW_CHOrow("ROSAIYUKYNIUSSUTTL") = Val(WW_CHOrow("ROSAIYUKYNIUSSU")) + Val(WW_CHOrow("ROSAIYUKYNIUSSUCHO"))
                WW_CHOrow("TOKUKYUMUKYUNISSUTTL") = Val(WW_CHOrow("TOKUKYUMUKYUNISSU")) + Val(WW_CHOrow("TOKUKYUMUKYUNISSUCHO"))
                WW_CHOrow("KOKANGOYUKYUNISSUTTL") = Val(WW_CHOrow("KOKANGOYUKYUNISSU")) + Val(WW_CHOrow("KOKANGOYUKYUNISSUCHO"))
                WW_CHOrow("KOKANGOMUKYUNISSUTTL") = Val(WW_CHOrow("KOKANGOMUKYUNISSU")) + Val(WW_CHOrow("KOKANGOMUKYUNISSUCHO"))
                ...
                '2020/04/13 ADD
                WW_CHOrow("OUENKAISUTTL") = Val(WW_CHOrow("OUENKAISU")) + Val(WW_CHOrow("OUENKAISUCHO"))
                WW_CHOrow("HANCHOKAISUTTL") = Val(WW_CHOrow("HANCHOKAISU")) + Val(WW_CHOrow("HANCHOKAISUCHO"))
                WW_CHOrow("KOKANGOYUKYUNISSUTTL") = Val(WW_CHOrow("KOKANGOYUKYUNISSU")) + Val(WW_CHOrow("KOKANGOYUKYUNISSUCHO"))
                WW_CHOrow("KOKANGOMUKYUNISSUTTL") = Val(WW_CHOrow("KOKANGOMUKYUNISSU")) + Val(WW_CHOrow("KOKANGOMUKYUNISSUCHO"))
                ...
                WW_CHOrow("HDAIWORKTIMECHO") = HHMMtoMinutes(WW_CHOrow("HDAIWORKTIMECHO"))
                WW_CHOrow("HDAINIGHTTIMECHO") = HHMMtoMinutes(WW_CHOrow("HDAINIGHTTIMECHO"))
                WW_CHOrow("SDAIWORKTIMECHO") = HHMMtoMinutes(WW_CHOrow("SDAIWORKTIMECHO"))
                WW_CHOrow("SDAINIGHTTIMECHO") = HHMMtoMinutes(WW_CHOrow("SDAINIGHTTIMECHO"))
    ...
    Public Sub T0007_TotalRecodeCreate(ByRef ioTbl As DataTable)
        ...
        Try
            ...
            '配送距離（日報）を日々のヘッダに反映
            Dim WW_HAIDISTANCE As Integer = 0
            Dim WW_HAIDISTANCETTL As Integer = 0
            Dim WW_KAIDISTANCE As Integer = 0
            Dim WW_KAIDISTANCETTL As Integer = 0
            Dim WW_LOADINGCNT As Integer = 0
            Dim WW_B3CNT As Integer = 0
            For Each WW_HEADrow As DataRow In WW_T0007HEADtbl.Rows
                If WW_HEADrow("RECODEKBN") = "0" Then
                    For Each WW_DTLrow As DataRow In WW_T0007DTLtbl.Rows
                        If WW_HEADrow("WORKDATE") = WW_DTLrow("WORKDATE") AndAlso
                           WW_HEADrow("STAFFCODE") = WW_DTLrow("STAFFCODE") Then
                            If WW_DTLrow("WORKKBN") = "B3" Then
                                If WW_DTLrow("OILPAYKBN") <> "10" Then
                                    '荷卸（B3）をカウントする（水素はカウントしない）
                                    WW_B3CNT += 1
                                End If
                            End If
                            If WW_DTLrow("WORKKBN") = "F3" Then
                                WW_HAIDISTANCE += Val(WW_DTLrow("HAIDISTANCE"))
                                WW_HAIDISTANCETTL += Val(WW_DTLrow("HAIDISTANCETTL"))
                                WW_KAIDISTANCE += Val(WW_DTLrow("KAIDISTANCE"))
                                WW_KAIDISTANCETTL += Val(WW_DTLrow("KAIDISTANCETTL"))
                            End If
                        End If
                    Next

                    ''JKTの太陽油脂、インフィニアムの場合、積置きをカウントする
                    'If WW_HEADrow("CAMPCODE") = "05" Then
                    '    Dim WW_B2CNT As Integer = 0
                    '    For i As Integer = WW_T0007DTLtbl.Rows.Count - 1 To 0 Step -1
                    ...
                    '                WW_B2CNT += 1
                    '            End If
                    '            If WW_DTLrow("WORKKBN") = "B2" AndAlso
                    '              (WW_DTLrow("OILPAYKBN2") = "02" OrElse
                    '               WW_DTLrow("OILPAYKBN2") = "03") AndAlso
                    '               WW_B2CNT = 0 Then
                    '                WW_LOADINGCNT += 1
                    '                WW_B2CNT += 1
                    '            End If
                    ...
                    WW_HEADrow("HAIDISTANCE") = WW_HAIDISTANCE
                    WW_HEADrow("HAIDISTANCECHO") = 0
                    WW_HEADrow("HAIDISTANCETTL") = WW_HAIDISTANCETTL
                    WW_HEADrow("KAIDISTANCE") = WW_KAIDISTANCE
                    WW_HEADrow("KAIDISTANCECHO") = 0
                    WW_HEADrow("KAIDISTANCETTL") = WW_KAIDISTANCETTL
                    WW_HEADrow("UNLOADCNT") = WW_B3CNT
                    WW_HEADrow("UNLOADCNTCHO") = 0
                    WW_HEADrow("UNLOADCNTTTL") = WW_B3CNT
                    WW_HEADrow("LOADINGCNT1") = 0
                    WW_HEADrow("LOADINGCNT1CHO") = 0
            ...
            For Each WW_CHOrow As DataRow In WW_T0007HEADtbl.Rows
                ...
                For i As Integer = WW_IDX To WW_T0007HEADtbl.Rows.Count - 1
                    ...
                    If WW_HEADrow("STAFFCODE") = WW_CHOrow("STAFFCODE") Then
                        If WW_HEADrow("RECODEKBN") = "0" Then
                            ...
                            '2020/04/13 ADD
                            WW_CHOrow("ROSAIYUKYNIUSSU") = Val(WW_CHOrow("ROSAIYUKYNIUSSU")) + WW_HEADrow("ROSAIYUKYNIUSSU")
                            WW_CHOrow("ROSAIYUKYNIUSSUCHO") = 0
                            WW_CHOrow("TOKUKYUMUKYUNISSU") = Val(WW_CHOrow("TOKUKYUMUKYUNISSU")) + WW_HEADrow("TOKUKYUMUKYUNISSU")
                            WW_CHOrow("TOKUKYUMUKYUNISSUCHO") = 0
                            WW_CHOrow("KOKANGOYUKYUNISSU") = Val(WW_CHOrow("KOKANGOYUKYUNISSU")) + WW_HEADrow("KOKANGOYUKYUNISSU")
                            WW_CHOrow("KOKANGOYUKYUNISSUCHO") = 0
                            WW_CHOrow("KOKANGOMUKYUNISSU") = Val(WW_CHOrow("KOKANGOMUKYUNISSU")) + WW_HEADrow("KOKANGOMUKYUNISSU")
                            WW_CHOrow("KOKANGOMUKYUNISSUCHO") = 0
                            ...
                            '2020/04/13 ADD
                            WW_CHOrow("OUENKAISU") = Val(WW_CHOrow("OUENKAISU")) + Val(WW_HEADrow("OUENKAISU"))
                            WW_CHOrow("OUENKAISUCHO") = 0
                            WW_CHOrow("HANCHOKAISU") = Val(WW_CHOrow("HANCHOKAISU")) + Val(WW_HEADrow("HANCHOKAISU"))
                            WW_CHOrow("HANCHOKAISUCHO") = 0
                            WW_CHOrow("YOKSAIKENSADAISU") = Val(WW_CHOrow("YOKSAIKENSADAISU")) + Val(WW_HEADrow("YOKSAIKENSADAISU"))
                            WW_CHOrow("YOKSAIKENSADAISUCHO") = 0
                            WW_CHOrow("KIMITUKENSADAISU") = Val(WW_CHOrow("KIMITUKENSADAISU")) + Val(WW_HEADrow("KIMITUKENSADAISU"))
                            WW_CHOrow("KIMITUKENSADAISUCHO") = 0
                    ...
                    Select Case WW_WKDTLrow("OILPAYKBN")
                        Case "01"  '一般
                            If WW_WKDTLrow("SHARYOKBN") = "1" Then
                                WW_WKDTLrow("KAITENCNT") = WW_CHOrow("KAITENCNT1_1")
                        ...
                        Case "02"  '潤滑油
                            If WW_WKDTLrow("SHARYOKBN") = "1" Then
                                WW_WKDTLrow("KAITENCNT") = WW_CHOrow("KAITENCNT1_2")
                        ...
                        Case "03"  'ＬＰ等
                            If WW_WKDTLrow("SHARYOKBN") = "1" Then
                                WW_WKDTLrow("KAITENCNT") = WW_CHOrow("KAITENCNT1_3")
                        ...
                        Case "04"  'ＬＮＧ
                            If WW_WKDTLrow("SHARYOKBN") = "1" Then
                                WW_WKDTLrow("KAITENCNT") = WW_CHOrow("KAITENCNT1_4")
                ...
                For Each WW_DTLrow As DataRow In wT0007tbl.Rows
                    ...
                    If WW_DTLrow("WORKKBN") = "F3" Then
                        ...
                        End If
                        If WW_DTLrow("CAMPCODE") = "03" OrElse WW_DTLrow("CAMPCODE") = "05" Then
                            'KNK、JKTの場合、回送も配送手当に含める
                            For j As Integer = 0 To WW_WKDTLtbl.Rows.Count - 1
                                Dim WW_WKDTLrow As DataRow = WW_WKDTLtbl.Rows(j)
                                If WW_WKDTLrow("STAFFCODE") = WW_DTLrow("STAFFCODE") AndAlso
                ...
                ''JKTで太陽油脂、インフィニアムの場合、積置きもカウントする
                'If WW_CHOrow("CAMPCODE") = "05" Then
                '    Dim WW_B2CNT As Integer = 0
                '    For i As Integer = wT0007tbl.Rows.Count - 1 To 0 Step -1
                ...
                '                Dim WW_WKDTLrow As DataRow = WW_WKDTLtbl.Rows(j)
                '                If WW_WKDTLrow("STAFFCODE") = WW_DTLrow("STAFFCODE") AndAlso
                '                   WW_WKDTLrow("SHARYOKBN") = WW_DTLrow("SHARYOKBN2") AndAlso
                '                   WW_WKDTLrow("OILPAYKBN") = WW_DTLrow("OILPAYKBN2") Then
                '                    WW_WKDTLrow("UNLOADCNT") = Val(WW_WKDTLrow("UNLOADCNT")) + 1
                '                    WW_WKDTLrow("UNLOADCNTTTL") = Val(WW_WKDTLrow("UNLOADCNTTTL")) + 1
                '                End If
                '            Next
                ...
                '2020/04/13 ADD
                WW_CHOrow("ROSAIYUKYNIUSSUTTL") = Val(WW_CHOrow("ROSAIYUKYNIUSSU"))
                WW_CHOrow("TOKUKYUMUKYUNISSUTTL") = Val(WW_CHOrow("TOKUKYUMUKYUNISSU"))
                WW_CHOrow("KOKANGOYUKYUNISSUTTL") = Val(WW_CHOrow("KOKANGOYUKYUNISSU"))
                WW_CHOrow("KOKANGOMUKYUNISSUTTL") = Val(WW_CHOrow("KOKANGOMUKYUNISSU"))
                ...
                '2020/04/13 ADD
                WW_CHOrow("OUENKAISUTTL") = Val(WW_CHOrow("OUENKAISU"))
                WW_CHOrow("HANCHOKAISUTTL") = Val(WW_CHOrow("HANCHOKAISU"))
                WW_CHOrow("YOKSAIKENSADAISUTTL") = Val(WW_CHOrow("YOKSAIKENSADAISU"))
                WW_CHOrow("KIMITUKENSADAISUTTL") = Val(WW_CHOrow("KIMITUKENSADAISU"))
    ...
    Public Sub T0007_TotalRecodeEdit(ByRef ioTbl As DataTable)
        ...
        Try
            ...
            Dim WW_T0007TTLtbl As DataTable = ioTbl.Clone
            Dim WW_T0007ETCtbl As DataTable = ioTbl.Clone
            Dim HEADquery = (From h As DataRow In ioTbl.Rows
                             Where h("SELECT") = "1" AndAlso h("HDKBN") = "H" AndAlso h("RECODEKBN") = "0"
                             Select h
                     )
            Dim TTLquery = (From t As DataRow In ioTbl.Rows
                            Where t("SELECT") = "1" AndAlso t("HDKBN") = "H" AndAlso t("RECODEKBN") = "2"
            ...
            Dim ETCquery = (From e As DataRow In ioTbl.Rows
                            Where Not (e("SELECT") = "1" AndAlso e("HDKBN") = "H" AndAlso e("RECODEKBN") = "0") AndAlso
                                  Not (e("SELECT") = "1" AndAlso e("HDKBN") = "H" AndAlso e("RECODEKBN") = "2") AndAlso
                                  e("RECODEKBN") <> "1"
                            Select e
                     )

            If HEADquery.Any Then
                WW_T0007HEADtbl = HEADquery.CopyToDataTable
            End If
            If TTLquery.Any Then
                WW_T0007TTLtbl = TTLquery.CopyToDataTable
            End If
            If ETCquery.Any Then
                WW_T0007ETCtbl = ETCquery.CopyToDataTable
            End If
            ...
            For Each WW_INrow As DataRow In WW_T0007TTLtbl.Rows
                ...
                If WW_TTLrow("CAMPCODE") = "05" Then
                    jikyusha = getList2(WW_TTLrow("CAMPCODE"), GRT00007WRKINC.CONST_JIKYU, jikyusha)
                    If Not IsNothing(jikyusha.Items.FindByValue(WW_TTLrow("STAFFKBN"))) Then
                        WW_TTLrow("WORKNISSU") = "0"
                    End If
                End If
                ...
                For i As Integer = WW_IDX To WW_T0007HEADtbl.Rows.Count - 1
                    ...
                    If WW_HEADrow("STAFFCODE") = WW_TTLrow("STAFFCODE") Then
                        ...
                        '2020/04/13 ADD
                        WW_TTLrow("ROSAIYUKYNIUSSU") = Val(WW_TTLrow("ROSAIYUKYNIUSSU")) + WW_HEADrow("ROSAIYUKYNIUSSU")
                        WW_TTLrow("TOKUKYUMUKYUNISSU") = Val(WW_TTLrow("TOKUKYUMUKYUNISSU")) + WW_HEADrow("TOKUKYUMUKYUNISSU")
                        WW_TTLrow("KOKANGOYUKYUNISSU") = Val(WW_TTLrow("KOKANGOYUKYUNISSU")) + WW_HEADrow("KOKANGOYUKYUNISSU")
                        WW_TTLrow("KOKANGOMUKYUNISSU") = Val(WW_TTLrow("KOKANGOMUKYUNISSU")) + WW_HEADrow("KOKANGOMUKYUNISSU")
                        ...
                        '2020/04/13 ADD
                        WW_TTLrow("OUENKAISU") = Val(WW_TTLrow("OUENKAISU")) + Val(WW_HEADrow("OUENKAISU"))
                        WW_TTLrow("HANCHOKAISU") = Val(WW_TTLrow("HANCHOKAISU")) + Val(WW_HEADrow("HANCHOKAISU"))
                        WW_TTLrow("YOKSAIKENSADAISU") = Val(WW_TTLrow("YOKSAIKENSADAISU")) + Val(WW_HEADrow("YOKSAIKENSADAISU"))
                        WW_TTLrow("KIMITUKENSADAISU") = Val(WW_TTLrow("KIMITUKENSADAISU")) + Val(WW_HEADrow("KIMITUKENSADAISU"))
                ...
                '2020/04/13 ADD
                WW_TTLrow("ROSAIYUKYNIUSSUTTL") = Val(WW_TTLrow("ROSAIYUKYNIUSSU")) + Val(WW_TTLrow("ROSAIYUKYNIUSSUCHO"))
                WW_TTLrow("TOKUKYUMUKYUNISSUTTL") = Val(WW_TTLrow("TOKUKYUMUKYUNISSU")) + Val(WW_TTLrow("TOKUKYUMUKYUNISSUCHO"))
                WW_TTLrow("KOKANGOYUKYUNISSUTTL") = Val(WW_TTLrow("KOKANGOYUKYUNISSU")) + Val(WW_TTLrow("KOKANGOYUKYUNISSUCHO"))
                WW_TTLrow("KOKANGOMUKYUNISSUTTL") = Val(WW_TTLrow("KOKANGOMUKYUNISSU")) + Val(WW_TTLrow("KOKANGOMUKYUNISSUCHO"))
                ...
                '2020/04/13 ADD
                WW_TTLrow("OUENKAISUTTL") = Val(WW_TTLrow("OUENKAISU")) + Val(WW_TTLrow("OUENKAISUCHO"))
                WW_TTLrow("HANCHOKAISUTTL") = Val(WW_TTLrow("HANCHOKAISU")) + Val(WW_TTLrow("HANCHOKAISUCHO"))
                WW_TTLrow("YOKSAIKENSADAISUTTL") = Val(WW_TTLrow("YOKSAIKENSADAISU")) + Val(WW_TTLrow("YOKSAIKENSADAISUCHO"))
                WW_TTLrow("KIMITUKENSADAISUTTL") = Val(WW_TTLrow("KIMITUKENSADAISU")) + Val(WW_TTLrow("KIMITUKENSADAISUCHO"))
    ...
    Public Sub T0007_KintaiCalc(ByRef ioTbl As DataTable, ByRef iTbl As DataTable, Optional ByVal hydFlg As Boolean = False)
        ...
        Dim WW_CONVERT As String = ""
        Dim WW_RTN As String = ""
        Dim specialOrg As ListBox = New ListBox
        ...
        Try
            ...
            For Each WW_HEADrow As DataRow In WW_T0007HEADtbl.Rows
                ...
                '特殊計算部署取得
                specialOrg = getList2(WW_HEADrow("CAMPCODE"), GRT00007WRKINC.CONST_SPEC, specialOrg)
                ...
                Select Case WW_HEADrow("PAYKBN")
                    ...
                    Case "12"
                        ...
                        WW_HEADrow("NENSHINISSUTTL") = 1         '年始出勤日数
                    Case "18"
                        '○勤怠区分(18:労災) …　出勤扱い(所労=1 )
                        '休日の年休取得は勤怠区分(=0)とする
                        If WW_HEADrow("HOLIDAYKBN") <> "0" Then
                            WW_HEADrow("PAYKBN") = "00"
                            WW_HEADrow("PAYKBNNAMES") = "通常"
                        Else
                            WW_HEADrow("ROSAIYUKYNIUSSU") = 1        '労災日数
                            WW_HEADrow("ROSAIYUKYNIUSSUTTL") = 1     '労災日数
                        End If
                    Case "19"
                        '○勤怠区分(19:特別休暇日数（無給）) …　出勤扱い(所労=0 )
                        '休日の年休取得は勤怠区分(=0)とする
                        If WW_HEADrow("HOLIDAYKBN") <> "0" Then
                            WW_HEADrow("PAYKBN") = "00"
                            WW_HEADrow("PAYKBNNAMES") = "通常"
                        Else
                            WW_HEADrow("TOKUKYUMUKYUNISSU") = 1        '特別休暇日数（無給）日数
                            WW_HEADrow("TOKUKYUMUKYUNISSUTTL") = 1     '特別休暇日数（無給）日数
                        End If
                    Case "20"
                        '○勤怠区分(20:子看護休暇日数（有給）) …　出勤扱い(所労=1 )
                        '休日の年休取得は勤怠区分(=0)とする
                        If WW_HEADrow("HOLIDAYKBN") <> "0" Then
                            WW_HEADrow("PAYKBN") = "00"
                            WW_HEADrow("PAYKBNNAMES") = "通常"
                        Else
                            WW_HEADrow("KOKANGOYUKYUNISSU") = 1        '子看護休暇日数（有給）日数
                            WW_HEADrow("KOKANGOYUKYUNISSUTTL") = 1     '子看護休暇日数（有給）日数
                        End If
                    Case "21"
                        '○勤怠区分(21:子看護休暇日数（無給）) …　出勤扱い(所労=0 )
                        '休日の年休取得は勤怠区分(=0)とする
                        If WW_HEADrow("HOLIDAYKBN") <> "0" Then
                            WW_HEADrow("PAYKBN") = "00"
                            WW_HEADrow("PAYKBNNAMES") = "通常"
                        Else
                            WW_HEADrow("KOKANGOMUKYUNISSU") = 1        '子看護休暇日数（無給）日数
                            WW_HEADrow("KOKANGOMUKYUNISSUTTL") = 1     '子看護休暇日数（無給）日数
                        End If
                End Select
                    ...
                    If IsNothing(specialOrg.Items.FindByValue(WW_HEADrow("HORG"))) Then
                        ...
                        Select Case WW_HEADrow("HOLIDAYKBN")
                            ...
                            Case "0"
                                ...
                                '翌日日曜日の場合
                                If WW_YOKUHOLIDAYKBN = "1" Then
                                    If WW_HEADrow("TAISHOYM") < GRT00007WRKINC.CONST_ZAN202004 Then
                                        '--------------------------------------------------------------------------------------
                                        '～2020/03までは、日跨りで翌日が休みで稼働有り無しにより残業計算結果を切り替えていたが
                                        '--------------------------------------------------------------------------------------
                                        If WW_YOKUACTTIME = "" Then
                                            If WK_OUTNIGHTTIME_SAGYO >= WW_BREAKTIMEZAN Then
                                                WW_WNIGHTTIME = WK_OUTNIGHTTIME_SAGYO - WW_BREAKTIMEZAN    ' 平日深夜時
                        ...
                        '早出補填計算
                        Dim WW_ZANTTL As Integer = 0
                        If WW_HEADrow("BINDSTDATE") = "00:00" Then
                            '60分以上の休憩が引かれているか判定
                            If WW_ORVERTIME = WK_OUTWORKTIME_SAGYO + WK_OUTWORKTIME_SAGYO2 Then
                                '休憩残が引かれていない場合、０時以降の残業から計算
                                WW_ZANTTL = WK_OUTWORKTIME_SAGYO2 + WW_HWORKTIME + WW_HNIGHTTIME + WW_SWORKTIME + WW_SNIGHTTIME
                            Else
                                '０時以降の残業があるか判定
                                If WW_ORVERTIME - WK_OUTWORKTIME_SAGYO > 0 Then
                                    '０時以降の残業から休憩分をマイナスした結果、０時以降の残業が残る場合
                                    Dim WW_minus As Integer = WW_ORVERTIME - (WK_OUTWORKTIME_SAGYO + WK_OUTWORKTIME_SAGYO2)
                                    WW_ZANTTL = (WK_OUTWORKTIME_SAGYO2 + WW_minus) + WW_HWORKTIME + WW_HNIGHTTIME + WW_SWORKTIME + WW_SNIGHTTIME
                                Else
                                    '０時以降の残業から休憩分をマイナスした結果、０時以降の残業が残らない場合
                                    WW_ZANTTL = 0 + WW_HWORKTIME + WW_HNIGHTTIME + WW_SWORKTIME + WW_SNIGHTTIME
                                End If
                            End If
                        Else
                            WW_ZANTTL = WW_ORVERTIME + WW_WNIGHTTIME + WW_HWORKTIME + WW_HNIGHTTIME + WW_SWORKTIME + WW_SNIGHTTIME
                        End If
                        ...
                        If WW_BINDSTTIME >= WW_STDATETIME0000 AndAlso
                           WW_BINDSTTIME <= WW_ENDDATETIME0500 Then
                            If WW_ENDDATETIME < WW_ENDDATETIME0500 Then
                                WW_HAYADETIME = DateDiff("n", WW_BINDSTTIME, WW_ENDDATETIME)
                            Else
            ...
            For Each WW_HEADrow As DataRow In WW_T0007HEADtbl.Rows
                ...
                Select Case WW_HEADrow("PAYKBN")
                    ...
                    Case "13"
                        ...
                        End If
                    Case "18"
                        '○勤怠区分(18:労災欠勤日数（有給）) …　出勤扱い(所労=1 )
                        '休日の年休取得は勤怠区分(=0)とする
                        If WW_HEADrow("HOLIDAYKBN") <> "0" Then
                            WW_HEADrow("PAYKBN") = "00"
                            WW_HEADrow("PAYKBNNAMES") = "通常"
                        Else
                            WW_HEADrow("ROSAIYUKYNIUSSU") = 1        '労災欠勤日数（有給）日数
                            WW_HEADrow("ROSAIYUKYNIUSSUTTL") = 1     '労災欠勤日数（有給）日数
                            WW_HEADrow("WORKNISSU") = 1          '所定労働日数
                            WW_HEADrow("WORKNISSUTTL") = 1       '所定労働日数
                        End If
                    Case "19"
                ...
                Else
                    WW_HEADrow("BINDTIME") = "00:00"
                    WW_HEADrow("WWORKTIME") = "00:00"
                    WW_HEADrow("WWORKTIMETTL") = "00:00"
                End If
                ...
                If iT0007view.Count > 0 Then
                    ...
                    If iT0007view.Item(0).Row("HOLIDAYKBN") = "2" Then
                        WW_YOKUHOLIDAYKBN = "2"
                    End If
                ...
                If DateDiff("d", WW_STDATETIME, WW_ENDDATETIME) <= 1 And WW_STDATETIME < WW_ENDDATETIME Then
                    '残業単価の安いものから休憩をマイナスする
                    Select Case WW_HEADrow("HOLIDAYKBN")
                        '○平日
                        Case "0"
                            '平日残業
                            If WK_OUTWORKTIME_SAGYO >= WW_BREAKTIMEZAN Then
                                WW_ORVERTIME = WK_OUTWORKTIME_SAGYO - WW_BREAKTIMEZAN      ' 平日残業時
                                WW_BREAKTIMEZAN = 0
                            Else
                                WW_ORVERTIME = 0                                           ' 平日残業時
                                WW_BREAKTIMEZAN = WW_BREAKTIMEZAN - WK_OUTWORKTIME_SAGYO   ' 休憩残算出
                            ...
                            If WW_YOKUHOLIDAYKBN = "0" Then
                                '平日残業
                                If WK_OUTWORKTIME_SAGYO2 >= WW_BREAKTIMEZAN Then
                                    WW_ORVERTIME = WW_ORVERTIME + WK_OUTWORKTIME_SAGYO2 - WW_BREAKTIMEZAN      ' 平日残業時
                                    WW_BREAKTIMEZAN = 0
                                Else
                                    WW_ORVERTIME = WW_ORVERTIME + 0                            ' 平日出勤時
                                    WW_BREAKTIMEZAN = WW_BREAKTIMEZAN - WK_OUTWORKTIME_SAGYO2  ' 休憩残算出
                                End If
                                '深夜時間(0:00～5:00、22:00～24:00、24:00～翌5:00、翌22:00～翌24:00)
                                If WK_OUTNIGHTTIME_SAGYO + WK_YOKU0to5NIGHT_SAGYO2 >= WW_BREAKTIMEZAN Then
                        ...
                        Case "2"
                            ...
                            Select Case WW_HEADrow("PAYKBN")
                                ...
                                Case Else
                                    ...
                                    '翌日平日の場合
                                    If WW_YOKUHOLIDAYKBN = "0" Then
                                        '平日深夜(0:00～5:00、22:00～24:00、24:00～翌5:00、翌22:00～翌24:00)
                                        ' 平日出勤時
                                        If WK_OUTWORKTIME_SAGYO2 >= WW_BREAKTIMEZAN Then
                                            WW_ORVERTIME = WK_OUTWORKTIME_SAGYO2 - WW_BREAKTIMEZAN           ' 平日出勤時
                                            WW_BREAKTIMEZAN = 0
                                        Else
                                            WW_ORVERTIME = 0                                                 ' 平日出勤時
                                            WW_BREAKTIMEZAN = WW_BREAKTIMEZAN - WK_OUTWORKTIME_SAGYO2        ' 休憩残算出
                                        End If
            ...
            For Each WW_HEADrow As DataRow In WW_T0007HEADtbl.Rows
                ...
                If DateDiff("d", WW_STDATETIME, WW_ENDDATETIME) <= 1 And WW_STDATETIME < WW_ENDDATETIME Then
                    ...
                    Select Case WW_HEADrow("HOLIDAYKBN")
                        ...
                        Case "0"
                            '平日残業
                            WW_ORVERTIME = WK_OUTWORKTIME_SAGYO - WK_OUTWORKTIME_KYUKEI                                                              ' 平日残業時
                            ...
                            If WW_YOKUHOLIDAYKBN = "0" Then
                                ...
                                '平日残業（翌5:00～22:00）
                                WW_ORVERTIME = WW_ORVERTIME + WK_OUTWORKTIME_SAGYO2 - WK_OUTWORKTIME_KYUKEI2                                         ' 平日残業時（翌）
                            End If

                            '翌日日曜日の場合
                            If WW_YOKUHOLIDAYKBN = "1" Then
                                '深夜時間(0:00～5:00、22:00～24:00)
                                WW_WNIGHTTIME = WK_OUTNIGHTTIME_SAGYO - WK_OUTNIGHTTIME_KYUKEI       ' 平日深夜時
                                '日曜深夜(翌0:00～翌5:00、翌22:00～翌24:00)
                            ...
                            If WW_YOKUHOLIDAYKBN = "2" Then
                                '深夜時間(0:00～5:00、22:00～24:00)
                                WW_WNIGHTTIME = WK_OUTNIGHTTIME_SAGYO - WK_OUTNIGHTTIME_KYUKEI       ' 平日深夜時
                                '休日深夜(24:00～翌5:00、翌22:00～翌24:00)
                        ...
                        Case "1"
                            ...
                            '翌日平日の場合
                            If WW_YOKUHOLIDAYKBN = "0" Then
                                '平日深夜(翌0:00～翌5:00、翌22:00～翌24:00)
                        ...
                        Case "2"
                            ...
                            If WW_YOKUHOLIDAYKBN = "0" Then
                                '休日深夜(0:00～5:00、22:00～24:00、24:00～翌5:00、翌22:00～翌24:00)
                                '平日深夜時
                                WW_WNIGHTTIME = WK_YOKU0to5NIGHT_SAGYO2 - WK_YOKU0to5NIGHT_KYUKEI2                                      ' 休日深夜時
                                '平日残業
                                WW_ORVERTIME = WK_OUTWORKTIME_SAGYO2 - WK_OUTWORKTIME_KYUKEI2                                           ' 平日残業
                            End If
        ...
        Try
            ...
            For Each WW_HEADrow As DataRow In WW_T0007HEADtbl.Rows
                ...
                Select Case WW_HEADrow("PAYKBN")
                    Case "00"
                        ...
                        If IsDate(WW_HEADrow("STDATE")) Then
                            ...
                            End If
                        End If
                        If Not IsNothing(jikyusha.Items.FindByValue(WW_HEADrow("STAFFKBN"))) Then
                            If WW_HEADrow("STTIME") = "00:00" And WW_HEADrow("ENDTIME") = "00:00" Then
                            Else
                                WW_HEADrow("WORKNISSU") = 1    '労働日数
                                WW_HEADrow("WORKNISSUTTL") = 1 '労働日数
                            End If
                        End If
                    Case "01"
                        '○勤怠区分(01:年休) …　出勤扱い(所労=1 )
                ...
                If DateDiff("d", WW_STDATETIME, WW_ENDDATETIME) <= 1 And WW_STDATETIME < WW_ENDDATETIME And Not WW_HEADrow("STAFFKBN") Like "03*" Then
                    ...
                    '2018/02/06 追加
                    '入力値（休憩）で計算する
                    If WW_HEADrow("BINDTIME") <> "00:00" Then
                        WW_BINDENDTIME = WW_BINDENDTIME.AddMinutes(HHMMtoMinutes(WW_HEADrow("BREAKTIME")))
                    Else
                        WW_BREAKTIMEZAN = HHMMtoMinutes(WW_HEADrow("BREAKTIME"))
                    End If
                    '2018/02/06 追加
                End If
                ...
                If Not IsNothing(jikyusha.Items.FindByValue(WW_HEADrow("STAFFKBN"))) Then
                    ...
                    '時給者所定時間=稼動時間-休憩
                    WW_JIKYUSHATIME = DateDiff("n", WW_STDATETIME, WW_ENDDATETIME) - WK_WORKTIME_KYUKEI
                    ...
                    Else
                        ...
                        Else
                            ...
                            Then
                                ...
                                Call WorkTimeMinuteGet(WW_NIGHT_YOK05, iENDDATETIME, iBINDSTTIME, iBINDENDTIME, WW_WORKTIME, WW_OVERTIME)
                                ioWORKTIME = ioWORKTIME + WW_WORKTIME
                                '2019/10/18 ioOUTWORKTIME → ioOUTWORKTIME2
                                ioOUTWORKTIME2 = ioOUTWORKTIME2 + WW_OVERTIME
                            Else
                                '○終了(翌22時過～翌24時)
    ...
    Public Sub INProw_Init(ByVal iCamp As String, ByRef ioRow As DataRow)
        ...
        '2020/04/13 ADD
        ioRow("ROSAIYUKYNIUSSU") = "0"
        ioRow("ROSAIYUKYNIUSSUCHO") = "0"
        ioRow("ROSAIYUKYNIUSSUTTL") = "0"
        ioRow("TOKUKYUMUKYUNISSU") = "0"
        ioRow("TOKUKYUMUKYUNISSUCHO") = "0"
        ioRow("TOKUKYUMUKYUNISSUTTL") = "0"
        ioRow("KOKANGOYUKYUNISSU") = "0"
        ioRow("KOKANGOYUKYUNISSUCHO") = "0"
        ioRow("KOKANGOYUKYUNISSUTTL") = "0"
        ioRow("KOKANGOMUKYUNISSU") = "0"
        ioRow("KOKANGOMUKYUNISSUCHO") = "0"
        ioRow("KOKANGOMUKYUNISSUTTL") = "0"
        ...
        '2020/04/13 ADD
        ioRow("OUENKAISU") = "0"
        ioRow("OUENKAISUCHO") = "0"
        ioRow("OUENKAISUTTL") = "0"
        ioRow("HANCHOKAISU") = "0"
        ioRow("HANCHOKAISUCHO") = "0"
        ioRow("HANCHOKAISUTTL") = "0"
        ioRow("YOKSAIKENSADAISU") = "0"
        ioRow("YOKSAIKENSADAISUCHO") = "0"
        ioRow("YOKSAIKENSADAISUTTL") = "0"
        ioRow("KIMITUKENSADAISU") = "0"
        ioRow("KIMITUKENSADAISUCHO") = "0"
        ioRow("KIMITUKENSADAISUTTL") = "0"
    ...
    ' ***  出社時間切り下げ（5分単位）
    Function Minute5EditDown(ByVal iParm As String) As String
        Dim WW_TIME As String() = iParm.Split(":")

        If Val(WW_TIME(1)) >= 55 And Val(WW_TIME(1)) <= 59 Then
            WW_TIME(1) = "55"
        End If
        If Val(WW_TIME(1)) >= 50 And Val(WW_TIME(1)) <= 54 Then
            WW_TIME(1) = "50"
        End If
        If Val(WW_TIME(1)) >= 45 And Val(WW_TIME(1)) <= 49 Then
            WW_TIME(1) = "45"
        End If
        If Val(WW_TIME(1)) >= 40 And Val(WW_TIME(1)) <= 44 Then
            WW_TIME(1) = "40"
        End If
        If Val(WW_TIME(1)) >= 35 And Val(WW_TIME(1)) <= 39 Then
            WW_TIME(1) = "35"
        End If
        If Val(WW_TIME(1)) >= 30 And Val(WW_TIME(1)) <= 34 Then
            WW_TIME(1) = "30"
        End If
        If Val(WW_TIME(1)) >= 25 And Val(WW_TIME(1)) <= 29 Then
            WW_TIME(1) = "25"
        End If
        If Val(WW_TIME(1)) >= 20 And Val(WW_TIME(1)) <= 24 Then
            WW_TIME(1) = "20"
        End If
        If Val(WW_TIME(1)) >= 15 And Val(WW_TIME(1)) <= 19 Then
            WW_TIME(1) = "15"
        End If
        If Val(WW_TIME(1)) >= 10 And Val(WW_TIME(1)) <= 14 Then
            WW_TIME(1) = "10"
        End If
        If Val(WW_TIME(1)) >= 5 And Val(WW_TIME(1)) <= 9 Then
            WW_TIME(1) = "05"
        End If
        If Val(WW_TIME(1)) >= 0 And Val(WW_TIME(1)) <= 4 Then
            WW_TIME(1) = "00"
        End If

        Minute5EditDown = Val(WW_TIME(0)).ToString("00") & ":" & Val(WW_TIME(1)).ToString("00")
    ...
    ' ***  権限チェック取得
    Public Sub OrgCheck(ByRef iCamp As String,
                        ByRef iOrg As String,
                        ByRef iRole As String,
        ...
        Try
            ...
            '検索SQL文
            If String.IsNullOrEmpty(iOrg) Then
                SQLStr =
                 " select min(isnull(B.PERMITCODE,0)) as PERMITCODE                     " _
               & " FROM   S0006_ROLE      as B                                          " _
               & "      WHERE  B.CAMPCODE  = @CAMP                                      " _
               & "        and  B.OBJECT    = 'ORG'                                      " _
               & "        and  B.ROLE      = @ROLE                                      " _
               & "        and  B.STYMD    <= @YMD                                       " _
               & "        and  B.ENDYMD   >= @YMD                                       " _
            ...
            Dim PARA01 As SqlParameter = SQLcmd.Parameters.Add("@CAMP", System.Data.SqlDbType.NVarChar)
            ...
            Dim PARA04 As SqlParameter = SQLcmd.Parameters.Add("@ROLE", System.Data.SqlDbType.NVarChar)
            '○関連受注指定
            PARA01.Value = iCamp
            PARA02.Value = iOrg
    ...
    Public Sub L1Insert(ByVal iRow As DataRow, ByRef I_SQLcon As SqlConnection)
        ...
        Dim SQLStr As String =
                ...
                & "        PAYWEEKNISSU, " _
                & "        PAYDAIKYUNISSU, " _
                & "        PAYROSAIYUKYNIUSSU, " _
                & "        PAYTOKUKYUMUKYUNISSU, " _
                & "        PAYKOKANGOYUKYUNISSU, " _
                & "        PAYKOKANGOMUKYUNISSU, " _
                & "        PAYWORKTIME, " _
                & "        PAYWWORKTIME, " _
                & "        PAYNIGHTTIME, " _
                & "        PAYORVERTIME, " _
                ...
                & "        PAYOUENKAISU, " _
                & "        PAYHANCHOKAISU, " _
                & "        PAYYOKSAIKENSADAISU, " _
                & "        PAYKIMITUKENSADAISU, " _
                & "        APPKIJUN, " _
                & "        APPKEY, " _
                & "        WORKKBN, " _
                & "        KEYSTAFFCODE, " _
        ...
        '2020/04/13 ADD
        Dim P_PAYROSAIYUKYNIUSSU As SqlParameter = SQLcmd.Parameters.Add("@PAYROSAIYUKYNIUSSU", System.Data.SqlDbType.Decimal)
        Dim P_PAYTOKUKYUMUKYUNISSU As SqlParameter = SQLcmd.Parameters.Add("@PAYTOKUKYUMUKYUNISSU", System.Data.SqlDbType.Decimal)
        Dim P_PAYKOKANGOYUKYUNISSU As SqlParameter = SQLcmd.Parameters.Add("@PAYKOKANGOYUKYUNISSU", System.Data.SqlDbType.Decimal)
        Dim P_PAYKOKANGOMUKYUNISSU As SqlParameter = SQLcmd.Parameters.Add("@PAYKOKANGOMUKYUNISSU", System.Data.SqlDbType.Decimal)
        ...
        '2020/04/13 ADD
        Dim P_PAYOUENKAISU As SqlParameter = SQLcmd.Parameters.Add("@PAYOUENKAISU", System.Data.SqlDbType.Decimal)
        Dim P_PAYHANCHOKAISU As SqlParameter = SQLcmd.Parameters.Add("@PAYHANCHOKAISU", System.Data.SqlDbType.Decimal)
        Dim P_PAYYOKSAIKENSADAISU As SqlParameter = SQLcmd.Parameters.Add("@PAYYOKSAIKENSADAISU", System.Data.SqlDbType.Decimal)
        Dim P_PAYKIMITUKENSADAISU As SqlParameter = SQLcmd.Parameters.Add("@PAYKIMITUKENSADAISU", System.Data.SqlDbType.Decimal)
        ...
        '2020/04/13 ADD
        P_PAYROSAIYUKYNIUSSU.Value = iRow("PAYROSAIYUKYNIUSSU")
        P_PAYTOKUKYUMUKYUNISSU.Value = iRow("PAYTOKUKYUMUKYUNISSU")
        P_PAYKOKANGOYUKYUNISSU.Value = iRow("PAYKOKANGOYUKYUNISSU")
        P_PAYKOKANGOMUKYUNISSU.Value = iRow("PAYKOKANGOMUKYUNISSU")
        ...
        '2020/04/13 ADD
        P_PAYOUENKAISU.Value = iRow("PAYOUENKAISU")
        P_PAYHANCHOKAISU.Value = iRow("PAYHANCHOKAISU")
        P_PAYYOKSAIKENSADAISU.Value = iRow("PAYYOKSAIKENSADAISU")
        P_PAYKIMITUKENSADAISU.Value = iRow("PAYKIMITUKENSADAISU")
    ...
    Public Sub ModelDistanceTbl(ByRef iTBL As DataTable, ByVal iCAMP As String, ByVal iTAISHOYM As String,
        ...
        Dim WW_ListBoxREPEATMODEL2 As ListBox = New ListBox
        Dim WW_ListBoxREPEATMODEL3 As ListBox = New ListBox
        Dim WW_ListBoxREPEATMODEL4 As ListBox = New ListBox
        Dim WW_ListBoxREPEATMODEL5 As ListBox = New ListBox

        '固定値マスタ取得（繰り返しモデル距離）
        GS0007FIXVALUElst.CAMPCODE = iCAMP
        GS0007FIXVALUElst.CLAS = "REPEATMODEL"
        GS0007FIXVALUElst.LISTBOX1 = WW_ListBoxREPEATMODEL1
        GS0007FIXVALUElst.LISTBOX2 = WW_ListBoxREPEATMODEL2
        GS0007FIXVALUElst.LISTBOX3 = WW_ListBoxREPEATMODEL3
        GS0007FIXVALUElst.LISTBOX4 = WW_ListBoxREPEATMODEL4
        GS0007FIXVALUElst.LISTBOX5 = WW_ListBoxREPEATMODEL5
        GS0007FIXVALUElst.GS0007FIXVALUElst()
        WW_ListBoxREPEATMODEL1 = GS0007FIXVALUElst.LISTBOX1
        WW_ListBoxREPEATMODEL2 = GS0007FIXVALUElst.LISTBOX2
        WW_ListBoxREPEATMODEL3 = GS0007FIXVALUElst.LISTBOX3
        ...
        If WW_iTBL.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To oTBL.Rows.Count - 1
                ...
                If WW_oTBLrow("SAVECNT") >= 1 Then
                    ...
                    Else
                        For j As Integer = 0 To WW_ListBoxREPEATMODEL1.Items.Count - 1
                            If WW_oTBLrow("SHUKABASHO_W1") & "-" & WW_oTBLrow("TODOKECODE1") = WW_ListBoxREPEATMODEL1.Items(j).Value Then
                                WW_oTBLrow("MODELDISTANCE1") = WW_ListBoxREPEATMODEL1.Items(j).Text
                                WW_oTBLrow("SHUKABASHO1") = WW_oTBLrow("SHUKABASHO_W1")
                                WW_oTBLrow("MODIFYKBN1") = "0"
                            End If
    ...
    Public Sub T0007tbl_ColumnsAdd(ByRef iTbl As DataTable)
        ...
        '2020/04/13 ADD
        iTbl.Columns.Add("ROSAIYUKYNIUSSU", GetType(String))
        iTbl.Columns.Add("ROSAIYUKYNIUSSUCHO", GetType(String))
        iTbl.Columns.Add("ROSAIYUKYNIUSSUTTL", GetType(String))
        iTbl.Columns.Add("TOKUKYUMUKYUNISSU", GetType(String))
        iTbl.Columns.Add("TOKUKYUMUKYUNISSUCHO", GetType(String))
        iTbl.Columns.Add("TOKUKYUMUKYUNISSUTTL", GetType(String))
        iTbl.Columns.Add("KOKANGOYUKYUNISSU", GetType(String))
        iTbl.Columns.Add("KOKANGOYUKYUNISSUCHO", GetType(String))
        iTbl.Columns.Add("KOKANGOYUKYUNISSUTTL", GetType(String))
        iTbl.Columns.Add("KOKANGOMUKYUNISSU", GetType(String))
        iTbl.Columns.Add("KOKANGOMUKYUNISSUCHO", GetType(String))
        iTbl.Columns.Add("KOKANGOMUKYUNISSUTTL", GetType(String))
        ...
        '2020/04/13 ADD
        iTbl.Columns.Add("OUENKAISU", GetType(String))
        iTbl.Columns.Add("OUENKAISUCHO", GetType(String))
        iTbl.Columns.Add("OUENKAISUTTL", GetType(String))
        iTbl.Columns.Add("HANCHOKAISU", GetType(String))
        iTbl.Columns.Add("HANCHOKAISUCHO", GetType(String))
        iTbl.Columns.Add("HANCHOKAISUTTL", GetType(String))
        iTbl.Columns.Add("YOKSAIKENSADAISU", GetType(String))
        iTbl.Columns.Add("YOKSAIKENSADAISUCHO", GetType(String))
        iTbl.Columns.Add("YOKSAIKENSADAISUTTL", GetType(String))
        iTbl.Columns.Add("KIMITUKENSADAISU", GetType(String))
    ...
    Public Sub L0001tblEtcEdit(ByVal I_USERID As String, ByRef I_T7tbl As DataTable, ByRef IO_L1tbl As DataTable, ByRef O_RTN As String)
        ...
        For i As Integer = 0 To WW_T0007tbl.Rows.Count - 1
            Try
                ...
                '2020/04/13 ADD
                L0001row("PAYROSAIYUKYNIUSSU") = 0                                         '労災欠勤日数（有給）
                L0001row("PAYTOKUKYUMUKYUNISSU") = 0                                       '特別休暇日数（無給）
                L0001row("PAYKOKANGOYUKYUNISSU") = 0                                       '子看護休暇日数（有給）
                L0001row("PAYKOKANGOMUKYUNISSU") = 0                                       '子看護休暇日数（無給）
                ...
                '2020/04/13 ADD
                L0001row("PAYOUENKAISU") = 0                                               '応援手当回数
                L0001row("PAYHANCHOKAISU") = 0                                             '班長会議手当回数
                L0001row("PAYYOKSAIKENSADAISU") = 0                                        '容器再検査台数
                L0001row("PAYKIMITUKENSADAISU") = 0                                        '気密検査台数
    ...
    Public Sub L0001tblDailyTtlEdit(ByVal I_USERID As String, ByRef I_T7tbl As DataTable, ByRef IO_L1tbl As DataTable, ByRef O_RTN As String)
        ...
        For i As Integer = 0 To WW_T0007tbl.Rows.Count - 1
            Try
                ...
                '2020/04/13 ADD
                L0001row("PAYROSAIYUKYNIUSSU") = T0007HEADrow("ROSAIYUKYNIUSSUTTL")        '労災欠勤日数（有給）
                L0001row("PAYTOKUKYUMUKYUNISSU") = T0007HEADrow("TOKUKYUMUKYUNISSUTTL")    '特別休暇日数（無給）
                L0001row("PAYKOKANGOYUKYUNISSU") = T0007HEADrow("KOKANGOYUKYUNISSUTTL")    '子看護休暇日数（有給）
                L0001row("PAYKOKANGOMUKYUNISSU") = T0007HEADrow("KOKANGOMUKYUNISSUTTL")    '子看護休暇日数（無給）
                ...
                '2020/04/13 ADD
                L0001row("PAYOUENKAISU") = Val(T0007HEADrow("OUENKAISUTTL"))               '応援手当回数
                L0001row("PAYHANCHOKAISU") = Val(T0007HEADrow("HANCHOKAISUTTL"))           '班長会議手当回数
                L0001row("PAYYOKSAIKENSADAISU") = Val(T0007HEADrow("YOKSAIKENSADAISUTTL")) '容器再検査台数
                L0001row("PAYKIMITUKENSADAISU") = Val(T0007HEADrow("KIMITUKENSADAISUTTL")) '気密検査台数
        ...
        For i As Integer = 0 To WW_T0007tbl.Rows.Count - 1
            Try
                ...
                If T0007DTLrow("SHARYOKBN") = "1" And T0007DTLrow("OILPAYKBN") = "01" Then
                    ...
                    '2020/04/13 ADD
                    L0001row("PAYROSAIYUKYNIUSSU") = T0007HEADrow("ROSAIYUKYNIUSSUCHO")        '労災欠勤日数（有給）
                    L0001row("PAYTOKUKYUMUKYUNISSU") = T0007HEADrow("TOKUKYUMUKYUNISSUCHO")    '特別休暇日数（無給）
                    L0001row("PAYKOKANGOYUKYUNISSU") = T0007HEADrow("KOKANGOYUKYUNISSUCHO")    '子看護休暇日数（有給）
                    L0001row("PAYKOKANGOMUKYUNISSU") = T0007HEADrow("KOKANGOMUKYUNISSUCHO")    '子看護休暇日数（無給）
    ...
    Public Sub ConvORGCODE(ByVal I_COMPCODE As String, ByVal I_ORGCODE As String, ByRef O_ORGCODE As String, ByRef O_RTN As String)
        ...
        Catch ex As Exception
            CS0011LOGWRITE.INFSUBCLASS = "GRT0007COM_V2"                   'SUBクラス名
    ...
    ''' 固定値リスト取得
    ''' </summary>
    Public Function getList2(ByVal cmp As String, ByVal cls As String, ByVal ilistbox As ListBox) As ListBox
