...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007KINTAI_JKT_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC_V2.MAPIDJKT
        ...
        '○ 右ボックスへの値設定
        rightview.MAPID = GRT00007WRKINC_V2.MAPIDJKT
    ...
    Protected Sub WF_FIELD_Change()
        ...
        Select Case WF_FIELD.Value
            ...
            Case "WF_UNLOADADDCNT3"
                WF_UNLOADADDCNT4.Focus()
            Case "WF_UNLOADADDCNT4"
    ...
    Protected Sub ItemChangeCheck(ByRef oRtn As String)
        ...
        For Each T0007INProw As DataRow In T0007INPtbl.Rows
            ...
            If T0007INProw("HDKBN") = "H" And T0007INProw("RECODEKBN") = "0" Then
                ...
                T0007INProw("UNLOADCNT") = WF_UNLOADCNT.Text
                T0007INProw("UNLOADCNTTTL") = WF_UNLOADCNT.Text
                ...
                T0007INProw("UNLOADADDCNT4") = WF_UNLOADADDCNT4.Text
                T0007INProw("UNLOADADDCNT4TTL") = WF_UNLOADADDCNT4.Text
                T0007INProw("LOADINGCNT1") = 0
                T0007INProw("LOADINGCNT1TTL") = 0
        ...
        For Each T0007INProw As DataRow In T0007INPtbl.Rows
            ...
            If T0007INProw("HDKBN") = "H" And T0007INProw("RECODEKBN") = "2" Then
                ...
                T0007INProw("UNLOADADDCNT4CHO") = Val(WF_UNLOADADDCNT4TTL.Text) - Val(T0007INProw("UNLOADADDCNT4"))
                T0007INProw("UNLOADADDCNT4TTL") = Val(T0007INProw("UNLOADADDCNT4")) + Val(T0007INProw("UNLOADADDCNT4CHO"))
                T0007INProw("LOADINGCNT1CHO") = 0 - Val(T0007INProw("LOADINGCNT1"))
    ...
    Protected Sub InpCHARstr()
        ...
        WF_UNLOADADDCNT4.Text = charStr(WF_UNLOADADDCNT4.Text)
        ...
        WF_UNLOADADDCNT4TTL.Text = charStr(WF_UNLOADADDCNT4TTL.Text)
    ...
    Public Sub T00005ALLget(ByVal iKBN As String,
        ...
        Try
            ...
            Dim SQLStr As String =
               ...
               & "       CASE WHEN isnull(rtrim(F10.VALUE1),'') <> '' THEN F10.VALUE1 ELSE (CASE WHEN isnull(rtrim(F11.VALUE1),'') <> '' THEN F11.VALUE1 ELSE isnull(rtrim(MA6.OILKBN),'') END) END as OILPAYKBN ," _
            ...
            Dim SQLStr3 As String =
               ...
               & "   and   F11.CLASS        = 'SPECIALSHUKABASHO' " _
               & "   and   F11.KEYCODE      = A.L1SHUKABASHO " _
               & "   and   F11.STYMD       <= @P5 " _
               & "   and   F11.ENDYMD      >= @P5 " _
               & "   and   F11.DELFLG      <> '1' " _
               ...
               & "   and   F5.KEYCODE     = (CASE WHEN isnull(F10.VALUE1,'') <> '' THEN F10.VALUE1 ELSE (CASE WHEN isnull(F11.VALUE1,'') <> '' THEN F11.VALUE1 ELSE MA6.OILKBN END) END)" _
               & "   and   F5.STYMD      <= @P5 " _
               & "   and   F5.ENDYMD     >= @P5 " _
               & "   and   F5.DELFLG     <> '1' " _
        ...
        For Each T0007INProw As DataRow In iTbl.Rows
            ...
            If T0007INProw("RECODEKBN") = "0" Then
                If T0007INProw("HDKBN") = "H" Then
                    ...
                    WF_UNLOADADDCNT4.Text = T0007INProw("UNLOADADDCNT4TTL")
                    'WF_LOADINGCNT.Text = T0007INProw("LOADINGCNT1TTL")
            ...
            If T0007INProw("RECODEKBN") = "2" Then
                If T0007INProw("HDKBN") = "H" Then
                    ...
                    WF_UNLOADADDCNT4TTL.Text = T0007INProw("UNLOADADDCNT4TTL") '危険品荷卸回数３
                    'WF_LOADINGCNT1TTL.Text = T0007INProw("LOADINGCNT1TTL") '危険品積込回数１
                    WF_SHORTDISTANCE1TTL.Text = T0007INProw("SHORTDISTANCE1TTL") '短距離手当回数１
                    WF_SHORTDISTANCE2TTL.Text = T0007INProw("SHORTDISTANCE2TTL") '短距離手当回数２

                    WF_UNLOADCNTTTL.Text = Val(T0007INProw("UNLOADCNTTTL")) '荷卸回数
                ...
                If T0007INProw("HDKBN") = "D" Then
                    Select Case T0007INProw("OILPAYKBN")
                        ...
                        Case "02"  '太陽油脂
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_TAIYO1.Text = Val(T0007INProw("UNLOADCNTTTL"))
                                WF_HAIDISTANCE_TAIYO1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_TAIYO2.Text = Val(T0007INProw("UNLOADCNTTTL"))
                                WF_HAIDISTANCE_TAIYO2.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                        Case "03"  'インファニアム
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_INF1.Text = Val(T0007INProw("UNLOADCNTTTL"))
                                WF_HAIDISTANCE_INF1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_INF2.Text = Val(T0007INProw("UNLOADCNTTTL"))
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC_V2.MAPIDJKT
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "0" Then
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(危険品荷卸回数100エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(危険品荷卸回数200エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(危険品荷卸回数800エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(危険品荷卸回数1000エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(短距離1000エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(短距離2000エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
        End If
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "2" Then
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(短距離手当1000エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
            ...
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(短距離手当2000エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, "10023")
            End If
    ...
    Private Sub NIPPO_Screen()
        ...
        If T0005tbl.Rows.Count > 0 Then
            ...
            '呼出元MAPID　
            work.WF_T5_FROMMAPID.Text = GRT00007WRKINC_V2.MAPIDJKT
            '画面一覧保存パス
            ...
            '呼出元VARIANT
            work.WF_T5_FROMMAPVARIANT.Text = Master.MAPvariant & GRT00007WRKINC_V2.MAPVRJKT
    ...
    Protected Sub MAPrefelence(ByRef O_MSG As String, ByRef O_RTN As String)
        ...
        '■■■ 選択画面の入力初期値設定 ■■■
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007IJKT_V2 Then       '条件画面からの画面遷移
        ...
        work.WF_T5I_XMLsaveF.Text = CS0050SESSION.UPLOAD_PATH & "\XML_TMP\" & Date.Now.ToString("yyyyMMdd") & "-" &
            CS0050SESSION.USERID & "-T00007JKT_V2-T5-" & Master.MAPvariant & "-" & Date.Now.ToString("HHmmss") & ".txt"
        work.WF_T5I_XMLsaveF9.Text = CS0050SESSION.UPLOAD_PATH & "\XML_TMP\" & Date.Now.ToString("yyyyMMdd") & "-" &
            CS0050SESSION.USERID & "-T00007JKT_V2-T59-" & Master.MAPvariant & "-" & Date.Now.ToString("HHmmss") & ".txt"
    End Sub
