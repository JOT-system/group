...
Public Class GRTA0006JIMKINTAILIST_V2
    Inherits Page
    ...
    Protected Sub Initialize()
        '○初期値設定
        Master.MAPID = GRTA0006WRKINC_V2.MAPID
        Master.VERSION = "V2"
        ...
        Using TBLview As DataView = New DataView(TA0006VIEWtbl)
            ...
            CS0013ProfView.MAPID = GRTA0006WRKINC_V2.MAPID
    ...
    Protected Sub WF_ButtonPDF_Click()
        ...
        For i As Integer = 0 To WF_SELECTOR.Items.Count - 1
            ...
            CS0030REPORT.MAPID = GRTA0006WRKINC_V2.MAPID               '画面ID
            ...
            If isNormal(CS0030REPORT.ERR) Then
                ...
                If Trim(work.WF_SEL_HORG.Text) = "" Then
                    System.IO.File.Copy(CS0030REPORT.FILEpath, WW_Dir & "\" & TA0006VIEWtbl.Rows(0)("HORG") & "_" & CType(WF_SELECTOR.Items(i).FindControl("WF_SELECTOR_VALUE"), Label).Text & ".xlsx", True)
                Else
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050Session.getConnection
                ...
                Dim SQLStr As String =
                   ...
                   & "       isnull(A.ORVERTIME,0) as ORVERTIME_V2 , " _
                   & "       isnull(A.ORVERTIMECHO,0) as ORVERTIMECHO_V2 , " _
                   & "       isnull(A.ORVERTIME,0) + isnull(A.ORVERTIMECHO,0) as ORVERTIMETTL_V2 , " _
                   & "       isnull(A.SWORKTIME,0) as SWORKTIME_V2 , " _
                   & "       isnull(A.SWORKTIMECHO,0) as SWORKTIMECHO_V2 , " _
                   & "       isnull(A.SWORKTIME,0) + isnull(A.SWORKTIMECHO,0) as SWORKTIMETTL_V2 , " _
                   & "       isnull(A.HWORKTIME,0) as HWORKTIME_V2 , " _
                   & "       isnull(A.HWORKTIMECHO,0) as HWORKTIMECHO_V2 , " _
                   & "       isnull(A.HWORKTIME,0) + isnull(A.HWORKTIMECHO,0) as HWORKTIMETTL_V2 , " _
                   & "       isnull(A.WNIGHTTIME,0) as WNIGHTTIME_V2 , " _
                   & "       isnull(A.WNIGHTTIMECHO,0) as WNIGHTTIMECHO_V2 , " _
                   & "       isnull(A.WNIGHTTIME,0) + isnull(A.WNIGHTTIMECHO,0) as WNIGHTTIMETTL_V2 , " _
                   ...
                   & "       isnull(A.HDAIWORKTIME,0) as HDAIWORKTIME_V2 , " _
                   & "       isnull(A.HDAIWORKTIMECHO,0) as HDAIWORKTIMECHO_V2 , " _
                   & "       isnull(A.HDAIWORKTIME,0) + isnull(A.HDAIWORKTIMECHO,0) as HDAIWORKTIMETTL_V2 , " _
                   & "       isnull(A.SDAIWORKTIME,0) as SDAIWORKTIME_V2 , " _
                   & "       isnull(A.SDAIWORKTIMECHO,0) as SDAIWORKTIMECHO_V2 , " _
                   & "       isnull(A.SDAIWORKTIME,0) + isnull(A.SDAIWORKTIMECHO,0) as SDAIWORKTIMETTL_V2  " _
                   & " FROM #MBtemp MB " _
                ...
                For Each TA0006ALLrow As DataRow In TA0006ALL.Rows
                    ...
                    If IsDate(TA0006ALLrow("STTIME")) Then
                        TA0006ALLrow("STTIME") = CDate(TA0006ALLrow("STTIME")).ToString("HH:mm")
                    Else
                        TA0006ALLrow("STTIME") = ""
                    End If
                    ...
                    If IsDate(TA0006ALLrow("ENDTIME")) Then
                        TA0006ALLrow("ENDTIME") = CDate(TA0006ALLrow("ENDTIME")).ToString("HH:mm")
                    Else
                        TA0006ALLrow("ENDTIME") = ""
                    End If
                    If IsDate(TA0006ALLrow("YENDTIME")) Then
                        TA0006ALLrow("YENDTIME") = CDate(TA0006ALLrow("YENDTIME")).ToString("HH:mm")
                    Else
                        TA0006ALLrow("YENDTIME") = ""
                    End If
                    If IsDate(TA0006ALLrow("BINDSTDATE")) Then
                        TA0006ALLrow("BINDSTDATE") = CDate(TA0006ALLrow("BINDSTDATE")).ToString("HH:mm")
                    Else
                    ...
                    Dim stDt As Date
                    Dim endDt As Date
                    Date.TryParse(TA0006ALLrow("STDATE") & " " & TA0006ALLrow("STTIME"), stDt)
                    Date.TryParse(TA0006ALLrow("ENDDATE") & " " & TA0006ALLrow("ENDTIME"), endDt)
                    If stDt = endDt Then
                        TA0006ALLrow("STTIME") = ""
                        TA0006ALLrow("ENDTIME") = ""
                        TA0006ALLrow("BINDSTDATE") = ""
                    ...
                    '2020/04/13 ADD
                    TA0006ALLrow("ORVERTIME_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("ORVERTIME_V2")))
                    TA0006ALLrow("ORVERTIMECHO_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("ORVERTIMECHO_V2")))
                    TA0006ALLrow("SWORKTIME_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("SWORKTIME_V2")))
                    TA0006ALLrow("SWORKTIMECHO_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("SWORKTIMECHO_V2")))
                    TA0006ALLrow("HWORKTIME_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("HWORKTIME_V2")))
                    TA0006ALLrow("HWORKTIMECHO_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("HWORKTIMECHO_V2")))
                    TA0006ALLrow("WNIGHTTIME_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("WNIGHTTIME_V2")))
                    TA0006ALLrow("WNIGHTTIMECHO_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("WNIGHTTIMECHO_V2")))
                    TA0006ALLrow("HDAIWORKTIME_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("HDAIWORKTIME_V2")))
                    TA0006ALLrow("HDAIWORKTIMECHO_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("HDAIWORKTIMECHO_V2")))
                    TA0006ALLrow("SDAIWORKTIME_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("SDAIWORKTIME_V2")))
                    TA0006ALLrow("SDAIWORKTIMECHO_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("SDAIWORKTIMECHO_V2")))
                    '時間外計算対象外を判定し、対象外の場合は深夜のみ
                    Dim WW_FIND As String = "OFF"
                    Dim WW_NAME As String = String.Empty
                    Dim WW_RTN As String = C_MESSAGE_NO.NORMAL
                    CodeToName("OVERTIMESTAFFKBN", TA0006ALLrow("STAFFKBN"), WW_NAME, WW_RTN)
                    If Not String.IsNullOrEmpty(WW_NAME) Then WW_FIND = "ON"
                    If WW_FIND = "ON" Then
                        'そのまま
                        TA0006ALLrow("ORVERTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("ORVERTIMETTL_V2")))
                        TA0006ALLrow("SWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("SWORKTIMETTL_V2")))
                        TA0006ALLrow("HWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("HWORKTIMETTL_V2")))
                        TA0006ALLrow("HDAIWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("HDAIWORKTIMETTL_V2")))
                        TA0006ALLrow("SDAIWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(TA0006ALLrow("SDAIWORKTIMETTL_V2")))
                    Else
                        TA0006ALLrow("ORVERTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(Val(TA0006ALLrow("ORVERTIMETTL")) + Val(TA0006ALLrow("WNIGHTTIMETTL"))))
                        TA0006ALLrow("SWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(Val(TA0006ALLrow("SWORKTIMETTL")) + Val(TA0006ALLrow("SNIGHTTIMETTL"))))
                        TA0006ALLrow("HWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(Val(TA0006ALLrow("HWORKTIMETTL")) + Val(TA0006ALLrow("HNIGHTTIMETTL"))))
                        TA0006ALLrow("HDAIWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(Val(TA0006ALLrow("HDAIWORKTIMETTL")) + Val(TA0006ALLrow("HDAINIGHTTIMETTL"))))
                        TA0006ALLrow("SDAIWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(Val(TA0006ALLrow("SDAIWORKTIMETTL")) + Val(TA0006ALLrow("SDAINIGHTTIMETTL"))))
                    End If
                    TA0006ALLrow("WNIGHTTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(Val(TA0006ALLrow("NIGHTTIMETTL")) +
                                                                                Val(TA0006ALLrow("WNIGHTTIMETTL")) +
                                                                                Val(TA0006ALLrow("SNIGHTTIMETTL")) +
                                                                                Val(TA0006ALLrow("HNIGHTTIMETTL")) +
                                                                                Val(TA0006ALLrow("HDAINIGHTTIMETTL")) +
                                                                                Val(TA0006ALLrow("SDAINIGHTTIMETTL"))))
                    '2020/04/13 ADD END
    ...
    Protected Sub EditList(ByRef IO_TBL As DataTable)
        ...
        For i As Integer = 0 To IO_TBL.Rows.Count - 1
            ...
            Dim stDt As Date
            Dim endDt As Date
            Date.TryParse(WW_TA0006row("STDATE") & " " & WW_TA0006row("STTIME"), stDt)
            Date.TryParse(WW_TA0006row("ENDDATE") & " " & WW_TA0006row("ENDTIME"), endDt)
            If stDt = endDt Then
                WW_TA0006row("STTIME") = ""
                WW_TA0006row("ENDTIME") = ""
            End If
            ...
            If T0007COM.CheckHOLIDAY(WW_TA0006row("HOLIDAYKBN"), WW_TA0006row("PAYKBN")) = True OrElse
            ...
            '2020/04/13 ADD
            WW_TA0006row("ORVERTIME_V2") = ZeroToSpace(WW_TA0006row("ORVERTIME_V2"))
            WW_TA0006row("ORVERTIMECHO_V2") = ZeroToSpace(WW_TA0006row("ORVERTIMECHO_V2"))
            WW_TA0006row("ORVERTIMETTL_V2") = ZeroToSpace(WW_TA0006row("ORVERTIMETTL_V2"))
            WW_TA0006row("SWORKTIME_V2") = ZeroToSpace(WW_TA0006row("SWORKTIME_V2"))
            WW_TA0006row("SWORKTIMECHO_V2") = ZeroToSpace(WW_TA0006row("SWORKTIMECHO_V2"))
            WW_TA0006row("SWORKTIMETTL_V2") = ZeroToSpace(WW_TA0006row("SWORKTIMETTL_V2"))
            WW_TA0006row("HWORKTIME_V2") = ZeroToSpace(WW_TA0006row("HWORKTIME_V2"))
            WW_TA0006row("HWORKTIMECHO_V2") = ZeroToSpace(WW_TA0006row("HWORKTIMECHO_V2"))
            WW_TA0006row("HWORKTIMETTL_V2") = ZeroToSpace(WW_TA0006row("HWORKTIMETTL_V2"))
            WW_TA0006row("WNIGHTTIME_V2") = ZeroToSpace(WW_TA0006row("WNIGHTTIME_V2"))
            WW_TA0006row("WNIGHTTIMECHO_V2") = ZeroToSpace(WW_TA0006row("WNIGHTTIMECHO_V2"))
            WW_TA0006row("WNIGHTTIMETTL_V2") = ZeroToSpace(WW_TA0006row("WNIGHTTIMETTL_V2"))
            WW_TA0006row("HDAIWORKTIME_V2") = ZeroToSpace(WW_TA0006row("HDAIWORKTIME_V2"))
            WW_TA0006row("HDAIWORKTIMECHO_V2") = ZeroToSpace(WW_TA0006row("HDAIWORKTIMECHO_V2"))
            WW_TA0006row("HDAIWORKTIMETTL_V2") = ZeroToSpace(WW_TA0006row("HDAIWORKTIMETTL_V2"))
            WW_TA0006row("SDAIWORKTIME_V2") = ZeroToSpace(WW_TA0006row("SDAIWORKTIME_V2"))
            WW_TA0006row("SDAIWORKTIMECHO_V2") = ZeroToSpace(WW_TA0006row("SDAIWORKTIMECHO_V2"))
            WW_TA0006row("SDAIWORKTIMETTL_V2") = ZeroToSpace(WW_TA0006row("SDAIWORKTIMETTL_V2"))

            WW_TA0006row("YOKSAIKENSADAISU") = ZeroToSpace(WW_TA0006row("YOKSAIKENSADAISU"))
            WW_TA0006row("YOKSAIKENSADAISUCHO") = ZeroToSpace(WW_TA0006row("YOKSAIKENSADAISUCHO"))
            WW_TA0006row("YOKSAIKENSADAISUTTL") = ZeroToSpace(WW_TA0006row("YOKSAIKENSADAISUTTL"))
            WW_TA0006row("KIMITUKENSADAISU") = ZeroToSpace(WW_TA0006row("KIMITUKENSADAISU"))
            WW_TA0006row("KIMITUKENSADAISUCHO") = ZeroToSpace(WW_TA0006row("KIMITUKENSADAISUCHO"))
            WW_TA0006row("KIMITUKENSADAISUTTL") = ZeroToSpace(WW_TA0006row("KIMITUKENSADAISUTTL"))
            '2020/04/13 ADD END
        ...
        Dim WW_HDAIWORKTIME_V2 As Integer = 0
        Dim WW_HDAINIGHTTIME As Integer = 0
        Dim WW_SDAIWORKTIME As Integer = 0
        Dim WW_SDAIWORKTIME_V2 As Integer = 0
        ...
        For Each TA0006Row As DataRow In WW_TA0006tbl.Rows
            ...
            WW_ORVERTIME_V2 += HHMMToMinutes(TA0006Row("ORVERTIMETTL_V2"))
            WW_WNIGHTTIME += HHMMToMinutes(TA0006Row("WNIGHTTIMETTL"))
            WW_WNIGHTTIME_V2 += HHMMToMinutes(TA0006Row("WNIGHTTIMETTL_V2"))
            WW_HWORKTIME += HHMMToMinutes(TA0006Row("HWORKTIMETTL"))
            WW_HWORKTIME_V2 += HHMMToMinutes(TA0006Row("HWORKTIMETTL_V2"))
            WW_HNIGHTTIME += HHMMToMinutes(TA0006Row("HNIGHTTIMETTL"))
            WW_SWORKTIME += HHMMToMinutes(TA0006Row("SWORKTIMETTL"))
            WW_SWORKTIME_V2 += HHMMToMinutes(TA0006Row("SWORKTIMETTL_V2"))
            ...
            WW_HDAIWORKTIME_V2 += HHMMToMinutes(TA0006Row("HDAIWORKTIMETTL_V2"))
            WW_HDAINIGHTTIME += HHMMToMinutes(TA0006Row("HDAINIGHTTIMETTL"))
            WW_SDAIWORKTIME += HHMMToMinutes(TA0006Row("SDAIWORKTIMETTL"))
            WW_SDAIWORKTIME_V2 += HHMMToMinutes(TA0006Row("SDAIWORKTIMETTL_V2"))
        ...
        WW_TA0006row("ORVERTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(WW_ORVERTIME_V2))
        WW_TA0006row("WNIGHTTIMETTL") = ZeroToSpace(MinutesToHHMM(WW_WNIGHTTIME))
        WW_TA0006row("WNIGHTTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(WW_WNIGHTTIME_V2))
        WW_TA0006row("HWORKTIMETTL") = ZeroToSpace(MinutesToHHMM(WW_HWORKTIME))
        WW_TA0006row("HWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(WW_HWORKTIME_V2))
        ...
        WW_TA0006row("SWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(WW_SWORKTIME_V2))
        ...
        WW_TA0006row("HDAIWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(WW_HDAIWORKTIME_V2))
        ...
        WW_TA0006row("SDAIWORKTIMETTL_V2") = ZeroToSpace(MinutesToHHMM(WW_SDAIWORKTIME_V2))
        ...
        If Not String.IsNullOrEmpty(I_VALUE) Then
            Select Case I_FIELD
                ...
                Case "OVERTIMESTAFFKBN"
                    '社員区分名称
                    leftview.CodeToName(GRIS0005LeftBox.LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, I_VALUE, O_TEXT, O_RTN, work.CreateFIXParam(work.WF_SEL_CAMPCODE.Text, "T0009_STAFFKBN"))
    ...
    Protected Sub MAPrefelence()
        If IsNothing(Master.MAPID) Then Master.MAPID = GRTA0006WRKINC_V2.MAPID
        '■■■ 選択画面の入力初期値設定 ■■■
