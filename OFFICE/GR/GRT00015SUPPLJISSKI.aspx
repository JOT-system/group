<%@ Page Title="T00015" Language="vb" AutoEventWireup="false" CodeBehind="GRT00015SUPPLJISSKI.aspx.vb" Inherits="OFFICE.GRT00015SUPPLJISSKI" %>
...
<%@ register src="inc/GRT00015WRKINC.ascx" tagname="work" tagprefix="LSINC" %>

<asp:Content ID="T00015H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/T00015.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/T00015.js")%>"></script>
</asp:Content> 

<asp:Content ID="T00015" ContentPlaceHolderID="contents1" runat="server">
    ...
    <div  class="headerboxOnly" id="headerbox">
        <div class="Operation">
            ...
            <a style="position:fixed;top:2.8em;left:34.5em;">
                <input type="button" id="WF_ButtonGet" value="日報取込"  style="Width:5em" onclick="ButtonClick('WF_ButtonGet');" />
            </a>
    ...
    <div  class="detailboxOnly" id="detailbox">
        ...
        <a style="position:fixed;top:3.0em;left:3em; width:32em;">
            <asp:Label ID="WF_Sel_LINECNT_L" runat="server" Text="選択No" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True"></asp:Label>
        ...
        <a style="position:fixed;top:5.8em;left:3em; width:32em;" ondblclick="Field_DBclick('WF_SHUKADATE', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR  %>)">
            <asp:Label ID="WF_SHUKADATE_L" runat="server" Text="出荷日" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <a style="position:fixed;top:5.8em;left:30.5em; width:32em;" ondblclick="Field_DBclick('WF_TODOKEDATE', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR  %>)">
            <asp:Label ID="WF_TODOKEDATE_L" runat="server" Text="届日" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <a style="position:fixed;top:5.8em;left:59.5em; width:32em;">
            <asp:Label ID="WF_RYOME_L" runat="server" Text="両目" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="false"></asp:Label>
        ...
        <a style="position:fixed;top:5.8em;left:59.5em; width:32em;" hidden="hidden">
            <asp:Label ID="WF_DETAILNO_L" runat="server" Text="明細No" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="false"></asp:Label>
        ...
        <a style="position:fixed;top:7.2em;left:3em; width:32em;" ondblclick="Field_DBclick('WF_OILTYPE', <%=LIST_BOX_CLASSIFICATION.LC_OILTYPE  %>)">
            <asp:Label ID="WF_OILTYPE_L" runat="server" Text="油種" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <!-- ■　取引先　■ -->
        <a style="position:fixed;top:7.2em;left:30.5em; width:32em;" ondblclick="Field_DBclick('WF_TORICODE',  <%=LIST_BOX_CLASSIFICATION.LC_CUSTOMER  %>)">
            <asp:Label ID="WF_TORICODE_L" runat="server" Text="取引先CD" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <!-- ■　出荷部署　■ -->
        <a style="position:fixed;top:7.2em;left:59.5em; width:32em;" ondblclick="Field_DBclick('WF_SHIPORG', <%=LIST_BOX_CLASSIFICATION.LC_ORG  %>)">
            <asp:Label ID="WF_SHIPORG_L" runat="server" Text="出荷部署" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <p id="KEY_LINE_5">
        <!-- ■　業務車番　■ -->
        <a style="position:fixed;top:8.6em;left:3em; width:32em;" ondblclick="Field_DBclick('WF_GSHABAN',  <%=LIST_BOX_CLASSIFICATION.LC_EXTRA_LIST%>)">
            <asp:Label ID="WF_GSHABAN_L" runat="server" Text="業務車番" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
            <asp:TextBox ID="WF_GSHABAN" runat="server" Height="1.1em" Width="15em" CssClass="WF_TEXTBOX_CSS"></asp:TextBox>
        </a>

        <!-- ■　車腹　■ -->
        <a style="position:fixed;top:8.6em;left:30.5em; width:32em;">
            <asp:Label ID="WF_SHAFUKU_L" runat="server" Text="車腹" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="False"></asp:Label>
        ...
        <a style="position:fixed;top:10.0em;left:3em; width:32em;">
            <asp:Label ID="WF_TSHABANF_L" runat="server" Text="統一車番（前）" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="false"></asp:Label>
        ...
        <!-- ■　統一車番（後）　■ -->
        <a style="position:fixed;top:10.0em;left:30.5em; width:32em;">
            <asp:Label ID="WF_TSHABANB_L" runat="server" Text="統一車番（後）" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="false"></asp:Label>
        ...
        <a style="position:fixed;top:10.0em;left:59.5em; width:32em;">
            <asp:Label ID="WF_TSHABANB2_L" runat="server" Text="統一車番（後）２" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="false"></asp:Label>
        ...
        <a style="position:fixed;top:11.4em;left:3em; width:32em;">
            <asp:Label ID="WF_TRIPNO_L" runat="server" Text="トリップ" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="False"></asp:Label>
        ...
        <a style="position:fixed;top:11.4em;left:30.5em; width:32em;">
            <asp:Label ID="WF_DROPNO_L" runat="server" Text="ドロップ" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="False"></asp:Label>
        ...
        <p id="KEY_LINE_8">
        <!-- ■　乗務員　■ -->
        <a style="position:fixed;top:12.8em;left:3em; width:32em;" ondblclick="Field_DBclick('WF_STAFFCODE',  <%=LIST_BOX_CLASSIFICATION.LC_STAFFCODE%>)">
            <asp:Label ID="WF_STAFFCODE_L" runat="server" Text="乗務員" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <!-- ■　副乗務員　■ -->
        <a style="position:fixed;top:12.8em;left:30.5em; width:32em;" ondblclick="Field_DBclick('WF_SUBSTAFFCODE',  <%=LIST_BOX_CLASSIFICATION.LC_STAFFCODE%>)">
            <asp:Label ID="WF_SUBSTAFFCODE_L" runat="server" Text="副乗務員" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
        ...
        <!-- ■　実績区分　■ -->
        <a style="position:fixed;top:12.8em;left:59.5em; width:32em;" ondblclick="Field_DBclick('WF_JISSEKIKBN',  <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)">
            <asp:Label ID="WF_JISSEKIKBN_L" runat="server" Text="実績区分" Height="1.3em" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True" Font-Underline="True"></asp:Label>
            <asp:TextBox ID="WF_JISSEKIKBN" runat="server" Height="1.1em" Width="15em" CssClass="WF_TEXTBOX_CSS" enabled="false"></asp:TextBox>
            <asp:Label ID="WF_JISSEKIKBN_TEXT" runat="server" Height="1.2em" Width="15em" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
        </a>
        </p>
