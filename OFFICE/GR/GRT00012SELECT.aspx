<%@ Page Title="T00012S" Language="vb" AutoEventWireup="false" CodeBehind="GRT00012SELECT.aspx.vb" Inherits="OFFICE.GRT00012SELECT" %>
...
<asp:Content ID="T00012SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/T00012S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/T00012S.js")%>"></script>
</asp:Content>
<asp:Content ID="T00012S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　searchbox -->
