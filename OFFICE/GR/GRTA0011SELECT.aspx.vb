...
Public Class GRTA0011SELECT
    ...
    Public Sub Initialize()
        ...
        Master.MAPID = GRTA0011WRKINC.MAPIDS
            ...
            With leftview
                ...
                Else
                    ...
                    Select Case WF_LeftMViewChange.Value
                        Case 901
                            prmData = work.CreateFIXParam(WF_CAMPCODE.Text, "TA011_FIELDSEL")
    ...
    Protected Sub SetMapValue(ByRef O_RTN As String)
        ...
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.TA0011 Then                                                 '実行画面からの画面遷移
            '■■■ 実行画面からの画面遷移 ■■■
        ...
        '○RightBox情報設定
        rightview.MAPID = GRTA0011WRKINC.MAPID
        rightview.MAPIDS = GRTA0011WRKINC.MAPIDS
    ...
    Protected Sub CodeToName(ByVal I_FIELD As String, ByRef I_VALUE As String, ByRef O_TEXT As String, ByRef O_RTN As String)
        ...
        If Not String.IsNullOrEmpty(I_VALUE) Then
            Select Case I_FIELD
                ...
                Case "FIELDSEL"
                    leftview.CodeToName(GRIS0005LeftBox.LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, I_VALUE, O_TEXT, O_RTN, work.CreateFIXParam(WF_CAMPCODE.Text, "TA011_FIELDSEL"))                   '日付選択項目
                Case Else
                    O_TEXT = String.Empty
            End Select
        End If
    ...
    Protected Sub CheckParameters(ByRef O_RTN As String)
        ...
        If isNormal(WW_CS0024FCHECKERR) Then
            ...
            If Not String.IsNullOrEmpty(WF_FIELDSEL.Text) Then
                leftview.CodeToName(GRIS0005LeftBox.LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, WF_FIELDSEL.Text, WF_FIELDSEL_TEXT.Text, O_RTN, work.CreateFIXParam(WF_CAMPCODE.Text, "TA011_FIELDSEL"))
                If Not isNormal(O_RTN) Then
                    Master.Output(C_MESSAGE_NO.INVALID_SELECTION_DATA, C_MESSAGE_TYPE.ERR)
                    WF_FIELDSEL.Focus()
                    O_RTN = C_MESSAGE_NO.INVALID_SELECTION_DATA
