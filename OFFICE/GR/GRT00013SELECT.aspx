<%@ Page Title="T00009S" Language="vb" AutoEventWireup="false" CodeBehind="GRT00013SELECT.aspx.vb" Inherits="OFFICE.GRT00013SELECT" %>
...
<asp:Content ID="T00009S" ContentPlaceHolderID="contents1" runat="server">
    ...
    <div class="searchbox" id="searchbox">
        ...
        <!-- 作業区分選択 -->
        <a style="position:fixed; top:22.0em; left:4em; font-weight:bold;">休憩・配送</a>

        <a style="position:fixed; top:22.0em; left:18em;">
            <asp:RadioButton ID="WF_SW1" runat="server" GroupName="WF_SW" Text=" 休憩" Width="5em" />
            <asp:RadioButton ID="WF_SW2" runat="server" GroupName="WF_SW" Text=" 配送" Width="5em" />
        </a>
    </div>
