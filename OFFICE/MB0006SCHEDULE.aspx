...
<asp:Content ID="MB0006" ContentPlaceHolderID="contents1" runat="server">
        ...
        <div  class="headerboxOnly" id="headerbox">
            ...
            <div class="WF_RepeaterSCHDULE" style="position:fixed;top:4.8em;bottom:25px;left:12.7em;right:1.0em;border:solid 1px black;overflow:auto;background-color:white;" >
                ...
                <!-- ■■■　行ヘッダー　■■■ -->
                <span id="RepHeaderL" style="position:fixed;top:6.7em;bottom:30px;left:13.0em;width:20em;border:solid 1px white;overflow-x:scroll;overflow-y:hidden ;background-color:white;">
                <asp:Repeater ID="WF_RepeaterHL" runat="server">
                    ...
                    <ItemTemplate>
<!--                        <table style="table-layout:fixed;border:solid 1px white; width:18em;"> -->
                      <table style="height:1.8em;margin:0px 0px 0px 0px;table-layout: fixed;border:solid 1px white;">
                        ...
                        <td style="height:1.0em;width:5.0em;vertical-align:middle;border:solid 1px white;overflow:hidden;">
                            <asp:TextBox ID="WF_Rep_GDATE" runat="server" ReadOnly="true" BorderWidth="1px"  Borderstyle="Solid" BorderColor="white" Width="5em" Font-Bold="True" ></asp:TextBox>
                        </td>
                        <td style="height:1.0em;width:8.5em;vertical-align:middle;border:solid 1px white;overflow:auto; word-wrap:normal">
                            <asp:TextBox ID="WF_Rep_GDATE_TEXT" runat="server" ReadOnly="true" BorderWidth="1px"  Borderstyle="Solid" BorderColor="white" Width="6em" ></asp:TextBox>
                        </td>
                        <td style="height:1.0em;width:8.5em;vertical-align:middle;border:solid 1px white;overflow:auto; word-wrap:normal">
                            <asp:TextBox ID="xxx" runat="server" ReadOnly="true" BorderWidth="1px"  Borderstyle="Solid" BorderColor="white" Width="6em" TextMode="MultiLine" ></asp:TextBox>
                        </td>
