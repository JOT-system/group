<%@ Page Title="TA0007" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0007JIMKYUYOLIST_V2.aspx.vb" Inherits="OFFICE.GRTA0007JIMKYUYOLIST_V2" %>
...
<%@ register src="~/GR/inc/GRTA0007WRKINC_V2.ascx" tagname="work" tagprefix="LSINC" %>
<asp:Content ID="GRTA0007H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0007_V2.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0007_V2.js")%>"></script>
</asp:Content>
