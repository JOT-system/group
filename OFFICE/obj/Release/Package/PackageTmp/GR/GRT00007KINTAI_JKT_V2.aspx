<%@ Page Title="T00007_V2" Language="vb" AutoEventWireup="false" CodeBehind="GRT00007KINTAI_JKT_V2.aspx.vb" Inherits="OFFICE.GRT00007KINTAI_JKT_V2" %>
...
<asp:Content ID="T00007H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00007_JKT_V2.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00007_JKT_V2.js")%>'></script>
