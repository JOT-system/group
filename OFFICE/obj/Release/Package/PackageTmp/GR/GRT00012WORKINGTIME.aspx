<%@ Page Title="T00012" Language="vb" AutoEventWireup="false" CodeBehind="GRT00012WORKINGTIME.aspx.vb" Inherits="OFFICE.GRT00012WORKINGTIME" %>
...
<%@ register src="inc/GRT00012WRKINC.ascx" tagname="work" tagprefix="LSINC" %>

<asp:Content ID="T00012H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/T00012.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/T00012.js")%>"></script>
</asp:Content> 
<asp:Content ID="T00012" ContentPlaceHolderID="contents1" runat="server">
