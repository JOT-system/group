...
Public Class GRIS0001Title
    ...
    ''' <remarks></remarks>
    Public Sub SetTitle(ByVal I_MAPID As String, ByVal I_VER As String, ByVal I_MAPVARI As String, ByVal I_USERCOMP As String, ByRef O_RTN As String, Optional ByVal I_USERID As String = Nothing)
        ...
        WF_TITLEDATE.Text = DateTime.Now.ToString("yyyy年MM月dd日 HH時mm分")
        'ログインID設定
        If I_USERID <> "INIT" Then
            WF_TITLEUSER.Text = I_USERID
        End If
